...
**Generated by `compare/run.sh` on 2026-07-31T13:05:09Z, from revision `33645ff` (`master`). Do not edit
...
|---|---|---|---|
| build | `33645ff` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 18953 | 19864 | 19931 |
| events accepted | 1204600 | 1200800 | 1200300 |
| elapsed s | 63.6 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12046 | 12008 | 12003 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.17 | 1.06 | 0.34 |
| push service p95 ms | 12.1 | 3.34 | 0.61 |
| push service p99 ms | 13.9 | 5.16 | 1.11 |
| push response p50 ms | 3.22 | 2.61 | 1.24 |
| push response p95 ms | 12.8 | 5.07 | 1.72 |
| push response p99 ms | 17.7 | 8.97 | 2.22 |
| latency samples | 10046 | 10008 | 10003 |
| line bytes offered | 394429258 | 393151549 | 392997605 |
| wire bytes (snappy) | 189948161 | 189340357 | 189267687 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 44.3 | 176 | 30.8 | 61.1 | 183 | 35.8 | **0.25x** | **1.44x** |
| `label_only` | warm | 43.5 | 176 | 27.6 | 45.4 | 187 | 31.9 | **0.25x** | **1.58x** |
| `line_filter` | cold | 13.9 | 23.7 | 7.58 | 15.5 | 25.7 | 9.14 | **0.59x** | **1.84x** |
| `line_filter` | warm | 13.9 | 23.6 | 6.85 | 15.8 | 26.0 | 8.77 | **0.59x** | **2.03x** |
| `json_field` | cold | 21.8 | 52.6 | 6.90 | 26.3 | 68.4 | 9.30 | **0.42x** | **3.17x** |
| `json_field` | warm | 21.5 | 52.6 | 7.14 | 26.6 | 67.9 | 9.63 | **0.41x** | **3.01x** |
| `json_field_rare` | cold | 3.01 | 136 | 1.19 | 3.19 | 139 | 1.59 | **0.02x** | **2.53x** |
| `json_field_rare` | warm | 3.03 | 136 | 1.21 | 3.30 | 138 | 1.76 | **0.02x** | **2.52x** |
| `metadata_rare` | cold | 2.50 | 79.2 | 1.33 | 2.67 | 81.0 | 2.08 | **0.03x** | **1.87x** |
| `metadata_rare` | warm | 2.52 | 79.2 | 1.26 | 2.73 | 81.6 | 1.77 | **0.03x** | **2.00x** |
| `trace_window` | cold | 2.37 | 32.0 | 1.14 | 2.38 | 33.5 | 1.59 | **0.07x** | **2.09x** |
| `trace_window` | warm | 2.44 | 31.9 | 1.22 | 2.75 | 34.0 | 1.58 | **0.08x** | **2.00x** |
| `rate` | cold | 3.25 | 10.6 | 0.41 | 3.97 | 11.6 | 0.89 | **0.31x** | **8.01x** |
| `rate` | warm | 3.33 | 10.8 | 0.41 | 4.19 | 12.0 | 0.66 | **0.31x** | **8.20x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 44.3 | 176 | 30.8 | **0.25x** | **1.44x** | 443888 | 156516 | 150000 |
| `label_only` | 100 | 8.69 | 8.10 | 15.2 | **1.07x** | **0.57x** | 123478 | 13686 | 2400 |
| `line_filter` | 20000 | 13.9 | 23.7 | 7.58 | **0.59x** | **1.84x** | 443888 | 157304 | 10208 |
| `line_filter` | 100 | 10.6 | 10.8 | 12.0 | **0.98x** | **0.89x** | 231456 | 85550 | 2400 |
| `json_field` | 20000 | 21.8 | 52.6 | 6.90 | **0.42x** | **3.17x** | 443888 | 156988 | 17661 |
| `json_field` | 100 | 12.8 | 14.6 | 10.1 | **0.88x** | **1.27x** | 443888 | 79279 | 2400 |
| `json_field_rare` | 20000 | 3.01 | 136 | 1.19 | **0.02x** | **2.53x** | 352256 | 1582288 | 24 |
| `json_field_rare` | 100 | 2.95 | 136 | 1.21 | **0.02x** | **2.44x** | 352256 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.50 | 79.2 | 1.33 | **0.03x** | **1.87x** | 352256 | 1582288 | 24 |
| `metadata_rare` | 100 | 2.47 | 79.3 | 1.17 | **0.03x** | **2.11x** | 352256 | 1582288 | 24 |
| `trace_window` | 20000 | 2.37 | 32.0 | 1.14 | **0.07x** | **2.09x** | 221184 | 574392 | 24 |
| `trace_window` | 100 | 2.36 | 31.9 | 1.12 | **0.07x** | **2.11x** | 221184 | 574392 | 24 |
| `rate` | 20000 | 3.25 | 10.6 | 0.41 | **0.31x** | **8.01x** | 443888 | 146551 | 112 |
| `rate` | 100 | 3.20 | 10.6 | 0.44 | **0.30x** | **7.21x** | 443888 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 679.5 MiB |
| **anonymous peak during ingest** | 1319.0 MiB | 1116.0 MiB | 415.2 MiB |
| `memory.peak` during queries | 103.7 MiB | 267.9 MiB | 210.1 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 443459087 | 442181378 | 442027434 |
| total on disk, settled | 613.4 MiB | 117.8 MiB | 58.0 MiB |
| of which write-ahead log | 543.4 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.1 MiB | 117.8 MiB | 58.0 MiB |
| **total per GB ingested** | 1383 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 158 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 613.4 MiB | 117.8 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:569776748,/data/parts:73460545,/data/traces:4096`
* Loki — `/data/chunks:123384706,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:76491,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60781209`
...
* against Loki, cold: loggytracy is 31.75x faster (2.5 ms against 79.2 ms)
* against Loki, warm: loggytracy is 31.39x faster (2.5 ms against 79.2 ms)
* against VictoriaLogs, cold: loggytracy is 1.87x slower (2.5 ms against 1.3 ms)
* against VictoriaLogs, warm: loggytracy is 2.00x slower (2.5 ms against 1.3 ms)
* ingest: loggytracy achieved 18953 eps against Loki's 19864 and VictoriaLogs' 19931
* disk: loggytracy's settled data is 0.59x Loki's and 1.21x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.41x faster (21.8 ms against 52.6 ms)
against Loki and loggytracy is 3.17x slower (21.8 ms against 6.9 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (18953 / 19864 / 19931 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 21:55:15.775831863 +0900
+++ /dev/fd/62	2026-07-31 21:55:15.775831863 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T12:54:57.602248Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T12:54:57.602390Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T12:54:57.608315Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T12:54:57.608321Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T12:54:57.608347Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T12:54:57.608353Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
