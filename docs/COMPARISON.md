...
**Generated by `compare/run.sh` on 2026-08-06T14:51:05Z, from revision `04b69d2` (`master`). Do not edit
...
|---|---|---|---|
| build | `04b69d2` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19761 | 19857 | 19933 |
| events accepted | 1200200 | 1200200 | 1200400 |
| elapsed s | 60.7 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12002 | 12002 | 12004 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.22 | 1.11 | 0.26 |
| push service p95 ms | 3.49 | 3.42 | 0.50 |
| push service p99 ms | 9.19 | 5.39 | 1.10 |
| push response p50 ms | 3.92 | 2.19 | 1.47 |
| push response p95 ms | 5.10 | 4.72 | 1.95 |
| push response p99 ms | 10.9 | 10.1 | 2.52 |
| latency samples | 10002 | 10002 | 10004 |
| line bytes offered | 392963749 | 392963749 | 393026236 |
| wire bytes (OTLP protobuf) | 511928817 | 511928817 | 512011125 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 26.3 | 176 | 29.3 | 48.0 | 183 | 34.8 | **0.15x** | **0.90x** |
| `label_only` | warm | 15.4 | 176 | 25.3 | 16.7 | 185 | 30.5 | **0.09x** | **0.61x** |
| `line_filter` | cold | 3.71 | 23.6 | 7.59 | 4.05 | 26.6 | 9.51 | **0.16x** | **0.49x** |
| `line_filter` | warm | 3.65 | 23.6 | 7.23 | 4.00 | 26.3 | 9.43 | **0.15x** | **0.50x** |
| `json_field` | cold | 11.6 | 52.4 | 13.3 | 14.6 | 69.1 | 14.6 | **0.22x** | **0.88x** |
| `json_field` | warm | 10.5 | 51.7 | 12.9 | 13.9 | 68.6 | 15.0 | **0.20x** | **0.81x** |
| `json_field_rare` | cold | 0.35 | 135 | 69.0 | 5.06 | 137 | 70.7 | **0.00x** | **0.01x** |
| `json_field_rare` | warm | 0.24 | 135 | 68.4 | 0.41 | 138 | 70.3 | **0.00x** | **0.00x** |
| `metadata_rare` | cold | 0.34 | 78.7 | 1.52 | 1.55 | 80.8 | 1.93 | **0.00x** | **0.23x** |
| `metadata_rare` | warm | 0.22 | 78.8 | 1.34 | 0.24 | 81.2 | 1.85 | **0.00x** | **0.16x** |
| `trace_window` | cold | 0.34 | 31.8 | 1.33 | 1.54 | 34.0 | 1.51 | **0.01x** | **0.26x** |
| `trace_window` | warm | 0.22 | 31.8 | 1.31 | 0.24 | 33.9 | 1.52 | **0.01x** | **0.17x** |
| `rate` | cold | 0.46 | 10.8 | 0.43 | 0.56 | 11.5 | 0.48 | **0.04x** | **1.07x** |
| `rate` | warm | 0.44 | 10.8 | 0.42 | 0.55 | 12.4 | 0.50 | **0.04x** | **1.06x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 26.3 | 176 | 29.3 | **0.15x** | **0.90x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 11.6 | 8.25 | 13.6 | **1.40x** | **0.85x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 3.71 | 23.6 | 7.59 | **0.16x** | **0.49x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 1.59 | 10.4 | 12.1 | **0.15x** | **0.13x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 11.6 | 52.4 | 13.3 | **0.22x** | **0.88x** | 657904 | 156988 | 17661 |
| `json_field` | 100 | 4.74 | 14.6 | 14.3 | **0.32x** | **0.33x** | 657904 | 79279 | 2400 |
| `json_field_rare` | 20000 | 0.35 | 135 | 69.0 | **0.00x** | **0.01x** | 6144 | 1582288 | 24 |
| `json_field_rare` | 100 | 0.35 | 136 | 68.5 | **0.00x** | **0.01x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 20000 | 0.34 | 78.7 | 1.52 | **0.00x** | **0.23x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 100 | 0.34 | 78.9 | 1.37 | **0.00x** | **0.24x** | 6144 | 1582288 | 24 |
| `trace_window` | 20000 | 0.34 | 31.8 | 1.33 | **0.01x** | **0.26x** | 6144 | 574392 | 24 |
| `trace_window` | 100 | 0.34 | 31.7 | 1.28 | **0.01x** | **0.26x** | 6144 | 574392 | 24 |
| `rate` | 20000 | 0.46 | 10.8 | 0.43 | **0.04x** | **1.07x** | 758256 | 146551 | 112 |
| `rate` | 100 | 0.44 | 10.6 | 0.43 | **0.04x** | **1.02x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1194.0 MiB | 2048.1 MiB | 630.9 MiB |
| **anonymous peak during ingest** | 900.3 MiB | 1110.4 MiB | 402.5 MiB |
| `memory.peak` during queries | 160.6 MiB | 278.8 MiB | 293.0 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 441993578 | 441993578 | 442056065 |
| total on disk, settled | 87.2 MiB | 117.7 MiB | 55.4 MiB |
...
* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9369898,/data/parts:82035560,/data/traces:4096`
* Loki — `/data/chunks:123331174,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:75349,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58043582`
...
* against Loki, cold: loggytracy is 229.51x faster (0.3 ms against 78.7 ms)
* against Loki, warm: loggytracy is 360.03x faster (0.2 ms against 78.8 ms)
* against VictoriaLogs, cold: loggytracy is 4.44x faster (0.3 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 6.12x faster (0.2 ms against 1.3 ms)
* ingest: loggytracy achieved 19761 eps against Loki's 19857 and VictoriaLogs' 19933
* disk: loggytracy's settled data is 0.66x Loki's and 1.41x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 4.51x faster (11.6 ms against 52.4 ms)
against Loki and loggytracy is 1.14x faster (11.6 ms against 13.3 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19761 / 19857 / 19933 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 23:41:07.558522087 +0900
+++ /dev/fd/62	2026-08-06 23:41:07.558522087 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T14:40:49.366999Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T14:40:49.367063Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T14:40:49.367210Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T14:40:49.371464Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T14:40:49.371473Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T14:40:49.371512Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T14:40:49.371516Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
