...
**Generated by `compare/run.sh` on 2026-07-31T06:59:23Z, from revision `3a3bcbd` (`master`). Do not edit
...
|---|---|---|---|
| build | `3a3bcbd` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19785 | 19857 | 19932 |
| events accepted | 1200900 | 1200300 | 1200400 |
| elapsed s | 60.7 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12009 | 12003 | 12004 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.16 | 1.06 | 0.35 |
| push service p95 ms | 12.1 | 3.36 | 0.60 |
| push service p99 ms | 14.5 | 5.30 | 1.11 |
| push response p50 ms | 3.84 | 1.93 | 1.38 |
| push response p95 ms | 13.4 | 4.47 | 1.86 |
| push response p99 ms | 16.4 | 12.0 | 2.31 |
| latency samples | 10009 | 10003 | 10004 |
| line bytes offered | 393185745 | 392997605 | 393026236 |
| wire bytes (snappy) | 189351595 | 189259932 | 189269749 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 56.6 | 174 | 31.0 | 68.6 | 180 | 33.6 | **0.32x** | **1.82x** |
| `label_only` | warm | 55.6 | 176 | 28.0 | 59.7 | 185 | 33.0 | **0.32x** | **1.99x** |
| `line_filter` | cold | 19.9 | 23.8 | 7.92 | 23.2 | 25.8 | 9.79 | **0.83x** | **2.51x** |
| `line_filter` | warm | 19.8 | 23.7 | 7.52 | 23.4 | 26.2 | 9.66 | **0.83x** | **2.63x** |
| `json_field` | cold | 47.6 | 51.2 | 7.45 | 53.7 | 67.5 | 8.92 | **0.93x** | **6.39x** |
| `json_field` | warm | 46.9 | 52.0 | 7.45 | 54.5 | 69.1 | 9.89 | **0.90x** | **6.29x** |
| `json_field_rare` | cold | 44.2 | 136 | 1.55 | 46.1 | 139 | 2.27 | **0.33x** | **28.51x** |
| `json_field_rare` | warm | 44.5 | 136 | 1.53 | 46.3 | 139 | 2.30 | **0.33x** | **29.01x** |
| `metadata_rare` | cold | 3.05 | 79.2 | 1.50 | 3.58 | 80.4 | 2.11 | **0.04x** | **2.04x** |
| `metadata_rare` | warm | 3.08 | 79.1 | 1.46 | 3.75 | 81.7 | 1.99 | **0.04x** | **2.11x** |
| `rate` | cold | 10.1 | 10.3 | 0.42 | 11.9 | 11.5 | 0.64 | **0.98x** | **24.33x** |
| `rate` | warm | 10.1 | 10.8 | 0.42 | 12.2 | 12.5 | 0.72 | **0.94x** | **24.29x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 56.6 | 174 | 31.0 | **0.32x** | **1.82x** | 914400 | 156516 | 150000 |
| `label_only` | 100 | 14.1 | 8.02 | 14.4 | **1.76x** | **0.98x** | 333532 | 13686 | 2400 |
| `line_filter` | 20000 | 19.9 | 23.8 | 7.92 | **0.83x** | **2.51x** | 914400 | 157304 | 10208 |
| `line_filter` | 100 | 15.5 | 10.5 | 12.0 | **1.48x** | **1.29x** | 497362 | 85550 | 2400 |
| `json_field` | 20000 | 47.6 | 51.2 | 7.45 | **0.93x** | **6.39x** | 914400 | 156988 | 17661 |
| `json_field` | 100 | 22.8 | 14.7 | 10.0 | **1.55x** | **2.27x** | 422051 | 79279 | 2400 |
| `json_field_rare` | 20000 | 44.2 | 136 | 1.55 | **0.33x** | **28.51x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 44.4 | 135 | 1.45 | **0.33x** | **30.66x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 3.05 | 79.2 | 1.50 | **0.04x** | **2.04x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 3.02 | 79.1 | 1.43 | **0.04x** | **2.10x** | 589824 | 1582288 | 24 |
| `rate` | 20000 | 10.1 | 10.3 | 0.42 | **0.98x** | **24.33x** | 914400 | 146551 | 112 |
| `rate` | 100 | 10.1 | 10.7 | 0.40 | **0.94x** | **25.13x** | 914400 | 146551 | 112 |
...
| `memory.peak` during ingest | 1847.1 MiB | 2048.0 MiB | 648.6 MiB |
| **anonymous peak during ingest** | 1155.8 MiB | 1148.1 MiB | 397.5 MiB |
| `memory.peak` during queries | 128.8 MiB | 341.1 MiB | 224.0 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442215574 | 442027434 | 442056065 |
| total on disk, settled | 597.6 MiB | 117.7 MiB | 58.0 MiB |
...
| total after the query phase | 597.6 MiB | 117.7 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568189860,/data/parts:58468509,/data/traces:4096`
* Loki — `/data/chunks:123249452,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95679,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60792132`
...
* against Loki, cold: loggytracy is 25.94x faster (3.1 ms against 79.2 ms)
* against Loki, warm: loggytracy is 25.70x faster (3.1 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 2.04x slower (3.1 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 2.11x slower (3.1 ms against 1.5 ms)
* ingest: loggytracy achieved 19785 eps against Loki's 19857 and VictoriaLogs' 19932
* disk: loggytracy's settled data is 0.47x Loki's and 0.96x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is within 10% (47.6 ms against 51.2 ms)
against Loki and loggytracy is 6.39x slower (47.6 ms against 7.4 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19785 / 19857 / 19932 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 15:49:11.440924070 +0900
+++ /dev/fd/62	2026-07-31 15:49:11.440924070 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T06:48:53.260836Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T06:48:53.260990Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T06:48:53.265328Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T06:48:53.265334Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T06:48:53.265362Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T06:48:53.265365Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
