...
**Generated by `compare/run.sh` on 2026-08-06T11:21:02Z, from revision `e28d107` (`master`). Do not edit
...
|---|---|---|---|
| build | `e28d107` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19800 | 19871 | 19937 |
| events accepted | 1202600 | 1201100 | 1200600 |
| elapsed s | 60.7 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12026 | 12011 | 12006 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.58 | 1.10 | 0.26 |
| push service p95 ms | 14.5 | 3.42 | 0.46 |
| push service p99 ms | 20.3 | 5.53 | 1.03 |
| push response p50 ms | 4.05 | 2.03 | 1.43 |
| push response p95 ms | 16.6 | 4.56 | 1.90 |
| push response p99 ms | 46.5 | 10.1 | 2.31 |
| latency samples | 10026 | 10011 | 10006 |
| line bytes offered | 393760235 | 393250374 | 393087620 |
| wire bytes (OTLP protobuf) | 512963173 | 512304607 | 512092310 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 48.2 | 177 | 28.9 | 62.1 | 183 | 32.5 | **0.27x** | **1.67x** |
| `label_only` | warm | 50.1 | 177 | 25.2 | 54.1 | 185 | 29.9 | **0.28x** | **1.98x** |
| `line_filter` | cold | 15.9 | 23.3 | 8.52 | 19.1 | 24.5 | 10.3 | **0.68x** | **1.87x** |
| `line_filter` | warm | 15.8 | 23.8 | 7.07 | 18.9 | 26.4 | 9.91 | **0.66x** | **2.23x** |
| `json_field` | cold | 26.4 | 52.1 | 14.0 | 30.2 | 68.0 | 15.3 | **0.51x** | **1.88x** |
| `json_field` | warm | 26.2 | 53.0 | 13.2 | 30.8 | 68.2 | 15.4 | **0.49x** | **1.98x** |
| `json_field_rare` | cold | 2.71 | 136 | 70.3 | 2.81 | 138 | 74.2 | **0.02x** | **0.04x** |
| `json_field_rare` | warm | 2.69 | 135 | 69.5 | 3.03 | 138 | 73.6 | **0.02x** | **0.04x** |
| `metadata_rare` | cold | 2.30 | 78.9 | 1.89 | 2.33 | 81.4 | 2.22 | **0.03x** | **1.21x** |
| `metadata_rare` | warm | 2.29 | 78.8 | 1.92 | 2.33 | 81.5 | 2.14 | **0.03x** | **1.19x** |
| `trace_window` | cold | 2.01 | 31.9 | 1.79 | 2.30 | 33.8 | 1.98 | **0.06x** | **1.12x** |
| `trace_window` | warm | 2.01 | 31.9 | 1.80 | 2.32 | 33.9 | 2.14 | **0.06x** | **1.12x** |
| `rate` | cold | 1.29 | 10.6 | 0.42 | 1.55 | 11.8 | 0.63 | **0.12x** | **3.07x** |
| `rate` | warm | 1.26 | 10.6 | 0.42 | 1.54 | 12.4 | 0.52 | **0.12x** | **3.01x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 48.2 | 177 | 28.9 | **0.27x** | **1.67x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 32.1 | 8.41 | 13.4 | **3.81x** | **2.38x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 15.9 | 23.3 | 8.52 | **0.68x** | **1.87x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 30.3 | 10.5 | 12.5 | **2.89x** | **2.42x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 26.4 | 52.1 | 14.0 | **0.51x** | **1.88x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 37.3 | 14.5 | 15.0 | **2.57x** | **2.49x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 2.71 | 136 | 70.3 | **0.02x** | **0.04x** | 65536 | 1582288 | 24 |
| `json_field_rare` | 100 | 5.34 | 136 | 68.8 | **0.04x** | **0.08x** | 65536 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.30 | 78.9 | 1.89 | **0.03x** | **1.21x** | 65536 | 1582288 | 24 |
| `metadata_rare` | 100 | 4.94 | 78.7 | 1.90 | **0.06x** | **2.61x** | 65536 | 1582288 | 24 |
| `trace_window` | 20000 | 2.01 | 31.9 | 1.79 | **0.06x** | **1.12x** | 49152 | 574392 | 24 |
| `trace_window` | 100 | 4.39 | 31.7 | 1.74 | **0.14x** | **2.52x** | 49152 | 574392 | 24 |
| `rate` | 20000 | 1.29 | 10.6 | 0.42 | **0.12x** | **3.07x** | 758256 | 146551 | 112 |
| `rate` | 100 | 1.25 | 10.8 | 0.43 | **0.12x** | **2.93x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1394.6 MiB | 2048.1 MiB | 623.3 MiB |
| **anonymous peak during ingest** | 962.5 MiB | 1077.4 MiB | 473.9 MiB |
| `memory.peak` during queries | 78.1 MiB | 286.0 MiB | 286.1 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442790064 | 442280203 | 442117449 |
| total on disk, settled | 78.6 MiB | 117.8 MiB | 55.2 MiB |
| of which write-ahead log | 8.6 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.0 MiB | 117.8 MiB | 55.2 MiB |
| **total per GB ingested** | 178 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 158 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 78.6 MiB | 117.8 MiB | 55.2 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9055782,/data/parts:73387887,/data/traces:4096`
* Loki — `/data/chunks:123371239,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:75317,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:57884536`
...
* against Loki, cold: loggytracy is 34.36x faster (2.3 ms against 78.9 ms)
* against Loki, warm: loggytracy is 34.36x faster (2.3 ms against 78.8 ms)
* against VictoriaLogs, cold: loggytracy is 1.21x slower (2.3 ms against 1.9 ms)
* against VictoriaLogs, warm: loggytracy is 1.19x slower (2.3 ms against 1.9 ms)
* ingest: loggytracy achieved 19800 eps against Loki's 19871 and VictoriaLogs' 19937
* disk: loggytracy's settled data is 0.59x Loki's and 1.27x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.97x faster (26.4 ms against 52.1 ms)
against Loki and loggytracy is 1.88x slower (26.4 ms against 14.0 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19800 / 19871 / 19937 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 20:10:28.521570009 +0900
+++ /dev/fd/62	2026-08-06 20:10:28.521570009 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T11:10:10.356135Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T11:10:10.356193Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T11:10:10.356340Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T11:10:10.359881Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T11:10:10.359906Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T11:10:10.360000Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T11:10:10.360019Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
