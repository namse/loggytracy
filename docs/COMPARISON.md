...
**Generated by `compare/run.sh` on 2026-08-06T13:31:22Z, from revision `0caa5bf` (`master`). Do not edit
...
|---|---|---|---|
| build | `0caa5bf` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19767 | 19855 | 19935 |
| events accepted | 1201000 | 1200300 | 1200500 |
| elapsed s | 60.8 | 60.5 | 60.2 |
...
| push service p50 ms | 10.1 | 1.11 | 0.26 |
| push service p95 ms | 19.3 | 3.43 | 0.47 |
| push service p99 ms | 50.6 | 5.38 | 1.04 |
| push response p50 ms | 11.5 | 2.00 | 1.59 |
| push response p95 ms | 24.3 | 4.50 | 2.06 |
| push response p99 ms | 121 | 9.68 | 2.63 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 48.2 | 174 | 29.0 | 77.7 | 179 | 32.9 | **0.28x** | **1.66x** |
| `label_only` | warm | 41.8 | 178 | 25.3 | 43.5 | 185 | 31.2 | **0.24x** | **1.65x** |
| `line_filter` | cold | 4.57 | 23.4 | 9.33 | 5.41 | 26.7 | 11.3 | **0.19x** | **0.49x** |
| `line_filter` | warm | 4.63 | 23.6 | 7.32 | 5.15 | 26.4 | 9.21 | **0.20x** | **0.63x** |
| `json_field` | cold | 43.9 | 50.7 | 13.5 | 48.1 | 68.2 | 15.5 | **0.87x** | **3.25x** |
| `json_field` | warm | 12.7 | 51.9 | 13.2 | 17.8 | 69.1 | 16.0 | **0.24x** | **0.96x** |
| `json_field_rare` | cold | 0.27 | 136 | 70.6 | 4.21 | 138 | 75.6 | **0.00x** | **0.00x** |
| `json_field_rare` | warm | 0.26 | 135 | 68.7 | 0.38 | 138 | 73.0 | **0.00x** | **0.00x** |
| `metadata_rare` | cold | 0.24 | 79.1 | 1.93 | 0.84 | 81.4 | 2.92 | **0.00x** | **0.12x** |
| `metadata_rare` | warm | 0.23 | 78.9 | 1.58 | 0.25 | 81.0 | 1.88 | **0.00x** | **0.15x** |
| `trace_window` | cold | 0.24 | 31.9 | 1.57 | 0.84 | 33.9 | 2.75 | **0.01x** | **0.15x** |
| `trace_window` | warm | 0.22 | 31.8 | 1.49 | 0.25 | 33.9 | 1.76 | **0.01x** | **0.15x** |
| `rate` | cold | 0.46 | 10.8 | 0.43 | 0.58 | 12.2 | 0.70 | **0.04x** | **1.06x** |
| `rate` | warm | 0.46 | 10.7 | 0.42 | 0.57 | 11.7 | 0.70 | **0.04x** | **1.09x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 48.2 | 174 | 29.0 | **0.28x** | **1.66x** | 760304 | 156516 | 150000 |
| `label_only` | 100 | 11.2 | 8.07 | 13.2 | **1.39x** | **0.85x** | 254240 | 13686 | 2400 |
| `line_filter` | 20000 | 4.57 | 23.4 | 9.33 | **0.19x** | **0.49x** | 760304 | 157304 | 10208 |
| `line_filter` | 100 | 1.99 | 10.7 | 12.2 | **0.19x** | **0.16x** | 436807 | 85550 | 2400 |
| `json_field` | 20000 | 43.9 | 50.7 | 13.5 | **0.87x** | **3.25x** | 655856 | 156988 | 17661 |
| `json_field` | 100 | 32.3 | 14.6 | 15.4 | **2.22x** | **2.10x** | 655856 | 79279 | 2400 |
| `json_field_rare` | 20000 | 0.27 | 136 | 70.6 | **0.00x** | **0.00x** | 5120 | 1582288 | 24 |
| `json_field_rare` | 100 | 0.38 | 135 | 68.5 | **0.00x** | **0.01x** | 5120 | 1582288 | 24 |
| `metadata_rare` | 20000 | 0.24 | 79.1 | 1.93 | **0.00x** | **0.12x** | 5120 | 1582288 | 24 |
| `metadata_rare` | 100 | 0.36 | 78.9 | 1.56 | **0.00x** | **0.23x** | 5120 | 1582288 | 24 |
| `trace_window` | 20000 | 0.24 | 31.9 | 1.57 | **0.01x** | **0.15x** | 5120 | 574392 | 24 |
| `trace_window` | 100 | 0.37 | 31.6 | 1.54 | **0.01x** | **0.24x** | 5120 | 574392 | 24 |
| `rate` | 20000 | 0.46 | 10.8 | 0.43 | **0.04x** | **1.06x** | 760184 | 146551 | 112 |
| `rate` | 100 | 0.47 | 10.8 | 0.41 | **0.04x** | **1.14x** | 760184 | 146551 | 112 |
...
| `memory.peak` during ingest | 1210.2 MiB | 2048.1 MiB | 609.3 MiB |
| **anonymous peak during ingest** | 906.8 MiB | 1052.7 MiB | 454.5 MiB |
| `memory.peak` during queries | 198.7 MiB | 313.2 MiB | 266.5 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442247761 | 442027434 | 442087463 |
| total on disk, settled | 87.5 MiB | 117.7 MiB | 55.4 MiB |
| of which write-ahead log | 9.2 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 78.2 MiB | 117.7 MiB | 55.4 MiB |
...
* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9696767,/data/parts:82037610,/data/traces:4096`
* Loki — `/data/chunks:123287953,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107439,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58075968`
...
* against Loki, cold: loggytracy is 331.50x faster (0.2 ms against 79.1 ms)
* against Loki, warm: loggytracy is 339.11x faster (0.2 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 8.08x faster (0.2 ms against 1.9 ms)
* against VictoriaLogs, warm: loggytracy is 6.79x faster (0.2 ms against 1.6 ms)
* ingest: loggytracy achieved 19767 eps against Loki's 19855 and VictoriaLogs' 19935
* disk: loggytracy's settled data is 0.66x Loki's and 1.41x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.15x faster (43.9 ms against 50.7 ms)
against Loki and loggytracy is 3.25x slower (43.9 ms against 13.5 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19767 / 19855 / 19935 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 22:21:08.561541984 +0900
+++ /dev/fd/62	2026-08-06 22:21:08.561541984 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T13:20:50.400412Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T13:20:50.400487Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T13:20:50.400646Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T13:20:50.405819Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T13:20:50.405826Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T13:20:50.405854Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T13:20:50.405858Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
