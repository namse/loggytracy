...
**Generated by `compare/run.sh` on 2026-07-31T08:52:52Z, from revision `3801656` (`master`). Do not edit
...
|---|---|---|---|
| build | `3801656` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19088 | 19858 | 19934 |
| events accepted | 1201100 | 1200600 | 1200500 |
| elapsed s | 62.9 | 60.5 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12011 | 12006 | 12005 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.12 | 1.06 | 0.34 |
| push service p95 ms | 2.54 | 3.32 | 0.61 |
| push service p99 ms | 7.33 | 5.29 | 1.11 |
| push response p50 ms | 2.92 | 2.59 | 1.52 |
| push response p95 ms | 3.54 | 5.07 | 1.99 |
| push response p99 ms | 8.26 | 9.98 | 2.40 |
| latency samples | 10011 | 10006 | 10005 |
| line bytes offered | 393250374 | 393087620 | 393057634 |
| wire bytes (snappy) | 189387426 | 189301643 | 189289586 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 51.4 | 176 | 30.9 | 63.9 | 182 | 35.3 | **0.29x** | **1.66x** |
| `label_only` | warm | 48.5 | 177 | 28.4 | 51.8 | 187 | 33.4 | **0.27x** | **1.71x** |
| `line_filter` | cold | 18.6 | 23.5 | 8.02 | 22.2 | 26.6 | 9.27 | **0.79x** | **2.32x** |
| `line_filter` | warm | 18.9 | 23.8 | 7.24 | 22.3 | 26.2 | 10.3 | **0.80x** | **2.62x** |
| `json_field` | cold | 24.3 | 52.6 | 7.47 | 31.4 | 68.1 | 10.00 | **0.46x** | **3.26x** |
| `json_field` | warm | 24.0 | 52.4 | 7.18 | 31.9 | 68.6 | 9.50 | **0.46x** | **3.35x** |
| `json_field_rare` | cold | 5.74 | 136 | 1.63 | 6.21 | 139 | 2.12 | **0.04x** | **3.52x** |
| `json_field_rare` | warm | 5.56 | 136 | 1.53 | 6.13 | 139 | 2.06 | **0.04x** | **3.63x** |
| `metadata_rare` | cold | 5.03 | 79.5 | 1.49 | 5.42 | 81.4 | 2.24 | **0.06x** | **3.38x** |
| `metadata_rare` | warm | 5.00 | 79.2 | 1.47 | 5.52 | 81.5 | 1.79 | **0.06x** | **3.39x** |
| `trace_window` | cold | 4.96 | 32.0 | 1.48 | 5.39 | 33.5 | 2.11 | **0.15x** | **3.34x** |
| `trace_window` | warm | 4.95 | 31.9 | 1.45 | 5.48 | 34.3 | 1.73 | **0.15x** | **3.41x** |
| `rate` | cold | 6.13 | 10.7 | 0.41 | 7.27 | 12.0 | 0.70 | **0.57x** | **14.83x** |
| `rate` | warm | 6.18 | 10.7 | 0.41 | 7.38 | 12.4 | 0.73 | **0.58x** | **15.01x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 51.4 | 176 | 30.9 | **0.29x** | **1.66x** | 791520 | 156516 | 150000 |
| `label_only` | 100 | 13.7 | 8.23 | 14.3 | **1.67x** | **0.96x** | 310267 | 13686 | 2400 |
| `line_filter` | 20000 | 18.6 | 23.5 | 8.02 | **0.79x** | **2.32x** | 791520 | 157304 | 10208 |
| `line_filter` | 100 | 15.2 | 10.5 | 11.8 | **1.45x** | **1.29x** | 442998 | 85550 | 2400 |
| `json_field` | 20000 | 24.3 | 52.6 | 7.47 | **0.46x** | **3.26x** | 791520 | 156988 | 17661 |
| `json_field` | 100 | 15.7 | 14.8 | 9.58 | **1.07x** | **1.64x** | 791520 | 79279 | 2400 |
| `json_field_rare` | 20000 | 5.74 | 136 | 1.63 | **0.04x** | **3.52x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 5.43 | 136 | 1.45 | **0.04x** | **3.74x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 5.03 | 79.5 | 1.49 | **0.06x** | **3.38x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 4.97 | 79.1 | 1.48 | **0.06x** | **3.37x** | 589824 | 1582288 | 24 |
| `trace_window` | 20000 | 4.96 | 32.0 | 1.48 | **0.15x** | **3.34x** | 589824 | 574392 | 24 |
| `trace_window` | 100 | 4.85 | 32.0 | 1.36 | **0.15x** | **3.56x** | 589824 | 574392 | 24 |
| `rate` | 20000 | 6.13 | 10.7 | 0.41 | **0.57x** | **14.83x** | 791520 | 146551 | 112 |
| `rate` | 100 | 6.13 | 10.8 | 0.41 | **0.57x** | **14.98x** | 791520 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 766.6 MiB |
| **anonymous peak during ingest** | 1254.0 MiB | 1127.4 MiB | 435.1 MiB |
| `memory.peak` during queries | 105.8 MiB | 304.9 MiB | 220.7 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442280203 | 442117449 | 442087463 |
| total on disk, settled | 611.0 MiB | 117.7 MiB | 58.0 MiB |
| of which write-ahead log | 541.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 69.1 MiB | 117.7 MiB | 58.0 MiB |
| **total per GB ingested** | 1382 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 156 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 611.0 MiB | 117.8 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568272851,/data/parts:72445330,/data/traces:4096`
* Loki — `/data/chunks:123289581,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95862,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60793751`
...
* against Loki, cold: loggytracy is 15.80x faster (5.0 ms against 79.5 ms)
* against Loki, warm: loggytracy is 15.83x faster (5.0 ms against 79.2 ms)
* against VictoriaLogs, cold: loggytracy is 3.38x slower (5.0 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 3.39x slower (5.0 ms against 1.5 ms)
* ingest: loggytracy achieved 19088 eps against Loki's 19858 and VictoriaLogs' 19934
* disk: loggytracy's settled data is 0.59x Loki's and 1.19x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.16x faster (24.3 ms against 52.6 ms)
against Loki and loggytracy is 3.26x slower (24.3 ms against 7.5 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19088 / 19858 / 19934 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 17:42:51.678262375 +0900
+++ /dev/fd/62	2026-07-31 17:42:51.678262375 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T08:42:33.494710Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T08:42:33.494876Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T08:42:33.498901Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T08:42:33.498909Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T08:42:33.498972Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T08:42:33.498979Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
