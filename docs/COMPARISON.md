...
**Generated by `compare/run.sh` on 2026-07-31T08:39:52Z, from revision `cfe0763` (`master`). Do not edit
...
|---|---|---|---|
| build | `cfe0763` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19090 | 19870 | 19931 |
| events accepted | 1205100 | 1201100 | 1200300 |
| elapsed s | 63.1 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12051 | 12011 | 12003 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.24 | 1.06 | 0.34 |
| push service p95 ms | 12.5 | 3.36 | 0.59 |
| push service p99 ms | 15.7 | 5.30 | 1.07 |
| push response p50 ms | 3.54 | 2.81 | 1.78 |
| push response p95 ms | 13.5 | 5.33 | 2.26 |
| push response p99 ms | 69.2 | 14.0 | 2.71 |
| latency samples | 10051 | 10011 | 10003 |
| line bytes offered | 394585959 | 393250374 | 392997605 |
| wire bytes (snappy) | 190003003 | 189385633 | 189253300 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 48.6 | 175 | 31.1 | 61.3 | 183 | 34.4 | **0.28x** | **1.57x** |
| `label_only` | warm | 45.7 | 176 | 27.3 | 51.8 | 184 | 31.2 | **0.26x** | **1.67x** |
| `line_filter` | cold | 15.7 | 23.3 | 7.68 | 22.2 | 26.0 | 9.66 | **0.67x** | **2.05x** |
| `line_filter` | warm | 15.9 | 23.7 | 7.05 | 22.4 | 26.1 | 8.97 | **0.67x** | **2.26x** |
| `json_field` | cold | 23.2 | 52.7 | 7.50 | 30.2 | 66.6 | 9.23 | **0.44x** | **3.09x** |
| `json_field` | warm | 23.1 | 52.2 | 7.28 | 30.5 | 68.3 | 9.09 | **0.44x** | **3.17x** |
| `json_field_rare` | cold | 5.74 | 136 | 1.32 | 5.92 | 138 | 2.06 | **0.04x** | **4.34x** |
| `json_field_rare` | warm | 5.78 | 136 | 1.24 | 6.12 | 139 | 1.74 | **0.04x** | **4.66x** |
| `metadata_rare` | cold | 5.22 | 79.3 | 1.29 | 5.40 | 80.8 | 1.81 | **0.07x** | **4.05x** |
| `metadata_rare` | warm | 5.22 | 79.2 | 1.21 | 5.41 | 82.2 | 1.89 | **0.07x** | **4.33x** |
| `trace_window` | cold | 5.14 | 31.9 | 1.15 | 5.38 | 34.1 | 1.52 | **0.16x** | **4.47x** |
| `trace_window` | warm | 5.22 | 32.0 | 1.21 | 5.40 | 34.0 | 1.80 | **0.16x** | **4.29x** |
| `rate` | cold | 5.29 | 10.7 | 0.41 | 7.19 | 12.9 | 0.55 | **0.50x** | **12.88x** |
| `rate` | warm | 5.42 | 10.6 | 0.40 | 7.25 | 12.7 | 0.62 | **0.51x** | **13.53x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 48.6 | 175 | 31.1 | **0.28x** | **1.57x** | 693216 | 156516 | 150000 |
| `label_only` | 100 | 11.2 | 8.64 | 14.9 | **1.29x** | **0.75x** | 291803 | 13686 | 2400 |
| `line_filter` | 20000 | 15.7 | 23.3 | 7.68 | **0.67x** | **2.05x** | 693216 | 157304 | 10208 |
| `line_filter` | 100 | 12.6 | 10.3 | 12.0 | **1.23x** | **1.06x** | 426782 | 85550 | 2400 |
| `json_field` | 20000 | 23.2 | 52.7 | 7.50 | **0.44x** | **3.09x** | 693216 | 156988 | 17661 |
| `json_field` | 100 | 12.9 | 14.7 | 9.85 | **0.87x** | **1.31x** | 693216 | 79279 | 2400 |
| `json_field_rare` | 20000 | 5.74 | 136 | 1.32 | **0.04x** | **4.34x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 5.87 | 136 | 1.19 | **0.04x** | **4.94x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 5.22 | 79.3 | 1.29 | **0.07x** | **4.05x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 5.45 | 79.1 | 1.20 | **0.07x** | **4.54x** | 589824 | 1582288 | 24 |
| `trace_window` | 20000 | 5.14 | 31.9 | 1.15 | **0.16x** | **4.47x** | 589824 | 574392 | 24 |
| `trace_window` | 100 | 5.39 | 31.9 | 1.15 | **0.17x** | **4.70x** | 589824 | 574392 | 24 |
| `rate` | 20000 | 5.29 | 10.7 | 0.41 | **0.50x** | **12.88x** | 693216 | 146551 | 112 |
| `rate` | 100 | 5.61 | 10.7 | 0.39 | **0.52x** | **14.25x** | 693216 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 650.2 MiB |
| **anonymous peak during ingest** | 1271.8 MiB | 1098.1 MiB | 389.1 MiB |
| `memory.peak` during queries | 106.1 MiB | 341.6 MiB | 214.4 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 443615788 | 442280203 | 442027434 |
| total on disk, settled | 614.2 MiB | 117.8 MiB | 58.0 MiB |
| of which write-ahead log | 543.6 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.6 MiB | 117.8 MiB | 58.0 MiB |
| **total per GB ingested** | 1385 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 159 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 614.2 MiB | 117.8 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:569982480,/data/parts:74070461,/data/traces:4096`
* Loki — `/data/chunks:123353256,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95984,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60789603`
...
* against Loki, cold: loggytracy is 15.18x faster (5.2 ms against 79.3 ms)
* against Loki, warm: loggytracy is 15.19x faster (5.2 ms against 79.2 ms)
* against VictoriaLogs, cold: loggytracy is 4.05x slower (5.2 ms against 1.3 ms)
* against VictoriaLogs, warm: loggytracy is 4.33x slower (5.2 ms against 1.2 ms)
* ingest: loggytracy achieved 19090 eps against Loki's 19870 and VictoriaLogs' 19931
* disk: loggytracy's settled data is 0.60x Loki's and 1.22x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.28x faster (23.2 ms against 52.7 ms)
against Loki and loggytracy is 3.09x slower (23.2 ms against 7.5 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **88% of loggytracy's disk number is a write-ahead log the bed's own configuration stops it from compacting.** `flush.rs:219` compacts the WAL only when an object store is configured, and this bed runs loggytracy local-only so that it keeps one durable copy of a part rather than two. The two choices are in tension and I did not find a configuration that avoids both; the table reports the total and the WAL-excluded figure separately rather than picking one. The WAL-excluded row is the one to compare engines on, and the total is the one an operator running local-only actually gets.

* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19090 / 19870 / 19931 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 17:29:53.612388576 +0900
+++ /dev/fd/62	2026-07-31 17:29:53.612388576 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T08:29:35.435143Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T08:29:35.435291Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T08:29:35.439147Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T08:29:35.439154Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T08:29:35.439188Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T08:29:35.439191Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
