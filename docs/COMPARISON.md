...
**Generated by `compare/run.sh` on 2026-08-01T11:55:59Z, from revision `5231058` (`master`). Do not edit
...
|---|---|---|---|
| build | `5231058` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19070 | 19853 | 19934 |
| events accepted | 1201200 | 1200200 | 1200600 |
| elapsed s | 63.0 | 60.5 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12012 | 12002 | 12006 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.22 | 1.06 | 0.34 |
| push service p95 ms | 12.3 | 3.32 | 0.59 |
| push service p99 ms | 15.1 | 5.32 | 1.12 |
| push response p50 ms | 3.73 | 2.08 | 1.95 |
| push response p95 ms | 13.4 | 4.55 | 2.43 |
| push response p99 ms | 19.8 | 9.16 | 2.94 |
| latency samples | 10012 | 10002 | 10006 |
| line bytes offered | 393285324 | 392963749 | 393087620 |
| wire bytes (snappy) | 189402005 | 189247205 | 189301814 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 44.0 | 176 | 31.0 | 57.7 | 180 | 35.7 | **0.25x** | **1.42x** |
| `label_only` | warm | 42.2 | 178 | 27.2 | 46.5 | 189 | 32.0 | **0.24x** | **1.55x** |
| `line_filter` | cold | 12.2 | 23.4 | 8.09 | 16.1 | 25.5 | 10.1 | **0.52x** | **1.50x** |
| `line_filter` | warm | 11.9 | 23.7 | 6.88 | 16.1 | 27.1 | 8.77 | **0.50x** | **1.73x** |
| `json_field` | cold | 20.6 | 52.2 | 7.89 | 25.9 | 66.8 | 9.77 | **0.39x** | **2.61x** |
| `json_field` | warm | 20.6 | 52.1 | 7.11 | 26.4 | 69.2 | 9.33 | **0.40x** | **2.90x** |
| `json_field_rare` | cold | 3.05 | 136 | 1.52 | 3.18 | 139 | 2.46 | **0.02x** | **2.01x** |
| `json_field_rare` | warm | 3.07 | 136 | 1.48 | 3.34 | 138 | 2.70 | **0.02x** | **2.07x** |
| `metadata_rare` | cold | 2.54 | 79.2 | 1.56 | 2.61 | 81.8 | 1.96 | **0.03x** | **1.63x** |
| `metadata_rare` | warm | 2.56 | 79.2 | 1.40 | 2.81 | 82.1 | 1.88 | **0.03x** | **1.83x** |
| `trace_window` | cold | 2.36 | 32.0 | 1.32 | 2.53 | 34.1 | 1.44 | **0.07x** | **1.79x** |
| `trace_window` | warm | 2.41 | 32.0 | 1.31 | 2.71 | 34.0 | 1.69 | **0.08x** | **1.84x** |
| `rate` | cold | 1.68 | 10.8 | 0.42 | 2.50 | 12.1 | 0.99 | **0.16x** | **4.02x** |
| `rate` | warm | 1.79 | 10.8 | 0.42 | 2.58 | 12.4 | 0.53 | **0.17x** | **4.26x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 44.0 | 176 | 31.0 | **0.25x** | **1.42x** | 444912 | 156516 | 150000 |
| `label_only` | 100 | 8.97 | 8.30 | 12.1 | **1.08x** | **0.74x** | 121554 | 13686 | 2400 |
| `line_filter` | 20000 | 12.2 | 23.4 | 8.09 | **0.52x** | **1.50x** | 444912 | 157304 | 10208 |
| `line_filter` | 100 | 9.56 | 10.3 | 11.9 | **0.93x** | **0.80x** | 232517 | 85550 | 2400 |
| `json_field` | 20000 | 20.6 | 52.2 | 7.89 | **0.39x** | **2.61x** | 444912 | 156988 | 17661 |
| `json_field` | 100 | 11.5 | 14.5 | 10.1 | **0.80x** | **1.15x** | 444912 | 79279 | 2400 |
| `json_field_rare` | 20000 | 3.05 | 136 | 1.52 | **0.02x** | **2.01x** | 360448 | 1582288 | 24 |
| `json_field_rare` | 100 | 3.04 | 135 | 1.42 | **0.02x** | **2.14x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.54 | 79.2 | 1.56 | **0.03x** | **1.63x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 100 | 2.53 | 79.2 | 1.44 | **0.03x** | **1.76x** | 360448 | 1582288 | 24 |
| `trace_window` | 20000 | 2.36 | 32.0 | 1.32 | **0.07x** | **1.79x** | 188416 | 574392 | 24 |
| `trace_window` | 100 | 2.34 | 31.7 | 1.33 | **0.07x** | **1.76x** | 188416 | 574392 | 24 |
| `rate` | 20000 | 1.68 | 10.8 | 0.42 | **0.16x** | **4.02x** | 444912 | 146551 | 112 |
| `rate` | 100 | 1.71 | 10.6 | 0.42 | **0.16x** | **4.13x** | 444912 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 735.4 MiB |
| **anonymous peak during ingest** | 1444.3 MiB | 1089.4 MiB | 435.8 MiB |
| `memory.peak` during queries | 126.6 MiB | 284.2 MiB | 196.3 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442315153 | 441993578 | 442117449 |
| total on disk, settled | 612.7 MiB | 117.7 MiB | 57.8 MiB |
| of which write-ahead log | 542.0 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.7 MiB | 117.7 MiB | 57.8 MiB |
| **total per GB ingested** | 1385 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 160 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 612.7 MiB | 117.7 MiB | 57.8 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568316732,/data/parts:74143023,/data/traces:4096`
* Loki — `/data/chunks:123249172,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95740,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60638055`
...
* against Loki, cold: loggytracy is 31.24x faster (2.5 ms against 79.2 ms)
* against Loki, warm: loggytracy is 30.97x faster (2.6 ms against 79.2 ms)
* against VictoriaLogs, cold: loggytracy is 1.63x slower (2.5 ms against 1.6 ms)
* against VictoriaLogs, warm: loggytracy is 1.83x slower (2.6 ms against 1.4 ms)
* ingest: loggytracy achieved 19070 eps against Loki's 19853 and VictoriaLogs' 19934
* disk: loggytracy's settled data is 0.60x Loki's and 1.22x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.54x faster (20.6 ms against 52.2 ms)
against Loki and loggytracy is 2.61x slower (20.6 ms against 7.9 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19070 / 19853 / 19934 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-01 20:46:05.730909813 +0900
+++ /dev/fd/62	2026-08-01 20:46:05.730909813 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-01T11:45:47.548095Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-01T11:45:47.548241Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-01T11:45:47.552009Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-01T11:45:47.552015Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-01T11:45:47.552047Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-01T11:45:47.552051Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
