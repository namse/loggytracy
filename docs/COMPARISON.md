...
**Generated by `compare/run.sh` on 2026-08-06T13:51:32Z, from revision `d080add` (`master`). Do not edit
...
|---|---|---|---|
| build | `d080add` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19746 | 19859 | 19930 |
| events accepted | 1200800 | 1200500 | 1200200 |
| elapsed s | 60.8 | 60.5 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12008 | 12005 | 12002 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 10.0 | 1.12 | 0.26 |
| push service p95 ms | 20.0 | 3.44 | 0.46 |
| push service p99 ms | 61.7 | 5.40 | 1.13 |
| push response p50 ms | 11.5 | 1.97 | 1.33 |
| push response p95 ms | 31.5 | 4.48 | 1.80 |
| push response p99 ms | 127 | 8.90 | 2.36 |
| latency samples | 10008 | 10005 | 10002 |
| line bytes offered | 393151549 | 393057634 | 392963749 |
| wire bytes (OTLP protobuf) | 512176066 | 512052424 | 511928817 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 38.8 | 175 | 29.1 | 63.9 | 183 | 36.0 | **0.22x** | **1.33x** |
| `label_only` | warm | 30.2 | 176 | 25.3 | 32.0 | 184 | 30.2 | **0.17x** | **1.19x** |
| `line_filter` | cold | 4.19 | 23.6 | 9.19 | 4.46 | 25.4 | 11.8 | **0.18x** | **0.46x** |
| `line_filter` | warm | 4.13 | 23.6 | 7.24 | 4.56 | 26.8 | 10.4 | **0.18x** | **0.57x** |
| `json_field` | cold | 41.3 | 53.0 | 13.9 | 49.9 | 68.3 | 15.4 | **0.78x** | **2.97x** |
| `json_field` | warm | 10.3 | 52.3 | 13.2 | 14.5 | 68.2 | 15.9 | **0.20x** | **0.78x** |
| `json_field_rare` | cold | 0.36 | 135 | 71.2 | 4.37 | 137 | 76.0 | **0.00x** | **0.00x** |
| `json_field_rare` | warm | 0.24 | 136 | 69.0 | 0.40 | 138 | 73.8 | **0.00x** | **0.00x** |
| `metadata_rare` | cold | 0.35 | 78.7 | 1.40 | 1.19 | 81.3 | 2.03 | **0.00x** | **0.25x** |
| `metadata_rare` | warm | 0.23 | 78.8 | 1.48 | 0.35 | 80.9 | 2.06 | **0.00x** | **0.15x** |
| `trace_window` | cold | 0.35 | 31.8 | 1.36 | 1.38 | 33.3 | 1.56 | **0.01x** | **0.26x** |
| `trace_window` | warm | 0.22 | 31.9 | 1.23 | 0.35 | 33.8 | 1.63 | **0.01x** | **0.18x** |
| `rate` | cold | 0.45 | 10.5 | 0.42 | 0.56 | 12.3 | 0.49 | **0.04x** | **1.08x** |
| `rate` | warm | 0.46 | 10.6 | 0.42 | 0.57 | 12.1 | 0.69 | **0.04x** | **1.08x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 38.8 | 175 | 29.1 | **0.22x** | **1.33x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 11.7 | 8.27 | 14.1 | **1.41x** | **0.82x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 4.19 | 23.6 | 9.19 | **0.18x** | **0.46x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 1.78 | 10.4 | 12.1 | **0.17x** | **0.15x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 41.3 | 53.0 | 13.9 | **0.78x** | **2.97x** | 657904 | 156988 | 17661 |
| `json_field` | 100 | 34.4 | 14.7 | 14.3 | **2.34x** | **2.40x** | 657904 | 79279 | 2400 |
| `json_field_rare` | 20000 | 0.36 | 135 | 71.2 | **0.00x** | **0.00x** | 6144 | 1582288 | 24 |
| `json_field_rare` | 100 | 0.36 | 135 | 67.9 | **0.00x** | **0.01x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 20000 | 0.35 | 78.7 | 1.40 | **0.00x** | **0.25x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 100 | 0.34 | 79.0 | 1.46 | **0.00x** | **0.23x** | 6144 | 1582288 | 24 |
| `trace_window` | 20000 | 0.35 | 31.8 | 1.36 | **0.01x** | **0.26x** | 6144 | 574392 | 24 |
| `trace_window` | 100 | 0.34 | 31.9 | 1.21 | **0.01x** | **0.28x** | 6144 | 574392 | 24 |
| `rate` | 20000 | 0.45 | 10.5 | 0.42 | **0.04x** | **1.08x** | 758256 | 146551 | 112 |
| `rate` | 100 | 0.47 | 10.8 | 0.42 | **0.04x** | **1.13x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1158.9 MiB | 2048.1 MiB | 676.2 MiB |
| **anonymous peak during ingest** | 848.2 MiB | 1067.0 MiB | 434.3 MiB |
| `memory.peak` during queries | 208.5 MiB | 347.3 MiB | 272.4 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442181378 | 442087463 | 441993578 |
| total on disk, settled | 87.3 MiB | 117.8 MiB | 55.4 MiB |
| of which write-ahead log | 9.1 MiB | 0.0 MiB | -0.0 MiB |
...
| total after the query phase | 87.3 MiB | 117.8 MiB | 55.4 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9497734,/data/parts:82050655,/data/traces:4096`
* Loki — `/data/chunks:123350553,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:75333,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58047375`
...
* against Loki, cold: loggytracy is 225.30x faster (0.3 ms against 78.7 ms)
* against Loki, warm: loggytracy is 349.80x faster (0.2 ms against 78.8 ms)
* against VictoriaLogs, cold: loggytracy is 3.99x faster (0.3 ms against 1.4 ms)
* against VictoriaLogs, warm: loggytracy is 6.55x faster (0.2 ms against 1.5 ms)
* ingest: loggytracy achieved 19746 eps against Loki's 19859 and VictoriaLogs' 19930
* disk: loggytracy's settled data is 0.66x Loki's and 1.41x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.28x faster (41.3 ms against 53.0 ms)
against Loki and loggytracy is 2.97x slower (41.3 ms against 13.9 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19746 / 19859 / 19930 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 22:41:31.881819500 +0900
+++ /dev/fd/62	2026-08-06 22:41:31.881819500 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T13:41:13.705510Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T13:41:13.705570Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T13:41:13.705719Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T13:41:13.709650Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T13:41:13.709656Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T13:41:13.709686Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T13:41:13.709692Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
