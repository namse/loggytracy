...
**Generated by `compare/run.sh` on 2026-08-06T09:38:36Z, from revision `4bcd01c` (`master`). Do not edit
...
|---|---|---|---|
| build | `4bcd01c` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19771 | 19870 | 19935 |
| events accepted | 1200300 | 1201100 | 1200500 |
| elapsed s | 60.7 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12003 | 12011 | 12005 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.22 | 1.12 | 0.26 |
| push service p95 ms | 3.75 | 3.47 | 0.47 |
| push service p99 ms | 8.30 | 5.40 | 1.06 |
| push response p50 ms | 3.25 | 2.17 | 1.79 |
| push response p95 ms | 4.71 | 4.74 | 2.26 |
| push response p99 ms | 9.35 | 10.5 | 2.79 |
| latency samples | 10003 | 10011 | 10005 |
| line bytes offered | 392997605 | 393250374 | 393057634 |
| wire bytes (OTLP protobuf) | 511972576 | 512304607 | 512052424 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 49.1 | 175 | 28.6 | 61.4 | 182 | 32.1 | **0.28x** | **1.72x** |
| `label_only` | warm | 49.9 | 178 | 25.3 | 54.0 | 186 | 30.2 | **0.28x** | **1.98x** |
| `line_filter` | cold | 15.6 | 23.9 | 7.62 | 18.6 | 25.9 | 9.89 | **0.65x** | **2.04x** |
| `line_filter` | warm | 15.8 | 23.7 | 7.23 | 18.8 | 26.8 | 10.2 | **0.66x** | **2.18x** |
| `json_field` | cold | 26.8 | 51.8 | 14.1 | 30.7 | 68.8 | 16.1 | **0.52x** | **1.89x** |
| `json_field` | warm | 26.6 | 52.2 | 13.2 | 31.3 | 68.0 | 15.5 | **0.51x** | **2.01x** |
| `json_field_rare` | cold | 2.32 | 135 | 70.6 | 3.41 | 143 | 73.6 | **0.02x** | **0.03x** |
| `json_field_rare` | warm | 2.33 | 135 | 69.4 | 3.41 | 139 | 74.3 | **0.02x** | **0.03x** |
| `metadata_rare` | cold | 2.02 | 79.0 | 1.38 | 2.59 | 81.2 | 1.76 | **0.03x** | **1.46x** |
| `metadata_rare` | warm | 2.07 | 78.9 | 1.41 | 2.80 | 81.0 | 1.93 | **0.03x** | **1.47x** |
| `trace_window` | cold | 2.01 | 31.7 | 1.40 | 2.31 | 33.4 | 1.73 | **0.06x** | **1.44x** |
| `trace_window` | warm | 2.07 | 31.8 | 1.34 | 2.52 | 33.9 | 1.76 | **0.07x** | **1.55x** |
| `rate` | cold | 1.24 | 10.6 | 0.41 | 1.51 | 12.0 | 0.50 | **0.12x** | **3.04x** |
| `rate` | warm | 1.25 | 10.7 | 0.42 | 1.52 | 11.9 | 0.61 | **0.12x** | **2.99x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 49.1 | 175 | 28.6 | **0.28x** | **1.72x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 31.5 | 8.31 | 14.0 | **3.80x** | **2.25x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 15.6 | 23.9 | 7.62 | **0.65x** | **2.04x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 30.0 | 10.6 | 12.4 | **2.83x** | **2.43x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 26.8 | 51.8 | 14.1 | **0.52x** | **1.89x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 36.9 | 14.7 | 14.4 | **2.52x** | **2.56x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 2.32 | 135 | 70.6 | **0.02x** | **0.03x** | 57344 | 1582288 | 24 |
| `json_field_rare` | 100 | 4.88 | 135 | 68.3 | **0.04x** | **0.07x** | 57344 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.02 | 79.0 | 1.38 | **0.03x** | **1.46x** | 57344 | 1582288 | 24 |
| `metadata_rare` | 100 | 4.28 | 78.8 | 1.31 | **0.05x** | **3.26x** | 57344 | 1582288 | 24 |
| `trace_window` | 20000 | 2.01 | 31.7 | 1.40 | **0.06x** | **1.44x** | 49152 | 574392 | 24 |
| `trace_window` | 100 | 4.29 | 31.8 | 1.39 | **0.13x** | **3.08x** | 49152 | 574392 | 24 |
| `rate` | 20000 | 1.24 | 10.6 | 0.41 | **0.12x** | **3.04x** | 758256 | 146551 | 112 |
| `rate` | 100 | 1.22 | 10.6 | 0.40 | **0.12x** | **3.03x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 943.8 MiB | 2048.1 MiB | 640.9 MiB |
| **anonymous peak during ingest** | 668.2 MiB | 1100.4 MiB | 449.0 MiB |
| `memory.peak` during queries | 87.3 MiB | 285.8 MiB | 281.1 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442027434 | 442280203 | 442087463 |
| total on disk, settled | 78.4 MiB | 117.8 MiB | 55.4 MiB |
| of which write-ahead log | 8.4 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 69.9 MiB | 117.8 MiB | 55.4 MiB |
| **total per GB ingested** | 177 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 158 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 78.4 MiB | 117.8 MiB | 55.4 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:8858050,/data/parts:73336125,/data/traces:4096`
* Loki — `/data/chunks:123374457,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:117102,/data/tsdb-shipper-cache:25974,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58061743`
...
* against Loki, cold: loggytracy is 39.16x faster (2.0 ms against 79.0 ms)
* against Loki, warm: loggytracy is 38.01x faster (2.1 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 1.46x slower (2.0 ms against 1.4 ms)
* against VictoriaLogs, warm: loggytracy is 1.47x slower (2.1 ms against 1.4 ms)
* ingest: loggytracy achieved 19771 eps against Loki's 19870 and VictoriaLogs' 19935
* disk: loggytracy's settled data is 0.59x Loki's and 1.26x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.94x faster (26.8 ms against 51.8 ms)
against Loki and loggytracy is 1.89x slower (26.8 ms against 14.1 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19771 / 19870 / 19935 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 18:28:03.032774256 +0900
+++ /dev/fd/62	2026-08-06 18:28:03.032774256 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T09:27:44.850606Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T09:27:44.850689Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T09:27:44.850861Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T09:27:44.854977Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T09:27:44.854986Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T09:27:44.855022Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T09:27:44.855027Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
