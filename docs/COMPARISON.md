...
**Generated by `compare/run.sh` on 2026-07-31T05:55:03Z, from revision `b1e7ad7` (`master`). Do not edit
...
|---|---|---|---|
| build | `b1e7ad7` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19834 | 19857 | 19937 |
| events accepted | 1200500 | 1200400 | 1200400 |
| elapsed s | 60.5 | 60.5 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12005 | 12004 | 12004 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.12 | 1.05 | 0.34 |
| push service p95 ms | 2.57 | 3.31 | 0.57 |
| push service p99 ms | 7.25 | 5.09 | 1.02 |
| push response p50 ms | 3.70 | 1.91 | 1.72 |
| push response p95 ms | 4.34 | 4.40 | 2.18 |
| push response p99 ms | 9.05 | 11.7 | 2.61 |
| latency samples | 10005 | 10004 | 10004 |
| line bytes offered | 393057634 | 393026236 | 393026236 |
| wire bytes (snappy) | 189291051 | 189270565 | 189275481 |
...
**loggytracy and Loki agreed on 144 of 144 queries on the strict
...
* **Loki** returned `stream:detected_level` on 120 answers, `stream:service_name` on 120 answers, dropped from the digest by declaration.
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 56.7 | 176 | 30.3 | 67.1 | 185 | 33.2 | **0.32x** | **1.87x** |
| `label_only` | warm | 53.5 | 176 | 29.0 | 60.7 | 187 | 33.8 | **0.30x** | **1.84x** |
| `line_filter` | cold | 17.9 | 23.4 | 7.84 | 24.8 | 26.2 | 9.04 | **0.77x** | **2.28x** |
| `line_filter` | warm | 17.8 | 23.5 | 7.45 | 24.7 | 27.1 | 9.45 | **0.76x** | **2.39x** |
| `json_field` | cold | 46.6 | 52.7 | 7.70 | 54.4 | 68.1 | 9.60 | **0.88x** | **6.05x** |
| `json_field` | warm | 46.5 | 52.4 | 7.28 | 54.9 | 68.7 | 9.71 | **0.89x** | **6.39x** |
| `json_field_rare` | cold | 43.7 | 136 | 1.28 | 47.0 | 138 | 1.82 | **0.32x** | **34.31x** |
| `json_field_rare` | warm | 43.7 | 136 | 1.30 | 46.6 | 138 | 2.10 | **0.32x** | **33.68x** |
| `metadata_rare` | cold | 18.5 | 79.2 | 1.36 | 19.2 | 81.8 | 1.93 | **0.23x** | **13.63x** |
| `metadata_rare` | warm | 18.6 | 79.2 | 1.28 | 19.4 | 81.9 | 2.27 | **0.23x** | **14.48x** |
| `rate` | cold | 21.4 | 10.6 | 0.42 | 30.4 | 12.0 | 0.64 | **2.01x** | **50.93x** |
| `rate` | warm | 21.2 | 10.7 | 0.41 | 30.4 | 12.0 | 0.75 | **1.97x** | **51.51x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 56.7 | 176 | 30.3 | **0.32x** | **1.87x** | 791520 | 156516 | 150000 |
| `label_only` | 100 | 12.8 | 8.42 | 14.9 | **1.52x** | **0.86x** | 307709 | 13686 | 2400 |
| `line_filter` | 20000 | 17.9 | 23.4 | 7.84 | **0.77x** | **2.28x** | 791520 | 157304 | 10208 |
| `line_filter` | 100 | 13.6 | 10.4 | 12.1 | **1.31x** | **1.12x** | 449494 | 85550 | 2400 |
| `json_field` | 20000 | 46.6 | 52.7 | 7.70 | **0.88x** | **6.05x** | 791520 | 156988 | 17661 |
| `json_field` | 100 | 21.1 | 14.8 | 10.3 | **1.42x** | **2.05x** | 396430 | 79279 | 2400 |
| `json_field_rare` | 20000 | 43.7 | 136 | 1.28 | **0.32x** | **34.31x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 43.6 | 136 | 1.19 | **0.32x** | **36.56x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 18.5 | 79.2 | 1.36 | **0.23x** | **13.63x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 18.5 | 79.1 | 1.21 | **0.23x** | **15.27x** | 589824 | 1582288 | 24 |
| `rate` | 20000 | 21.4 | 10.6 | 0.42 | **2.01x** | **50.93x** | 791520 | 146551 | 112 |
| `rate` | 100 | 21.0 | 10.9 | 0.40 | **1.93x** | **51.90x** | 791520 | 146551 | 112 |
...
| `memory.peak` during ingest | 1897.3 MiB | 2048.0 MiB | 705.0 MiB |
| **anonymous peak during ingest** | 1294.3 MiB | 1111.8 MiB | 398.4 MiB |
| `memory.peak` during queries | 105.8 MiB | 265.5 MiB | 233.6 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442087463 | 442056065 | 442056065 |
| total on disk, settled | 598.0 MiB | 117.7 MiB | 58.0 MiB |
| of which write-ahead log | 541.7 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 56.3 MiB | 117.7 MiB | 58.0 MiB |
| **total per GB ingested** | 1353 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 127 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 598.0 MiB | 117.8 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568022690,/data/parts:59042991,/data/traces:4096`
* Loki — `/data/chunks:123273642,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95862,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60812453`
...
* against Loki, cold: loggytracy is 4.27x faster (18.5 ms against 79.2 ms)
* against Loki, warm: loggytracy is 4.26x faster (18.6 ms against 79.2 ms)
* against VictoriaLogs, cold: loggytracy is 13.63x slower (18.5 ms against 1.4 ms)
* against VictoriaLogs, warm: loggytracy is 14.48x slower (18.6 ms against 1.3 ms)
* ingest: loggytracy achieved 19834 eps against Loki's 19857 and VictoriaLogs' 19937
* disk: loggytracy's settled data is 0.48x Loki's and 0.97x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.13x faster (46.6 ms against 52.7 ms)
against Loki and loggytracy is 6.05x slower (46.6 ms against 7.7 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **91% of loggytracy's disk number is a write-ahead log the bed's own configuration stops it from compacting.** `flush.rs:219` compacts the WAL only when an object store is configured, and this bed runs loggytracy local-only so that it keeps one durable copy of a part rather than two. The two choices are in tension and I did not find a configuration that avoids both; the table reports the total and the WAL-excluded figure separately rather than picking one. The WAL-excluded row is the one to compare engines on, and the total is the one an operator running local-only actually gets.

* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19834 / 19857 / 19937 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 14:44:42.122660737 +0900
+++ /dev/fd/62	2026-07-31 14:44:42.122660737 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T05:44:23.945892Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T05:44:23.946039Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T05:44:23.951895Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T05:44:23.951902Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T05:44:23.951928Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T05:44:23.951930Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
