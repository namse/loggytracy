...
**Generated by `compare/run.sh` on 2026-07-31T09:04:35Z, from revision `d0ccf0b` (`master`). Do not edit
...
|---|---|---|---|
| build | `d0ccf0b` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 18979 | 19857 | 19934 |
| events accepted | 1201200 | 1200300 | 1200500 |
| elapsed s | 63.3 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12012 | 12003 | 12005 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.22 | 1.06 | 0.34 |
| push service p95 ms | 12.5 | 3.32 | 0.58 |
| push service p99 ms | 15.6 | 5.40 | 1.04 |
| push response p50 ms | 3.99 | 2.55 | 1.48 |
| push response p95 ms | 14.0 | 5.02 | 1.95 |
| push response p99 ms | 68.8 | 11.5 | 2.35 |
| latency samples | 10012 | 10003 | 10005 |
| line bytes offered | 393285324 | 392997605 | 393057634 |
| wire bytes (snappy) | 189395637 | 189260105 | 189291300 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 48.3 | 175 | 31.0 | 64.9 | 180 | 34.5 | **0.28x** | **1.56x** |
| `label_only` | warm | 47.5 | 177 | 27.7 | 51.4 | 184 | 31.6 | **0.27x** | **1.71x** |
| `line_filter` | cold | 18.0 | 23.4 | 7.64 | 19.8 | 26.6 | 9.54 | **0.77x** | **2.36x** |
| `line_filter` | warm | 17.9 | 23.5 | 7.17 | 19.9 | 26.4 | 8.93 | **0.76x** | **2.50x** |
| `json_field` | cold | 26.0 | 52.7 | 7.28 | 30.6 | 66.1 | 9.56 | **0.49x** | **3.57x** |
| `json_field` | warm | 25.9 | 52.2 | 7.18 | 31.4 | 68.8 | 8.98 | **0.50x** | **3.61x** |
| `json_field_rare` | cold | 5.63 | 135 | 1.54 | 6.23 | 139 | 2.05 | **0.04x** | **3.65x** |
| `json_field_rare` | warm | 5.68 | 136 | 1.53 | 6.31 | 139 | 2.22 | **0.04x** | **3.72x** |
| `metadata_rare` | cold | 5.13 | 79.1 | 1.48 | 5.64 | 80.8 | 1.91 | **0.06x** | **3.48x** |
| `metadata_rare` | warm | 5.23 | 79.1 | 1.49 | 5.73 | 81.4 | 2.03 | **0.07x** | **3.50x** |
| `trace_window` | cold | 5.03 | 32.1 | 1.54 | 5.49 | 34.0 | 1.80 | **0.16x** | **3.27x** |
| `trace_window` | warm | 5.09 | 31.9 | 1.45 | 5.55 | 34.0 | 1.86 | **0.16x** | **3.52x** |
| `rate` | cold | 6.51 | 11.1 | 0.41 | 7.47 | 11.9 | 0.56 | **0.59x** | **15.89x** |
| `rate` | warm | 6.48 | 10.7 | 0.41 | 7.56 | 11.9 | 0.79 | **0.61x** | **15.79x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 48.3 | 175 | 31.0 | **0.28x** | **1.56x** | 488944 | 156516 | 150000 |
| `label_only` | 100 | 12.5 | 8.38 | 14.3 | **1.49x** | **0.87x** | 160542 | 13686 | 2400 |
| `line_filter` | 20000 | 18.0 | 23.4 | 7.64 | **0.77x** | **2.36x** | 488944 | 157304 | 10208 |
| `line_filter` | 100 | 14.3 | 10.5 | 12.1 | **1.36x** | **1.18x** | 296842 | 85550 | 2400 |
| `json_field` | 20000 | 26.0 | 52.7 | 7.28 | **0.49x** | **3.57x** | 488944 | 156988 | 17661 |
| `json_field` | 100 | 15.9 | 14.7 | 10.4 | **1.08x** | **1.53x** | 488944 | 79279 | 2400 |
| `json_field_rare` | 20000 | 5.63 | 135 | 1.54 | **0.04x** | **3.65x** | 360448 | 1582288 | 24 |
| `json_field_rare` | 100 | 5.59 | 135 | 1.44 | **0.04x** | **3.88x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 20000 | 5.13 | 79.1 | 1.48 | **0.06x** | **3.48x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 100 | 5.09 | 79.3 | 1.46 | **0.06x** | **3.50x** | 360448 | 1582288 | 24 |
| `trace_window` | 20000 | 5.03 | 32.1 | 1.54 | **0.16x** | **3.27x** | 221184 | 574392 | 24 |
| `trace_window` | 100 | 5.06 | 31.9 | 1.50 | **0.16x** | **3.37x** | 221184 | 574392 | 24 |
| `rate` | 20000 | 6.51 | 11.1 | 0.41 | **0.59x** | **15.89x** | 488944 | 146551 | 112 |
| `rate` | 100 | 6.54 | 10.7 | 0.40 | **0.61x** | **16.37x** | 488944 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 675.9 MiB |
| **anonymous peak during ingest** | 1393.7 MiB | 1120.0 MiB | 421.5 MiB |
| `memory.peak` during queries | 129.6 MiB | 316.4 MiB | 218.6 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442315153 | 442027434 | 442087463 |
| total on disk, settled | 612.4 MiB | 117.7 MiB | 58.0 MiB |
| of which write-ahead log | 542.0 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.4 MiB | 117.7 MiB | 58.0 MiB |
| **total per GB ingested** | 1384 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 159 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 612.4 MiB | 117.7 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568317407,/data/parts:73780489,/data/traces:4096`
* Loki — `/data/chunks:123249274,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:76459,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60785326`
...
* against Loki, cold: loggytracy is 15.41x faster (5.1 ms against 79.1 ms)
* against Loki, warm: loggytracy is 15.11x faster (5.2 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 3.48x slower (5.1 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 3.50x slower (5.2 ms against 1.5 ms)
* ingest: loggytracy achieved 18979 eps against Loki's 19857 and VictoriaLogs' 19934
* disk: loggytracy's settled data is 0.60x Loki's and 1.21x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.03x faster (26.0 ms against 52.7 ms)
against Loki and loggytracy is 3.57x slower (26.0 ms against 7.3 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (18979 / 19857 / 19934 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 17:54:34.636306270 +0900
+++ /dev/fd/62	2026-07-31 17:54:34.636306270 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T08:54:16.479873Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T08:54:16.480025Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T08:54:16.485140Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T08:54:16.485170Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T08:54:16.485209Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T08:54:16.485227Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
