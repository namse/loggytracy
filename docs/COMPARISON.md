...
**Generated by `compare/run.sh` on 2026-08-06T14:12:55Z, from revision `7abda52` (`master`). Do not edit
...
|---|---|---|---|
| build | `7abda52` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19746 | 19855 | 19930 |
| events accepted | 1201000 | 1200200 | 1200200 |
| elapsed s | 60.8 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12010 | 12002 | 12002 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 6.65 | 1.12 | 0.26 |
| push service p95 ms | 16.0 | 3.46 | 0.46 |
| push service p99 ms | 23.6 | 5.41 | 1.10 |
| push response p50 ms | 7.97 | 2.60 | 1.68 |
| push response p95 ms | 18.0 | 5.09 | 2.15 |
| push response p99 ms | 58.8 | 9.47 | 2.71 |
| latency samples | 10010 | 10002 | 10002 |
| line bytes offered | 393217932 | 392963749 | 392963749 |
| wire bytes (OTLP protobuf) | 512262270 | 511928817 | 511928817 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 39.7 | 178 | 28.7 | 63.7 | 185 | 33.0 | **0.22x** | **1.38x** |
| `label_only` | warm | 29.2 | 178 | 25.4 | 31.0 | 188 | 29.8 | **0.16x** | **1.15x** |
| `line_filter` | cold | 4.10 | 23.4 | 7.95 | 4.31 | 26.1 | 9.66 | **0.18x** | **0.52x** |
| `line_filter` | warm | 4.13 | 23.6 | 7.29 | 4.47 | 26.4 | 10.5 | **0.17x** | **0.57x** |
| `json_field` | cold | 29.6 | 53.8 | 13.5 | 32.4 | 68.5 | 15.6 | **0.55x** | **2.19x** |
| `json_field` | warm | 29.7 | 52.1 | 13.1 | 32.4 | 67.6 | 15.8 | **0.57x** | **2.27x** |
| `json_field_rare` | cold | 0.24 | 135 | 69.1 | 3.69 | 137 | 72.0 | **0.00x** | **0.00x** |
| `json_field_rare` | warm | 0.25 | 135 | 69.6 | 0.36 | 139 | 74.0 | **0.00x** | **0.00x** |
| `metadata_rare` | cold | 0.22 | 78.8 | 1.61 | 0.81 | 80.1 | 2.42 | **0.00x** | **0.14x** |
| `metadata_rare` | warm | 0.23 | 78.9 | 1.47 | 0.24 | 80.9 | 2.47 | **0.00x** | **0.15x** |
| `trace_window` | cold | 0.23 | 31.8 | 1.37 | 0.81 | 34.0 | 1.63 | **0.01x** | **0.17x** |
| `trace_window` | warm | 0.22 | 31.9 | 1.39 | 0.24 | 33.9 | 2.21 | **0.01x** | **0.16x** |
| `rate` | cold | 0.45 | 10.6 | 0.45 | 0.55 | 12.6 | 0.91 | **0.04x** | **0.99x** |
| `rate` | warm | 0.45 | 10.5 | 0.42 | 0.56 | 12.0 | 0.56 | **0.04x** | **1.08x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 39.7 | 178 | 28.7 | **0.22x** | **1.38x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 11.7 | 8.23 | 13.3 | **1.42x** | **0.88x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 4.10 | 23.4 | 7.95 | **0.18x** | **0.52x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 1.82 | 10.4 | 11.3 | **0.17x** | **0.16x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 29.6 | 53.8 | 13.5 | **0.55x** | **2.19x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 8.33 | 14.4 | 15.5 | **0.58x** | **0.54x** | 356258 | 79279 | 2400 |
| `json_field_rare` | 20000 | 0.24 | 135 | 69.1 | **0.00x** | **0.00x** | 6144 | 1582288 | 24 |
| `json_field_rare` | 100 | 0.37 | 135 | 68.1 | **0.00x** | **0.01x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 20000 | 0.22 | 78.8 | 1.61 | **0.00x** | **0.14x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 100 | 0.34 | 78.8 | 1.47 | **0.00x** | **0.23x** | 6144 | 1582288 | 24 |
| `trace_window` | 20000 | 0.23 | 31.8 | 1.37 | **0.01x** | **0.17x** | 6144 | 574392 | 24 |
| `trace_window` | 100 | 0.34 | 31.8 | 1.36 | **0.01x** | **0.25x** | 6144 | 574392 | 24 |
| `rate` | 20000 | 0.45 | 10.6 | 0.45 | **0.04x** | **0.99x** | 758256 | 146551 | 112 |
| `rate` | 100 | 0.45 | 10.9 | 0.41 | **0.04x** | **1.11x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1159.7 MiB | 2048.1 MiB | 695.4 MiB |
| **anonymous peak during ingest** | 856.6 MiB | 1104.6 MiB | 415.9 MiB |
| `memory.peak` during queries | 178.4 MiB | 344.3 MiB | 256.8 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442247761 | 441993578 | 441993578 |
| total on disk, settled | 87.5 MiB | 117.7 MiB | 55.4 MiB |
| of which write-ahead log | 9.2 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 78.3 MiB | 117.7 MiB | 55.4 MiB |
| **total per GB ingested** | 198 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 177 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 87.5 MiB | 117.8 MiB | 55.4 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9614605,/data/parts:82083142,/data/traces:4096`
* Loki — `/data/chunks:123275050,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107373,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58040618`
...
* against Loki, cold: loggytracy is 356.57x faster (0.2 ms against 78.8 ms)
* against Loki, warm: loggytracy is 346.41x faster (0.2 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 7.28x faster (0.2 ms against 1.6 ms)
* against VictoriaLogs, warm: loggytracy is 6.45x faster (0.2 ms against 1.5 ms)
* ingest: loggytracy achieved 19746 eps against Loki's 19855 and VictoriaLogs' 19930
* disk: loggytracy's settled data is 0.67x Loki's and 1.41x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.82x faster (29.6 ms against 53.8 ms)
against Loki and loggytracy is 2.19x slower (29.6 ms against 13.5 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19746 / 19855 / 19930 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 23:02:52.189932515 +0900
+++ /dev/fd/62	2026-08-06 23:02:52.189932515 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T14:02:34.002556Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T14:02:34.002625Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T14:02:34.007472Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T14:02:34.012761Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T14:02:34.012768Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T14:02:34.012797Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T14:02:34.012801Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
