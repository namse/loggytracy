...
**Generated by `compare/run.sh` on 2026-08-02T15:36:26Z, from revision `f7d9a36` (`master`). Do not edit
...
|---|---|---|---|
| build | `f7d9a36` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19810 | 19870 | 19932 |
| events accepted | 1200200 | 1201100 | 1200400 |
| elapsed s | 60.6 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12002 | 12011 | 12004 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.17 | 1.11 | 0.26 |
| push service p95 ms | 3.22 | 3.39 | 0.46 |
| push service p99 ms | 7.44 | 5.24 | 1.00 |
| push response p50 ms | 3.44 | 2.74 | 1.15 |
| push response p95 ms | 4.43 | 5.19 | 1.62 |
| push response p99 ms | 8.67 | 9.79 | 2.06 |
| latency samples | 10002 | 10011 | 10004 |
| line bytes offered | 392963749 | 393250374 | 393026236 |
| wire bytes (OTLP protobuf) | 511928817 | 512304607 | 512011125 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 48.0 | 177 | 28.5 | 64.0 | 184 | 32.8 | **0.27x** | **1.69x** |
| `label_only` | warm | 46.8 | 176 | 25.8 | 50.4 | 184 | 31.1 | **0.27x** | **1.82x** |
| `line_filter` | cold | 17.1 | 23.5 | 8.91 | 21.0 | 25.6 | 12.4 | **0.73x** | **1.93x** |
| `line_filter` | warm | 17.3 | 23.7 | 7.50 | 21.0 | 26.1 | 11.1 | **0.73x** | **2.30x** |
| `json_field` | cold | 27.5 | 53.0 | 13.6 | 31.8 | 67.7 | 15.5 | **0.52x** | **2.02x** |
| `json_field` | warm | 27.5 | 52.0 | 13.0 | 31.8 | 68.8 | 16.6 | **0.53x** | **2.12x** |
| `json_field_rare` | cold | 3.07 | 135 | 69.3 | 3.34 | 138 | 73.9 | **0.02x** | **0.04x** |
| `json_field_rare` | warm | 3.15 | 135 | 69.3 | 3.42 | 138 | 75.2 | **0.02x** | **0.05x** |
| `metadata_rare` | cold | 2.54 | 78.8 | 1.57 | 2.61 | 80.9 | 1.99 | **0.03x** | **1.61x** |
| `metadata_rare` | warm | 2.62 | 78.9 | 1.44 | 2.94 | 81.1 | 2.06 | **0.03x** | **1.83x** |
| `trace_window` | cold | 2.40 | 31.8 | 1.34 | 2.48 | 33.6 | 2.21 | **0.08x** | **1.79x** |
| `trace_window` | warm | 2.47 | 31.8 | 1.35 | 2.80 | 33.8 | 2.00 | **0.08x** | **1.83x** |
| `rate` | cold | 2.76 | 10.8 | 0.42 | 3.56 | 11.8 | 0.65 | **0.26x** | **6.64x** |
| `rate` | warm | 2.80 | 10.7 | 0.41 | 3.65 | 12.4 | 0.52 | **0.26x** | **6.75x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 48.0 | 177 | 28.5 | **0.27x** | **1.69x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 14.6 | 8.19 | 14.2 | **1.78x** | **1.02x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 17.1 | 23.5 | 8.91 | **0.73x** | **1.93x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 14.6 | 10.7 | 11.9 | **1.37x** | **1.23x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 27.5 | 53.0 | 13.6 | **0.52x** | **2.02x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 18.1 | 14.4 | 15.6 | **1.26x** | **1.16x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 3.07 | 135 | 69.3 | **0.02x** | **0.04x** | 360448 | 1582288 | 24 |
| `json_field_rare` | 100 | 3.12 | 135 | 68.2 | **0.02x** | **0.05x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.54 | 78.8 | 1.57 | **0.03x** | **1.61x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 100 | 2.56 | 78.9 | 1.45 | **0.03x** | **1.77x** | 360448 | 1582288 | 24 |
| `trace_window` | 20000 | 2.40 | 31.8 | 1.34 | **0.08x** | **1.79x** | 212992 | 574392 | 24 |
| `trace_window` | 100 | 2.39 | 31.8 | 1.31 | **0.08x** | **1.82x** | 212992 | 574392 | 24 |
| `rate` | 20000 | 2.76 | 10.8 | 0.42 | **0.26x** | **6.64x** | 758256 | 146551 | 112 |
| `rate` | 100 | 2.74 | 10.5 | 0.42 | **0.26x** | **6.60x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1569.5 MiB | 2048.1 MiB | 771.3 MiB |
| **anonymous peak during ingest** | 832.0 MiB | 1123.0 MiB | 494.9 MiB |
| `memory.peak` during queries | 129.7 MiB | 276.8 MiB | 285.7 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 441993578 | 442280203 | 442056065 |
| total on disk, settled | 619.0 MiB | 117.8 MiB | 55.0 MiB |
| of which write-ahead log | 548.7 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.3 MiB | 117.8 MiB | 55.0 MiB |
| **total per GB ingested** | 1400 MiB / GB | 266 MiB / GB | 124 MiB / GB |
| **settled data per GB ingested** | 159 MiB / GB | 266 MiB / GB | 124 MiB / GB |
| total after the query phase | 619.0 MiB | 117.8 MiB | 55.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:575326859,/data/parts:73718846,/data/traces:4096`
* Loki — `/data/chunks:123402076,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:75349,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:57691255`
...
* against Loki, cold: loggytracy is 31.04x faster (2.5 ms against 78.8 ms)
* against Loki, warm: loggytracy is 30.06x faster (2.6 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 1.61x slower (2.5 ms against 1.6 ms)
* against VictoriaLogs, warm: loggytracy is 1.83x slower (2.6 ms against 1.4 ms)
* ingest: loggytracy achieved 19810 eps against Loki's 19870 and VictoriaLogs' 19932
* disk: loggytracy's settled data is 0.60x Loki's and 1.28x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.93x faster (27.5 ms against 53.0 ms)
against Loki and loggytracy is 2.02x slower (27.5 ms against 13.6 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19810 / 19870 / 19932 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-03 00:26:02.506292599 +0900
+++ /dev/fd/62	2026-08-03 00:26:02.506292599 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-02T15:25:44.327536Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-02T15:25:44.327711Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-02T15:25:44.333809Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-02T15:25:44.333816Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-02T15:25:44.333845Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-02T15:25:44.333848Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
