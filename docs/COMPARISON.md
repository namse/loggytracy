...
**Generated by `compare/run.sh` on 2026-08-06T06:37:07Z, from revision `f849e7c` (`master`). Do not edit
...
|---|---|---|---|
| build | `f849e7c` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19779 | 19864 | 19935 |
| events accepted | 1201100 | 1200700 | 1200600 |
| elapsed s | 60.7 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12011 | 12007 | 12006 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.39 | 1.11 | 0.26 |
| push service p95 ms | 15.8 | 3.46 | 0.48 |
| push service p99 ms | 24.0 | 5.55 | 1.08 |
| push response p50 ms | 4.30 | 2.60 | 1.52 |
| push response p95 ms | 18.5 | 5.14 | 1.99 |
| push response p99 ms | 76.3 | 10.6 | 2.47 |
| latency samples | 10011 | 10007 | 10006 |
| line bytes offered | 393250374 | 393119777 | 393087620 |
| wire bytes (OTLP protobuf) | 512304607 | 512134376 | 512092310 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 50.4 | 176 | 28.7 | 56.4 | 185 | 32.0 | **0.29x** | **1.75x** |
| `label_only` | warm | 51.5 | 178 | 26.2 | 56.1 | 190 | 30.3 | **0.29x** | **1.96x** |
| `line_filter` | cold | 17.3 | 23.7 | 8.77 | 20.9 | 27.2 | 11.7 | **0.73x** | **1.97x** |
| `line_filter` | warm | 17.2 | 23.9 | 7.47 | 20.9 | 26.6 | 10.1 | **0.72x** | **2.31x** |
| `json_field` | cold | 27.6 | 53.0 | 14.3 | 31.6 | 68.3 | 15.3 | **0.52x** | **1.93x** |
| `json_field` | warm | 27.6 | 52.8 | 12.7 | 32.1 | 69.3 | 15.7 | **0.52x** | **2.18x** |
| `json_field_rare` | cold | 2.70 | 135 | 67.1 | 2.86 | 137 | 68.5 | **0.02x** | **0.04x** |
| `json_field_rare` | warm | 2.70 | 135 | 67.1 | 3.04 | 138 | 70.2 | **0.02x** | **0.04x** |
| `metadata_rare` | cold | 2.30 | 78.9 | 1.19 | 2.50 | 81.2 | 1.48 | **0.03x** | **1.93x** |
| `metadata_rare` | warm | 2.30 | 78.9 | 1.20 | 2.52 | 81.2 | 1.45 | **0.03x** | **1.92x** |
| `trace_window` | cold | 2.30 | 31.9 | 1.03 | 2.32 | 33.8 | 1.33 | **0.07x** | **2.23x** |
| `trace_window` | warm | 2.30 | 31.9 | 1.13 | 2.52 | 33.7 | 1.54 | **0.07x** | **2.04x** |
| `rate` | cold | 2.72 | 10.6 | 0.41 | 3.47 | 11.7 | 0.66 | **0.26x** | **6.68x** |
| `rate` | warm | 2.73 | 10.7 | 0.41 | 3.55 | 11.8 | 0.59 | **0.25x** | **6.70x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 50.4 | 176 | 28.7 | **0.29x** | **1.75x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 32.8 | 8.33 | 13.9 | **3.94x** | **2.37x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 17.3 | 23.7 | 8.77 | **0.73x** | **1.97x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 31.4 | 10.6 | 12.2 | **2.96x** | **2.57x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 27.6 | 53.0 | 14.3 | **0.52x** | **1.93x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 38.8 | 14.7 | 14.3 | **2.64x** | **2.72x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 2.70 | 135 | 67.1 | **0.02x** | **0.04x** | 57344 | 1582288 | 24 |
| `json_field_rare` | 100 | 5.09 | 135 | 66.9 | **0.04x** | **0.08x** | 57344 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.30 | 78.9 | 1.19 | **0.03x** | **1.93x** | 57344 | 1582288 | 24 |
| `metadata_rare` | 100 | 4.63 | 79.0 | 1.18 | **0.06x** | **3.92x** | 57344 | 1582288 | 24 |
| `trace_window` | 20000 | 2.30 | 31.9 | 1.03 | **0.07x** | **2.23x** | 57344 | 574392 | 24 |
| `trace_window` | 100 | 4.57 | 31.8 | 1.06 | **0.14x** | **4.33x** | 57344 | 574392 | 24 |
| `rate` | 20000 | 2.72 | 10.6 | 0.41 | **0.26x** | **6.68x** | 758256 | 146551 | 112 |
| `rate` | 100 | 2.72 | 10.7 | 0.41 | **0.25x** | **6.65x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 830.7 MiB | 2048.1 MiB | 676.4 MiB |
| **anonymous peak during ingest** | 580.0 MiB | 1142.7 MiB | 479.3 MiB |
| `memory.peak` during queries | 81.3 MiB | 349.4 MiB | 283.0 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442280203 | 442149606 | 442117449 |
| total on disk, settled | 95.9 MiB | 117.8 MiB | 55.3 MiB |
| of which write-ahead log | 25.6 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.3 MiB | 117.8 MiB | 55.3 MiB |
| **total per GB ingested** | 217 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 159 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 95.9 MiB | 117.8 MiB | 55.3 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:26852040,/data/parts:73729255,/data/traces:4096`
* Loki — `/data/chunks:123371004,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:117476,/data/tsdb-shipper-cache:27251,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:57994887`
...
* against Loki, cold: loggytracy is 34.23x faster (2.3 ms against 78.9 ms)
* against Loki, warm: loggytracy is 34.26x faster (2.3 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 1.93x slower (2.3 ms against 1.2 ms)
* against VictoriaLogs, warm: loggytracy is 1.92x slower (2.3 ms against 1.2 ms)
* ingest: loggytracy achieved 19779 eps against Loki's 19864 and VictoriaLogs' 19935
* disk: loggytracy's settled data is 0.60x Loki's and 1.27x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.92x faster (27.6 ms against 53.0 ms)
against Loki and loggytracy is 1.93x slower (27.6 ms against 14.3 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19779 / 19864 / 19935 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 15:26:32.898596396 +0900
+++ /dev/fd/62	2026-08-06 15:26:32.898596396 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T06:26:14.686324Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T06:26:14.686395Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T06:26:14.689238Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T06:26:14.714546Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T06:26:14.714557Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T06:26:14.714596Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T06:26:14.714603Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
