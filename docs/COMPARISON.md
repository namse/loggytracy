...
**Generated by `compare/run.sh` on 2026-08-06T12:23:11Z, from revision `28a54e8` (`master`). Do not edit
...
|---|---|---|---|
| build | `28a54e8` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19766 | 19862 | 19930 |
| events accepted | 1201000 | 1200600 | 1200200 |
| elapsed s | 60.8 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12010 | 12006 | 12002 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.54 | 1.13 | 0.26 |
| push service p95 ms | 14.6 | 3.46 | 0.47 |
| push service p99 ms | 20.3 | 5.45 | 1.07 |
| push response p50 ms | 3.71 | 2.27 | 1.72 |
| push response p95 ms | 15.6 | 4.78 | 2.19 |
| push response p99 ms | 21.4 | 8.86 | 2.73 |
| latency samples | 10010 | 10006 | 10002 |
| line bytes offered | 393217932 | 393087620 | 392963749 |
| wire bytes (OTLP protobuf) | 512262270 | 512092310 | 511928817 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 48.6 | 177 | 29.2 | 71.1 | 180 | 32.2 | **0.28x** | **1.67x** |
| `label_only` | warm | 40.6 | 176 | 25.6 | 42.8 | 186 | 31.4 | **0.23x** | **1.58x** |
| `line_filter` | cold | 4.71 | 23.6 | 8.77 | 5.63 | 26.2 | 10.2 | **0.20x** | **0.54x** |
| `line_filter` | warm | 4.60 | 23.5 | 7.22 | 5.36 | 25.6 | 9.69 | **0.20x** | **0.64x** |
| `json_field` | cold | 44.4 | 53.6 | 14.4 | 54.0 | 65.4 | 16.9 | **0.83x** | **3.09x** |
| `json_field` | warm | 12.6 | 52.3 | 13.0 | 16.8 | 69.1 | 15.3 | **0.24x** | **0.97x** |
| `json_field_rare` | cold | 0.25 | 136 | 72.7 | 4.84 | 138 | 75.6 | **0.00x** | **0.00x** |
| `json_field_rare` | warm | 0.25 | 136 | 68.6 | 0.33 | 138 | 72.9 | **0.00x** | **0.00x** |
| `metadata_rare` | cold | 0.23 | 78.9 | 1.36 | 1.50 | 81.1 | 1.64 | **0.00x** | **0.17x** |
| `metadata_rare` | warm | 0.23 | 78.9 | 1.30 | 0.24 | 81.4 | 1.71 | **0.00x** | **0.17x** |
| `trace_window` | cold | 0.23 | 31.8 | 1.32 | 1.59 | 33.3 | 1.85 | **0.01x** | **0.17x** |
| `trace_window` | warm | 0.23 | 31.8 | 1.25 | 0.24 | 34.2 | 1.54 | **0.01x** | **0.18x** |
| `rate` | cold | 1.32 | 10.8 | 0.45 | 1.59 | 11.5 | 1.23 | **0.12x** | **2.92x** |
| `rate` | warm | 1.31 | 10.8 | 0.42 | 1.97 | 12.7 | 0.48 | **0.12x** | **3.11x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 48.6 | 177 | 29.2 | **0.28x** | **1.67x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 11.9 | 8.43 | 13.6 | **1.41x** | **0.88x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 4.71 | 23.6 | 8.77 | **0.20x** | **0.54x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 1.94 | 10.6 | 11.4 | **0.18x** | **0.17x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 44.4 | 53.6 | 14.4 | **0.83x** | **3.09x** | 657904 | 156988 | 17661 |
| `json_field` | 100 | 34.5 | 14.5 | 15.0 | **2.38x** | **2.30x** | 657904 | 79279 | 2400 |
| `json_field_rare` | 20000 | 0.25 | 136 | 72.7 | **0.00x** | **0.00x** | 6144 | 1582288 | 24 |
| `json_field_rare` | 100 | 0.37 | 136 | 67.9 | **0.00x** | **0.01x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 20000 | 0.23 | 78.9 | 1.36 | **0.00x** | **0.17x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 100 | 0.36 | 78.9 | 1.29 | **0.00x** | **0.28x** | 6144 | 1582288 | 24 |
| `trace_window` | 20000 | 0.23 | 31.8 | 1.32 | **0.01x** | **0.17x** | 6144 | 574392 | 24 |
| `trace_window` | 100 | 0.36 | 31.9 | 1.29 | **0.01x** | **0.28x** | 6144 | 574392 | 24 |
| `rate` | 20000 | 1.32 | 10.8 | 0.45 | **0.12x** | **2.92x** | 758256 | 146551 | 112 |
| `rate` | 100 | 1.26 | 10.6 | 0.42 | **0.12x** | **2.97x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1226.4 MiB | 2048.1 MiB | 680.2 MiB |
| **anonymous peak during ingest** | 923.0 MiB | 1123.0 MiB | 422.4 MiB |
| `memory.peak` during queries | 201.0 MiB | 276.8 MiB | 277.5 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442247761 | 442117449 | 441993578 |
| total on disk, settled | 87.1 MiB | 117.7 MiB | 55.3 MiB |
| of which write-ahead log | 8.8 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 78.3 MiB | 117.7 MiB | 55.3 MiB |
| **total per GB ingested** | 197 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 177 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 87.1 MiB | 117.8 MiB | 55.3 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9238404,/data/parts:82084919,/data/traces:4096`
* Loki — `/data/chunks:123299305,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107256,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58030898`
...
* against Loki, cold: loggytracy is 343.87x faster (0.2 ms against 78.9 ms)
* against Loki, warm: loggytracy is 347.81x faster (0.2 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 5.91x faster (0.2 ms against 1.4 ms)
* against VictoriaLogs, warm: loggytracy is 5.74x faster (0.2 ms against 1.3 ms)
* ingest: loggytracy achieved 19766 eps against Loki's 19862 and VictoriaLogs' 19930
* disk: loggytracy's settled data is 0.67x Loki's and 1.41x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.21x faster (44.4 ms against 53.6 ms)
against Loki and loggytracy is 3.09x slower (44.4 ms against 14.4 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19766 / 19862 / 19930 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 21:13:08.490417200 +0900
+++ /dev/fd/62	2026-08-06 21:13:08.490417200 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T12:12:50.280388Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T12:12:50.280458Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T12:12:50.280598Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T12:12:50.298432Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T12:12:50.298439Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T12:12:50.298466Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T12:12:50.298470Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
