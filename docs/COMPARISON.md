...
**Generated by `compare/run.sh` on 2026-08-06T08:05:26Z, from revision `927e222` (`master`). Do not edit
...
|---|---|---|---|
| build | `927e222` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19765 | 19862 | 19927 |
| events accepted | 1200900 | 1200600 | 1200100 |
| elapsed s | 60.8 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12009 | 12006 | 12001 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.36 | 1.10 | 0.26 |
| push service p95 ms | 14.1 | 3.42 | 0.45 |
| push service p99 ms | 20.5 | 5.45 | 1.05 |
| push response p50 ms | 3.83 | 2.23 | 1.62 |
| push response p95 ms | 15.7 | 4.74 | 2.08 |
| push response p99 ms | 23.5 | 9.29 | 2.60 |
| latency samples | 10009 | 10006 | 10001 |
| line bytes offered | 393185745 | 393087620 | 392928494 |
| wire bytes (OTLP protobuf) | 512220156 | 512092310 | 511883658 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 49.2 | 176 | 28.3 | 52.6 | 181 | 33.2 | **0.28x** | **1.74x** |
| `label_only` | warm | 48.9 | 178 | 24.6 | 52.9 | 186 | 29.3 | **0.28x** | **1.99x** |
| `line_filter` | cold | 17.6 | 23.6 | 8.35 | 21.0 | 26.5 | 11.5 | **0.75x** | **2.10x** |
| `line_filter` | warm | 17.3 | 23.7 | 6.89 | 21.0 | 26.6 | 8.79 | **0.73x** | **2.51x** |
| `json_field` | cold | 27.8 | 52.6 | 13.1 | 32.3 | 68.6 | 15.2 | **0.53x** | **2.12x** |
| `json_field` | warm | 27.3 | 51.6 | 12.8 | 31.8 | 69.4 | 15.2 | **0.53x** | **2.13x** |
| `json_field_rare` | cold | 2.38 | 136 | 69.2 | 2.75 | 139 | 70.5 | **0.02x** | **0.03x** |
| `json_field_rare` | warm | 2.35 | 135 | 68.0 | 2.96 | 138 | 71.4 | **0.02x** | **0.03x** |
| `metadata_rare` | cold | 2.11 | 79.0 | 1.28 | 2.34 | 80.9 | 1.56 | **0.03x** | **1.64x** |
| `metadata_rare` | warm | 2.13 | 78.9 | 1.27 | 2.51 | 81.4 | 1.50 | **0.03x** | **1.67x** |
| `trace_window` | cold | 2.09 | 31.9 | 1.16 | 2.32 | 33.7 | 1.37 | **0.07x** | **1.80x** |
| `trace_window` | warm | 2.06 | 31.9 | 1.17 | 2.49 | 34.0 | 1.33 | **0.06x** | **1.75x** |
| `rate` | cold | 2.75 | 10.7 | 0.43 | 3.52 | 11.3 | 0.59 | **0.26x** | **6.37x** |
| `rate` | warm | 2.78 | 10.6 | 0.42 | 3.61 | 12.1 | 0.49 | **0.26x** | **6.70x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 49.2 | 176 | 28.3 | **0.28x** | **1.74x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 30.6 | 8.26 | 12.8 | **3.70x** | **2.38x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 17.6 | 23.6 | 8.35 | **0.75x** | **2.10x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 30.0 | 10.4 | 11.5 | **2.88x** | **2.62x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 27.8 | 52.6 | 13.1 | **0.53x** | **2.12x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 36.6 | 14.6 | 14.2 | **2.51x** | **2.58x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 2.38 | 136 | 69.2 | **0.02x** | **0.03x** | 49152 | 1582288 | 24 |
| `json_field_rare` | 100 | 3.92 | 136 | 67.6 | **0.03x** | **0.06x** | 49152 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.11 | 79.0 | 1.28 | **0.03x** | **1.64x** | 49152 | 1582288 | 24 |
| `metadata_rare` | 100 | 3.56 | 78.9 | 1.24 | **0.05x** | **2.87x** | 49152 | 1582288 | 24 |
| `trace_window` | 20000 | 2.09 | 31.9 | 1.16 | **0.07x** | **1.80x** | 49152 | 574392 | 24 |
| `trace_window` | 100 | 3.61 | 31.8 | 1.13 | **0.11x** | **3.20x** | 49152 | 574392 | 24 |
| `rate` | 20000 | 2.75 | 10.7 | 0.43 | **0.26x** | **6.37x** | 758256 | 146551 | 112 |
| `rate` | 100 | 2.75 | 10.9 | 0.43 | **0.25x** | **6.41x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 947.8 MiB | 2048.1 MiB | 583.1 MiB |
| **anonymous peak during ingest** | 674.1 MiB | 1113.8 MiB | 422.9 MiB |
| `memory.peak` during queries | 58.8 MiB | 342.3 MiB | 263.2 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442215574 | 442117449 | 441958323 |
| total on disk, settled | 79.5 MiB | 117.8 MiB | 55.3 MiB |
| of which write-ahead log | 9.2 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.3 MiB | 117.8 MiB | 55.3 MiB |
| **total per GB ingested** | 180 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 159 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 79.5 MiB | 117.8 MiB | 55.3 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9658626,/data/parts:73723235,/data/traces:4096`
* Loki — `/data/chunks:123374706,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:75317,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58011691`
...
* against Loki, cold: loggytracy is 37.48x faster (2.1 ms against 79.0 ms)
* against Loki, warm: loggytracy is 37.13x faster (2.1 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 1.64x slower (2.1 ms against 1.3 ms)
* against VictoriaLogs, warm: loggytracy is 1.67x slower (2.1 ms against 1.3 ms)
* ingest: loggytracy achieved 19765 eps against Loki's 19862 and VictoriaLogs' 19927
* disk: loggytracy's settled data is 0.60x Loki's and 1.27x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.89x faster (27.8 ms against 52.6 ms)
against Loki and loggytracy is 2.12x slower (27.8 ms against 13.1 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19765 / 19862 / 19927 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 16:54:53.264889929 +0900
+++ /dev/fd/62	2026-08-06 16:54:53.264889929 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T07:54:35.099272Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T07:54:35.099360Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T07:54:35.099530Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T07:54:35.103008Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T07:54:35.103014Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T07:54:35.103042Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T07:54:35.103045Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
