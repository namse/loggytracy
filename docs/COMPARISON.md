...
**Generated by `compare/run.sh` on 2026-08-06T12:03:17Z, from revision `e1e5185` (`master`). Do not edit
...
|---|---|---|---|
| build | `e1e5185` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19753 | 19869 | 19937 |
| events accepted | 1201000 | 1200900 | 1200600 |
| elapsed s | 60.8 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12010 | 12009 | 12006 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.27 | 1.11 | 0.26 |
| push service p95 ms | 12.5 | 3.40 | 0.47 |
| push service p99 ms | 18.8 | 5.52 | 1.11 |
| push response p50 ms | 3.36 | 2.77 | 1.56 |
| push response p95 ms | 13.4 | 5.23 | 2.04 |
| push response p99 ms | 19.8 | 9.76 | 2.63 |
| latency samples | 10010 | 10009 | 10006 |
| line bytes offered | 393217932 | 393185745 | 393087620 |
| wire bytes (OTLP protobuf) | 512262270 | 512220156 | 512092310 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 48.4 | 177 | 27.9 | 71.7 | 185 | 30.6 | **0.27x** | **1.73x** |
| `label_only` | warm | 37.9 | 177 | 24.8 | 38.9 | 186 | 29.5 | **0.21x** | **1.53x** |
| `line_filter` | cold | 4.60 | 23.8 | 8.01 | 4.81 | 25.6 | 9.54 | **0.19x** | **0.57x** |
| `line_filter` | warm | 4.62 | 23.7 | 7.36 | 5.19 | 26.3 | 9.90 | **0.19x** | **0.63x** |
| `json_field` | cold | 44.0 | 51.9 | 13.4 | 52.7 | 68.7 | 14.9 | **0.85x** | **3.29x** |
| `json_field` | warm | 13.9 | 52.4 | 13.0 | 17.7 | 69.0 | 15.6 | **0.27x** | **1.07x** |
| `json_field_rare` | cold | 1.33 | 136 | 69.5 | 4.01 | 138 | 73.0 | **0.01x** | **0.02x** |
| `json_field_rare` | warm | 2.29 | 135 | 68.8 | 3.45 | 138 | 75.1 | **0.02x** | **0.03x** |
| `metadata_rare` | cold | 1.02 | 79.1 | 1.51 | 1.38 | 80.5 | 1.97 | **0.01x** | **0.67x** |
| `metadata_rare` | warm | 1.65 | 78.7 | 1.50 | 2.37 | 81.3 | 1.85 | **0.02x** | **1.10x** |
| `trace_window` | cold | 1.01 | 31.8 | 1.36 | 1.39 | 34.2 | 1.80 | **0.03x** | **0.74x** |
| `trace_window` | warm | 1.64 | 31.9 | 1.40 | 2.35 | 34.2 | 2.07 | **0.05x** | **1.17x** |
| `rate` | cold | 1.26 | 10.5 | 0.43 | 1.51 | 11.9 | 0.50 | **0.12x** | **2.95x** |
| `rate` | warm | 1.61 | 10.7 | 0.42 | 2.09 | 11.9 | 0.70 | **0.15x** | **3.83x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 48.4 | 177 | 27.9 | **0.27x** | **1.73x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 11.9 | 8.35 | 13.2 | **1.42x** | **0.90x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 4.60 | 23.8 | 8.01 | **0.19x** | **0.57x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 1.92 | 10.6 | 11.4 | **0.18x** | **0.17x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 44.0 | 51.9 | 13.4 | **0.85x** | **3.29x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 35.4 | 15.0 | 14.6 | **2.36x** | **2.42x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 1.33 | 136 | 69.5 | **0.01x** | **0.02x** | 49152 | 1582288 | 24 |
| `json_field_rare` | 100 | 2.22 | 135 | 67.5 | **0.02x** | **0.03x** | 49152 | 1582288 | 24 |
| `metadata_rare` | 20000 | 1.02 | 79.1 | 1.51 | **0.01x** | **0.67x** | 49152 | 1582288 | 24 |
| `metadata_rare` | 100 | 1.65 | 79.1 | 1.46 | **0.02x** | **1.13x** | 49152 | 1582288 | 24 |
| `trace_window` | 20000 | 1.01 | 31.8 | 1.36 | **0.03x** | **0.74x** | 49152 | 574392 | 24 |
| `trace_window` | 100 | 1.63 | 32.0 | 1.37 | **0.05x** | **1.20x** | 49152 | 574392 | 24 |
| `rate` | 20000 | 1.26 | 10.5 | 0.43 | **0.12x** | **2.95x** | 758256 | 146551 | 112 |
| `rate` | 100 | 1.31 | 10.6 | 0.45 | **0.12x** | **2.92x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1282.9 MiB | 2048.1 MiB | 559.3 MiB |
| **anonymous peak during ingest** | 982.1 MiB | 1129.5 MiB | 432.8 MiB |
| `memory.peak` during queries | 200.3 MiB | 289.0 MiB | 254.8 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442247761 | 442215574 | 442117449 |
| total on disk, settled | 87.2 MiB | 117.8 MiB | 55.4 MiB |
| of which write-ahead log | 8.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 78.3 MiB | 117.8 MiB | 55.4 MiB |
| **total per GB ingested** | 197 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 177 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 87.2 MiB | 117.8 MiB | 55.4 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9324269,/data/parts:82074935,/data/traces:4096`
* Loki — `/data/chunks:123350024,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107378,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58061559`
...
* against Loki, cold: loggytracy is 77.79x faster (1.0 ms against 79.1 ms)
* against Loki, warm: loggytracy is 47.82x faster (1.6 ms against 78.7 ms)
* against VictoriaLogs, cold: loggytracy is 1.49x faster (1.0 ms against 1.5 ms)
* against VictoriaLogs, warm: within 10% (1.6 ms against 1.5 ms)
* ingest: loggytracy achieved 19753 eps against Loki's 19869 and VictoriaLogs' 19937
* disk: loggytracy's settled data is 0.66x Loki's and 1.41x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.18x faster (44.0 ms against 51.9 ms)
against Loki and loggytracy is 3.29x slower (44.0 ms against 13.4 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19753 / 19869 / 19937 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 20:53:13.871448828 +0900
+++ /dev/fd/62	2026-08-06 20:53:13.871448828 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T11:52:55.693117Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T11:52:55.693172Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T11:52:55.693322Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T11:52:55.697105Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T11:52:55.697112Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T11:52:55.697143Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T11:52:55.697155Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
