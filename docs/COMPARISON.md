...
**Generated by `compare/run.sh` on 2026-07-31T03:56:54Z, from revision `9195188` (`master`). Do not edit
...
|---|---|---|---|
| build | `9195188` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 18647 | 19859 | 19937 |
| events accepted | 1200100 | 1200500 | 1200400 |
| elapsed s | 64.4 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12001 | 12005 | 12004 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.12 | 1.05 | 0.34 |
| push service p95 ms | 2.54 | 3.29 | 0.59 |
| push service p99 ms | 7.88 | 5.29 | 1.01 |
| push response p50 ms | 3.05 | 2.79 | 1.52 |
| push response p95 ms | 3.70 | 5.21 | 1.99 |
| push response p99 ms | 8.80 | 8.85 | 2.34 |
| latency samples | 10001 | 10005 | 10004 |
| line bytes offered | 392928494 | 393057634 | 393026236 |
| wire bytes (snappy) | 189226979 | 189293374 | 189276192 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 57.9 | 176 | 31.3 | 69.2 | 184 | 34.5 | **0.33x** | **1.85x** |
| `label_only` | warm | 57.5 | 177 | 27.2 | 64.8 | 186 | 32.0 | **0.32x** | **2.11x** |
| `line_filter` | cold | 21.4 | 24.0 | 7.95 | 28.2 | 26.1 | 9.82 | **0.89x** | **2.69x** |
| `line_filter` | warm | 21.3 | 23.6 | 7.05 | 28.6 | 26.5 | 9.28 | **0.90x** | **3.02x** |
| `json_field` | cold | 49.1 | 52.2 | 6.95 | 56.8 | 68.4 | 9.07 | **0.94x** | **7.07x** |
| `json_field` | warm | 49.1 | 52.8 | 7.16 | 56.7 | 68.3 | 9.22 | **0.93x** | **6.86x** |
| `json_field_rare` | cold | 44.3 | 136 | 1.48 | 50.9 | 140 | 2.01 | **0.33x** | **29.99x** |
| `json_field_rare` | warm | 44.1 | 136 | 1.47 | 51.0 | 139 | 1.89 | **0.32x** | **29.96x** |
| `metadata_rare` | cold | 19.2 | 79.4 | 1.52 | 21.3 | 81.6 | 2.08 | **0.24x** | **12.62x** |
| `metadata_rare` | warm | 19.2 | 79.1 | 1.49 | 21.5 | 81.8 | 1.84 | **0.24x** | **12.91x** |
| `rate` | cold | 25.2 | 10.8 | 0.41 | 34.1 | 11.7 | 0.50 | **2.33x** | **60.91x** |
| `rate` | warm | 25.0 | 10.6 | 0.41 | 34.2 | 11.8 | 0.81 | **2.36x** | **60.99x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 57.9 | 176 | 31.3 | **0.33x** | **1.85x** | 963272 | 156516 | 150000 |
| `label_only` | 100 | 15.8 | 8.09 | 14.4 | **1.96x** | **1.10x** | 415974 | 13686 | 2400 |
| `line_filter` | 20000 | 21.4 | 24.0 | 7.95 | **0.89x** | **2.69x** | 963272 | 157304 | 10208 |
| `line_filter` | 100 | 17.5 | 10.5 | 11.5 | **1.67x** | **1.53x** | 597694 | 85550 | 2400 |
| `json_field` | 20000 | 49.1 | 52.2 | 6.95 | **0.94x** | **7.07x** | 963272 | 156988 | 17661 |
| `json_field` | 100 | 24.2 | 14.7 | 10.1 | **1.65x** | **2.39x** | 496835 | 79279 | 2400 |
| `json_field_rare` | 20000 | 44.3 | 136 | 1.48 | **0.33x** | **29.99x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 43.7 | 135 | 1.43 | **0.32x** | **30.47x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 19.2 | 79.4 | 1.52 | **0.24x** | **12.62x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 19.1 | 79.1 | 1.43 | **0.24x** | **13.36x** | 589824 | 1582288 | 24 |
| `rate` | 20000 | 25.2 | 10.8 | 0.41 | **2.33x** | **60.91x** | 963272 | 146551 | 112 |
| `rate` | 100 | 25.2 | 10.6 | 0.41 | **2.38x** | **62.07x** | 963272 | 146551 | 112 |
...
| `memory.peak` during ingest | 1873.0 MiB | 2048.1 MiB | 690.3 MiB |
| **anonymous peak during ingest** | 1317.0 MiB | 1129.6 MiB | 426.6 MiB |
| `memory.peak` during queries | 100.8 MiB | 266.0 MiB | 212.0 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 441958323 | 442087463 | 442056065 |
| total on disk, settled | 592.9 MiB | 117.7 MiB | 58.0 MiB |
| of which write-ahead log | 541.6 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 51.4 MiB | 117.7 MiB | 58.0 MiB |
| **total per GB ingested** | 1342 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 116 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 592.9 MiB | 117.8 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:567856693,/data/parts:53850128,/data/traces:4096`
* Loki — `/data/chunks:123266717,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95679,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60820164`
...
* against Loki, cold: loggytracy is 4.14x faster (19.2 ms against 79.4 ms)
* against Loki, warm: loggytracy is 4.12x faster (19.2 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 12.62x slower (19.2 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 12.91x slower (19.2 ms against 1.5 ms)
* ingest: loggytracy achieved 18647 eps against Loki's 19859 and VictoriaLogs' 19937
* disk: loggytracy's settled data is 0.44x Loki's and 0.89x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is within 10% (49.1 ms against 52.2 ms)
against Loki and loggytracy is 7.07x slower (49.1 ms against 6.9 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (18647 / 19859 / 19937 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 12:46:54.856705394 +0900
+++ /dev/fd/62	2026-07-31 12:46:54.852705380 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T03:46:36.675905Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T03:46:36.676061Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T03:46:36.679937Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T03:46:36.679943Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T03:46:36.679970Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T03:46:36.679974Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
