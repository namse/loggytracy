...
**Generated by `compare/run.sh` on 2026-08-02T11:33:25Z, from revision `3b642fe` (`master`). Do not edit
...
|---|---|---|---|
| build | `3b642fe` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19639 | 19872 | 19931 |
| events accepted | 1201000 | 1201100 | 1200300 |
| elapsed s | 61.2 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12010 | 12011 | 12003 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.34 | 1.12 | 0.26 |
| push service p95 ms | 12.8 | 3.53 | 0.47 |
| push service p99 ms | 16.9 | 6.31 | 1.08 |
| push response p50 ms | 3.94 | 2.37 | 1.88 |
| push response p95 ms | 14.1 | 5.17 | 2.35 |
| push response p99 ms | 62.2 | 22.9 | 2.86 |
| latency samples | 10010 | 10011 | 10003 |
| line bytes offered | 393217932 | 393250374 | 392997605 |
| wire bytes (OTLP protobuf) | 512262270 | 512304607 | 511972576 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 52.3 | 172 | 29.0 | 68.9 | 178 | 33.1 | **0.30x** | **1.80x** |
| `label_only` | warm | 51.0 | 178 | 25.5 | 54.9 | 188 | 30.3 | **0.29x** | **2.00x** |
| `line_filter` | cold | 20.6 | 23.6 | 7.68 | 24.1 | 25.0 | 9.71 | **0.87x** | **2.68x** |
| `line_filter` | warm | 20.4 | 23.8 | 7.18 | 24.6 | 26.5 | 10.3 | **0.86x** | **2.84x** |
| `json_field` | cold | 30.7 | 51.4 | 13.9 | 35.0 | 67.9 | 15.4 | **0.60x** | **2.21x** |
| `json_field` | warm | 30.7 | 52.8 | 12.8 | 35.9 | 69.3 | 15.4 | **0.58x** | **2.39x** |
| `json_field_rare` | cold | 3.01 | 135 | 66.8 | 3.21 | 138 | 73.1 | **0.02x** | **0.05x** |
| `json_field_rare` | warm | 3.12 | 135 | 67.2 | 3.45 | 139 | 71.3 | **0.02x** | **0.05x** |
| `metadata_rare` | cold | 2.51 | 78.9 | 0.52 | 2.59 | 80.4 | 1.20 | **0.03x** | **4.78x** |
| `metadata_rare` | warm | 2.57 | 78.9 | 0.52 | 2.94 | 81.1 | 1.21 | **0.03x** | **4.98x** |
| `trace_window` | cold | 2.43 | 31.8 | 0.46 | 2.45 | 33.8 | 1.01 | **0.08x** | **5.23x** |
| `trace_window` | warm | 2.45 | 31.9 | 0.49 | 2.75 | 34.4 | 1.09 | **0.08x** | **5.04x** |
| `rate` | cold | 3.18 | 10.8 | 0.42 | 4.00 | 12.1 | 0.56 | **0.30x** | **7.54x** |
| `rate` | warm | 3.25 | 10.5 | 0.42 | 4.23 | 12.3 | 0.50 | **0.31x** | **7.79x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 52.3 | 172 | 29.0 | **0.30x** | **1.80x** | 901616 | 156516 | 150000 |
| `label_only` | 100 | 17.3 | 8.22 | 13.5 | **2.10x** | **1.28x** | 313023 | 13686 | 2400 |
| `line_filter` | 20000 | 20.6 | 23.6 | 7.68 | **0.87x** | **2.68x** | 901616 | 157304 | 10208 |
| `line_filter` | 100 | 17.9 | 10.6 | 11.3 | **1.68x** | **1.58x** | 524116 | 85550 | 2400 |
| `json_field` | 20000 | 30.7 | 51.4 | 13.9 | **0.60x** | **2.21x** | 901616 | 156988 | 17661 |
| `json_field` | 100 | 21.3 | 14.7 | 14.6 | **1.44x** | **1.46x** | 901616 | 79279 | 2400 |
| `json_field_rare` | 20000 | 3.01 | 135 | 66.8 | **0.02x** | **0.05x** | 376832 | 1582288 | 24 |
| `json_field_rare` | 100 | 3.15 | 135 | 66.0 | **0.02x** | **0.05x** | 376832 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.51 | 78.9 | 0.52 | **0.03x** | **4.78x** | 376832 | 1582288 | 24 |
| `metadata_rare` | 100 | 2.64 | 78.9 | 0.49 | **0.03x** | **5.42x** | 376832 | 1582288 | 24 |
| `trace_window` | 20000 | 2.43 | 31.8 | 0.46 | **0.08x** | **5.23x** | 229376 | 574392 | 24 |
| `trace_window` | 100 | 2.54 | 31.8 | 0.47 | **0.08x** | **5.40x** | 229376 | 574392 | 24 |
| `rate` | 20000 | 3.18 | 10.8 | 0.42 | **0.30x** | **7.54x** | 901616 | 146551 | 112 |
| `rate` | 100 | 3.35 | 10.8 | 0.40 | **0.31x** | **8.34x** | 901616 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.1 MiB | 1783.1 MiB | 577.2 MiB |
| **anonymous peak during ingest** | 1278.4 MiB | 1152.4 MiB | 435.7 MiB |
| `memory.peak` during queries | 108.2 MiB | 310.0 MiB | 269.7 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442247761 | 442280203 | 442027434 |
| total on disk, settled | 614.4 MiB | 117.8 MiB | 55.4 MiB |
| of which write-ahead log | 549.0 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 65.4 MiB | 117.8 MiB | 55.4 MiB |
| **total per GB ingested** | 1389 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 148 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 614.4 MiB | 117.9 MiB | 55.4 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:575660544,/data/parts:68615273,/data/traces:4096`
* Loki — `/data/chunks:123376472,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107561,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58039894`
...
* against Loki, cold: loggytracy is 31.49x faster (2.5 ms against 78.9 ms)
* against Loki, warm: loggytracy is 30.66x faster (2.6 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 4.78x slower (2.5 ms against 0.5 ms)
* against VictoriaLogs, warm: loggytracy is 4.98x slower (2.6 ms against 0.5 ms)
* ingest: loggytracy achieved 19639 eps against Loki's 19872 and VictoriaLogs' 19931
* disk: loggytracy's settled data is 0.56x Loki's and 1.18x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.68x faster (30.7 ms against 51.4 ms)
against Loki and loggytracy is 2.21x slower (30.7 ms against 13.9 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19639 / 19872 / 19931 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-02 20:22:56.773389939 +0900
+++ /dev/fd/62	2026-08-02 20:22:56.773389939 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-02T11:22:38.588955Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-02T11:22:38.589131Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-02T11:22:38.594551Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-02T11:22:38.594558Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-02T11:22:38.594588Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-02T11:22:38.594591Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
