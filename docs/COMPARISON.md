...
**Generated by `compare/run.sh` on 2026-08-06T07:41:29Z, from revision `9ae6893` (`master`). Do not edit
...
|---|---|---|---|
| build | `9ae6893` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19769 | 19864 | 19932 |
| events accepted | 1200300 | 1200800 | 1200300 |
| elapsed s | 60.7 | 60.5 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12003 | 12008 | 12003 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.19 | 1.11 | 0.26 |
| push service p95 ms | 3.66 | 3.46 | 0.49 |
| push service p99 ms | 8.30 | 5.80 | 1.12 |
| push response p50 ms | 3.80 | 2.08 | 1.14 |
| push response p95 ms | 5.21 | 4.59 | 1.62 |
| push response p99 ms | 9.91 | 9.58 | 2.16 |
| latency samples | 10003 | 10008 | 10003 |
| line bytes offered | 392997605 | 393151549 | 392997605 |
| wire bytes (OTLP protobuf) | 511972576 | 512176066 | 511972576 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 69.5 | 177 | 27.7 | 79.4 | 185 | 31.9 | **0.39x** | **2.51x** |
| `label_only` | warm | 70.2 | 178 | 25.7 | 79.2 | 187 | 30.1 | **0.40x** | **2.74x** |
| `line_filter` | cold | 33.7 | 23.5 | 7.34 | 40.1 | 26.3 | 10.2 | **1.43x** | **4.59x** |
| `line_filter` | warm | 34.4 | 23.8 | 7.41 | 42.8 | 26.0 | 9.94 | **1.44x** | **4.64x** |
| `json_field` | cold | 46.8 | 52.5 | 13.7 | 51.7 | 68.9 | 15.2 | **0.89x** | **3.41x** |
| `json_field` | warm | 48.1 | 52.1 | 13.1 | 54.7 | 69.9 | 15.6 | **0.92x** | **3.68x** |
| `json_field_rare` | cold | 3.59 | 135 | 68.7 | 4.31 | 139 | 72.2 | **0.03x** | **0.05x** |
| `json_field_rare` | warm | 3.91 | 135 | 68.5 | 4.43 | 138 | 71.6 | **0.03x** | **0.06x** |
| `metadata_rare` | cold | 3.41 | 78.7 | 1.32 | 3.58 | 80.9 | 1.92 | **0.04x** | **2.59x** |
| `metadata_rare` | warm | 3.66 | 78.9 | 1.32 | 3.99 | 81.3 | 1.75 | **0.05x** | **2.77x** |
| `trace_window` | cold | 3.42 | 31.9 | 1.22 | 3.58 | 33.9 | 1.55 | **0.11x** | **2.80x** |
| `trace_window` | warm | 3.63 | 31.8 | 1.16 | 3.86 | 34.2 | 1.43 | **0.11x** | **3.13x** |
| `rate` | cold | 2.73 | 11.1 | 0.43 | 3.51 | 12.0 | 0.48 | **0.25x** | **6.37x** |
| `rate` | warm | 2.70 | 10.6 | 0.43 | 3.55 | 12.0 | 0.61 | **0.25x** | **6.34x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 69.5 | 177 | 27.7 | **0.39x** | **2.51x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 33.7 | 8.10 | 12.6 | **4.16x** | **2.67x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 33.7 | 23.5 | 7.34 | **1.43x** | **4.59x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 32.1 | 10.5 | 11.8 | **3.07x** | **2.72x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 46.8 | 52.5 | 13.7 | **0.89x** | **3.41x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 37.6 | 14.6 | 13.7 | **2.58x** | **2.74x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 3.59 | 135 | 68.7 | **0.03x** | **0.05x** | 49152 | 1582288 | 24 |
| `json_field_rare` | 100 | 4.35 | 135 | 68.0 | **0.03x** | **0.06x** | 49152 | 1582288 | 24 |
| `metadata_rare` | 20000 | 3.41 | 78.7 | 1.32 | **0.04x** | **2.59x** | 49152 | 1582288 | 24 |
| `metadata_rare` | 100 | 4.08 | 78.7 | 1.32 | **0.05x** | **3.10x** | 49152 | 1582288 | 24 |
| `trace_window` | 20000 | 3.42 | 31.9 | 1.22 | **0.11x** | **2.80x** | 49152 | 574392 | 24 |
| `trace_window` | 100 | 4.00 | 31.6 | 1.25 | **0.13x** | **3.20x** | 49152 | 574392 | 24 |
| `rate` | 20000 | 2.73 | 11.1 | 0.43 | **0.25x** | **6.37x** | 758256 | 146551 | 112 |
| `rate` | 100 | 2.67 | 10.6 | 0.41 | **0.25x** | **6.57x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 822.0 MiB | 2048.1 MiB | 622.9 MiB |
| **anonymous peak during ingest** | 571.7 MiB | 1123.2 MiB | 405.4 MiB |
| `memory.peak` during queries | 82.2 MiB | 294.2 MiB | 257.5 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442027434 | 442181378 | 442027434 |
| total on disk, settled | 95.8 MiB | 117.8 MiB | 55.3 MiB |
| of which write-ahead log | 25.5 MiB | 0.0 MiB | -0.0 MiB |
...
| total after the query phase | 95.8 MiB | 117.8 MiB | 55.3 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:26687728,/data/parts:73742975,/data/traces:4096`
* Loki — `/data/chunks:123338227,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107500,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58031425`
...
* against Loki, cold: loggytracy is 23.09x faster (3.4 ms against 78.7 ms)
* against Loki, warm: loggytracy is 21.58x faster (3.7 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 2.59x slower (3.4 ms against 1.3 ms)
* against VictoriaLogs, warm: loggytracy is 2.77x slower (3.7 ms against 1.3 ms)
* ingest: loggytracy achieved 19769 eps against Loki's 19864 and VictoriaLogs' 19932
* disk: loggytracy's settled data is 0.60x Loki's and 1.27x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.12x faster (46.8 ms against 52.5 ms)
against Loki and loggytracy is 3.41x slower (46.8 ms against 13.7 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19769 / 19864 / 19932 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 16:30:46.877244757 +0900
+++ /dev/fd/62	2026-08-06 16:30:46.877244757 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T07:30:28.697442Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T07:30:28.697509Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T07:30:28.697653Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T07:30:28.702719Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T07:30:28.702728Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T07:30:28.702760Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T07:30:28.702764Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
