...
**Generated by `compare/run.sh` on 2026-07-31T08:05:27Z, from revision `d91014b` (`master`). Do not edit
...
|---|---|---|---|
| build | `d91014b` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19066 | 19865 | 19928 |
| events accepted | 1201000 | 1200800 | 1200100 |
| elapsed s | 63.0 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12010 | 12008 | 12001 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.18 | 1.07 | 0.34 |
| push service p95 ms | 12.2 | 3.37 | 0.60 |
| push service p99 ms | 14.5 | 5.47 | 1.09 |
| push response p50 ms | 3.82 | 2.49 | 1.44 |
| push response p95 ms | 13.5 | 5.02 | 1.91 |
| push response p99 ms | 56.3 | 9.97 | 2.36 |
| latency samples | 10010 | 10008 | 10001 |
| line bytes offered | 393217932 | 393151549 | 392928494 |
| wire bytes (snappy) | 189373936 | 189339471 | 189230702 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 48.7 | 177 | 30.5 | 60.5 | 182 | 33.8 | **0.28x** | **1.60x** |
| `label_only` | warm | 48.3 | 176 | 27.9 | 54.4 | 187 | 31.9 | **0.27x** | **1.73x** |
| `line_filter` | cold | 18.9 | 23.7 | 7.70 | 24.9 | 27.2 | 9.54 | **0.80x** | **2.45x** |
| `line_filter` | warm | 18.8 | 23.6 | 7.71 | 24.9 | 26.2 | 9.76 | **0.80x** | **2.44x** |
| `json_field` | cold | 25.3 | 52.6 | 7.38 | 30.5 | 67.1 | 8.83 | **0.48x** | **3.43x** |
| `json_field` | warm | 25.0 | 52.1 | 7.28 | 30.6 | 68.3 | 9.21 | **0.48x** | **3.43x** |
| `json_field_rare` | cold | 5.88 | 136 | 1.62 | 6.00 | 138 | 2.21 | **0.04x** | **3.62x** |
| `json_field_rare` | warm | 5.76 | 136 | 1.57 | 6.10 | 138 | 2.60 | **0.04x** | **3.67x** |
| `metadata_rare` | cold | 5.24 | 79.4 | 1.64 | 5.37 | 81.9 | 2.11 | **0.07x** | **3.19x** |
| `metadata_rare` | warm | 5.23 | 79.1 | 1.54 | 5.44 | 81.1 | 2.37 | **0.07x** | **3.41x** |
| `rate` | cold | 8.35 | 10.8 | 0.41 | 10.4 | 12.1 | 0.53 | **0.77x** | **20.62x** |
| `rate` | warm | 8.32 | 10.6 | 0.40 | 10.3 | 12.6 | 0.68 | **0.78x** | **20.55x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 48.7 | 177 | 30.5 | **0.28x** | **1.60x** | 791520 | 156516 | 150000 |
| `label_only` | 100 | 13.3 | 8.19 | 15.7 | **1.62x** | **0.85x** | 319699 | 13686 | 2400 |
| `line_filter` | 20000 | 18.9 | 23.7 | 7.70 | **0.80x** | **2.45x** | 791520 | 157304 | 10208 |
| `line_filter` | 100 | 15.3 | 10.6 | 11.8 | **1.44x** | **1.29x** | 469065 | 85550 | 2400 |
| `json_field` | 20000 | 25.3 | 52.6 | 7.38 | **0.48x** | **3.43x** | 791520 | 156988 | 17661 |
| `json_field` | 100 | 15.2 | 14.7 | 10.6 | **1.03x** | **1.43x** | 791520 | 79279 | 2400 |
| `json_field_rare` | 20000 | 5.88 | 136 | 1.62 | **0.04x** | **3.62x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 5.91 | 136 | 1.52 | **0.04x** | **3.88x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 5.24 | 79.4 | 1.64 | **0.07x** | **3.19x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 5.28 | 79.0 | 1.52 | **0.07x** | **3.48x** | 589824 | 1582288 | 24 |
| `rate` | 20000 | 8.35 | 10.8 | 0.41 | **0.77x** | **20.62x** | 791520 | 146551 | 112 |
| `rate` | 100 | 8.36 | 10.6 | 0.42 | **0.79x** | **20.15x** | 791520 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 696.5 MiB |
| **anonymous peak during ingest** | 1195.6 MiB | 1096.4 MiB | 417.7 MiB |
| `memory.peak` during queries | 111.0 MiB | 341.9 MiB | 234.5 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442247761 | 442181378 | 441958323 |
| total on disk, settled | 611.9 MiB | 117.8 MiB | 57.9 MiB |
| of which write-ahead log | 541.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.0 MiB | 117.8 MiB | 57.9 MiB |
| **total per GB ingested** | 1384 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 158 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 611.9 MiB | 117.8 MiB | 57.9 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568231471,/data/parts:73351328,/data/traces:4096`
* Loki — `/data/chunks:123365331,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:76523,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60758874`
...
* against Loki, cold: loggytracy is 15.14x faster (5.2 ms against 79.4 ms)
* against Loki, warm: loggytracy is 15.12x faster (5.2 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 3.19x slower (5.2 ms against 1.6 ms)
* against VictoriaLogs, warm: loggytracy is 3.41x slower (5.2 ms against 1.5 ms)
* ingest: loggytracy achieved 19066 eps against Loki's 19865 and VictoriaLogs' 19928
* disk: loggytracy's settled data is 0.59x Loki's and 1.21x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.08x faster (25.3 ms against 52.6 ms)
against Loki and loggytracy is 3.43x slower (25.3 ms against 7.4 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19066 / 19865 / 19928 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 16:55:38.283683156 +0900
+++ /dev/fd/62	2026-07-31 16:55:38.283683156 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T07:55:20.106104Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T07:55:20.106251Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T07:55:20.110717Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T07:55:20.110725Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T07:55:20.110757Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T07:55:20.110762Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
