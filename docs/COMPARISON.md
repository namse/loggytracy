...
**Generated by `compare/run.sh` on 2026-07-31T07:43:00Z, from revision `b275eff` (`master`). Do not edit
...
|---|---|---|---|
| build | `b275eff` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19144 | 19870 | 19937 |
| events accepted | 1201100 | 1201100 | 1200500 |
| elapsed s | 62.7 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12011 | 12011 | 12005 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.12 | 1.07 | 0.34 |
| push service p95 ms | 2.52 | 3.37 | 0.58 |
| push service p99 ms | 7.90 | 5.28 | 1.04 |
| push response p50 ms | 3.74 | 2.49 | 1.46 |
| push response p95 ms | 4.37 | 4.96 | 1.93 |
| push response p99 ms | 9.60 | 9.32 | 2.32 |
| latency samples | 10011 | 10011 | 10005 |
| line bytes offered | 393250374 | 393250374 | 393057634 |
| wire bytes (snappy) | 189379911 | 189378387 | 189285717 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 54.2 | 175 | 31.2 | 68.8 | 181 | 34.7 | **0.31x** | **1.74x** |
| `label_only` | warm | 53.8 | 177 | 27.3 | 57.0 | 188 | 31.1 | **0.30x** | **1.97x** |
| `line_filter` | cold | 18.6 | 23.6 | 7.57 | 21.8 | 26.1 | 9.18 | **0.79x** | **2.46x** |
| `line_filter` | warm | 18.8 | 23.5 | 7.01 | 22.1 | 26.8 | 8.51 | **0.80x** | **2.68x** |
| `json_field` | cold | 24.9 | 52.4 | 7.27 | 29.3 | 67.0 | 8.83 | **0.47x** | **3.42x** |
| `json_field` | warm | 24.8 | 52.1 | 7.07 | 29.8 | 67.7 | 8.73 | **0.48x** | **3.51x** |
| `json_field_rare` | cold | 5.73 | 136 | 1.60 | 5.95 | 139 | 2.20 | **0.04x** | **3.58x** |
| `json_field_rare` | warm | 5.75 | 136 | 1.42 | 6.11 | 138 | 1.83 | **0.04x** | **4.05x** |
| `metadata_rare` | cold | 5.23 | 79.4 | 1.38 | 5.30 | 81.1 | 1.76 | **0.07x** | **3.78x** |
| `metadata_rare` | warm | 5.20 | 79.2 | 1.38 | 5.52 | 81.5 | 1.66 | **0.07x** | **3.75x** |
| `rate` | cold | 11.4 | 10.7 | 0.43 | 12.7 | 11.8 | 0.66 | **1.06x** | **26.34x** |
| `rate` | warm | 11.5 | 10.5 | 0.41 | 12.9 | 11.9 | 0.72 | **1.09x** | **28.08x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 54.2 | 175 | 31.2 | **0.31x** | **1.74x** | 791520 | 156516 | 150000 |
| `label_only` | 100 | 13.7 | 7.90 | 14.0 | **1.74x** | **0.98x** | 320577 | 13686 | 2400 |
| `line_filter` | 20000 | 18.6 | 23.6 | 7.57 | **0.79x** | **2.46x** | 791520 | 157304 | 10208 |
| `line_filter` | 100 | 15.1 | 10.4 | 11.8 | **1.45x** | **1.28x** | 451678 | 85550 | 2400 |
| `json_field` | 20000 | 24.9 | 52.4 | 7.27 | **0.47x** | **3.42x** | 791520 | 156988 | 17661 |
| `json_field` | 100 | 15.0 | 15.0 | 9.21 | **1.00x** | **1.63x** | 791520 | 79279 | 2400 |
| `json_field_rare` | 20000 | 5.73 | 136 | 1.60 | **0.04x** | **3.58x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 5.85 | 136 | 1.36 | **0.04x** | **4.29x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 5.23 | 79.4 | 1.38 | **0.07x** | **3.78x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 5.22 | 79.0 | 1.39 | **0.07x** | **3.75x** | 589824 | 1582288 | 24 |
| `rate` | 20000 | 11.4 | 10.7 | 0.43 | **1.06x** | **26.34x** | 791520 | 146551 | 112 |
| `rate` | 100 | 11.5 | 10.8 | 0.39 | **1.06x** | **29.21x** | 791520 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 709.6 MiB |
| **anonymous peak during ingest** | 1291.0 MiB | 1104.6 MiB | 425.1 MiB |
| `memory.peak` during queries | 127.0 MiB | 255.7 MiB | 215.1 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442280203 | 442280203 | 442087463 |
| total on disk, settled | 611.5 MiB | 117.8 MiB | 58.0 MiB |
| of which write-ahead log | 541.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 69.5 MiB | 117.8 MiB | 58.0 MiB |
| **total per GB ingested** | 1383 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 157 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 611.5 MiB | 117.8 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568273470,/data/parts:72919063,/data/traces:4096`
* Loki — `/data/chunks:123338617,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95801,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60848824`
...
* against Loki, cold: loggytracy is 15.19x faster (5.2 ms against 79.4 ms)
* against Loki, warm: loggytracy is 15.24x faster (5.2 ms against 79.2 ms)
* against VictoriaLogs, cold: loggytracy is 3.78x slower (5.2 ms against 1.4 ms)
* against VictoriaLogs, warm: loggytracy is 3.75x slower (5.2 ms against 1.4 ms)
* ingest: loggytracy achieved 19144 eps against Loki's 19870 and VictoriaLogs' 19937
* disk: loggytracy's settled data is 0.59x Loki's and 1.20x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.11x faster (24.9 ms against 52.4 ms)
against Loki and loggytracy is 3.42x slower (24.9 ms against 7.3 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19144 / 19870 / 19937 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 16:33:10.132825034 +0900
+++ /dev/fd/62	2026-07-31 16:33:10.132825034 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T07:32:51.946268Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T07:32:51.946443Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T07:32:51.956575Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T07:32:51.956582Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T07:32:51.956605Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T07:32:51.956609Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
