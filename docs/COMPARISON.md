...
**Generated by `compare/run.sh` on 2026-08-03T01:40:16Z, from revision `4a630d8` (`master`). Do not edit
...
|---|---|---|---|
| build | `4a630d8` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19771 | 19855 | 19932 |
| events accepted | 1200100 | 1200500 | 1200300 |
| elapsed s | 60.7 | 60.5 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12001 | 12005 | 12003 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.22 | 1.12 | 0.26 |
| push service p95 ms | 3.59 | 3.49 | 0.45 |
| push service p99 ms | 8.56 | 5.42 | 0.98 |
| push response p50 ms | 3.33 | 2.41 | 1.54 |
| push response p95 ms | 4.66 | 4.97 | 2.00 |
| push response p99 ms | 9.70 | 9.98 | 2.45 |
| latency samples | 10001 | 10005 | 10003 |
| line bytes offered | 392928494 | 393057634 | 392997605 |
| wire bytes (OTLP protobuf) | 511883658 | 512052424 | 511972576 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 50.0 | 176 | 28.3 | 77.5 | 185 | 32.1 | **0.28x** | **1.77x** |
| `label_only` | warm | 51.4 | 177 | 25.1 | 55.5 | 185 | 29.3 | **0.29x** | **2.05x** |
| `line_filter` | cold | 16.8 | 23.8 | 7.82 | 20.4 | 26.6 | 10.8 | **0.71x** | **2.15x** |
| `line_filter` | warm | 17.1 | 23.8 | 7.26 | 20.7 | 26.3 | 9.90 | **0.72x** | **2.36x** |
| `json_field` | cold | 27.6 | 52.4 | 13.9 | 32.2 | 68.3 | 15.5 | **0.53x** | **1.98x** |
| `json_field` | warm | 27.3 | 51.8 | 12.9 | 32.0 | 68.6 | 15.1 | **0.53x** | **2.12x** |
| `json_field_rare` | cold | 3.08 | 135 | 73.5 | 3.14 | 137 | 78.9 | **0.02x** | **0.04x** |
| `json_field_rare` | warm | 3.08 | 136 | 68.6 | 3.31 | 139 | 73.3 | **0.02x** | **0.04x** |
| `metadata_rare` | cold | 2.62 | 78.9 | 1.48 | 2.77 | 81.2 | 1.96 | **0.03x** | **1.77x** |
| `metadata_rare` | warm | 2.57 | 78.8 | 1.40 | 2.83 | 81.4 | 1.81 | **0.03x** | **1.84x** |
| `trace_window` | cold | 2.50 | 31.9 | 1.33 | 2.67 | 33.7 | 2.07 | **0.08x** | **1.89x** |
| `trace_window` | warm | 2.43 | 31.9 | 1.27 | 2.52 | 34.0 | 1.87 | **0.08x** | **1.91x** |
| `rate` | cold | 2.66 | 11.3 | 0.42 | 3.43 | 11.6 | 0.51 | **0.24x** | **6.29x** |
| `rate` | warm | 2.64 | 10.8 | 0.42 | 3.45 | 12.5 | 0.52 | **0.24x** | **6.26x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 50.0 | 176 | 28.3 | **0.28x** | **1.77x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 30.6 | 8.15 | 13.2 | **3.76x** | **2.32x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 16.8 | 23.8 | 7.82 | **0.71x** | **2.15x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 29.5 | 10.5 | 11.9 | **2.81x** | **2.48x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 27.6 | 52.4 | 13.9 | **0.53x** | **1.98x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 36.6 | 14.7 | 15.0 | **2.49x** | **2.43x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 3.08 | 135 | 73.5 | **0.02x** | **0.04x** | 360448 | 1582288 | 24 |
| `json_field_rare` | 100 | 4.61 | 135 | 67.7 | **0.03x** | **0.07x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.62 | 78.9 | 1.48 | **0.03x** | **1.77x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 100 | 3.92 | 78.9 | 1.42 | **0.05x** | **2.77x** | 360448 | 1582288 | 24 |
| `trace_window` | 20000 | 2.50 | 31.9 | 1.33 | **0.08x** | **1.89x** | 212992 | 574392 | 24 |
| `trace_window` | 100 | 3.79 | 31.7 | 1.35 | **0.12x** | **2.82x** | 212992 | 574392 | 24 |
| `rate` | 20000 | 2.66 | 11.3 | 0.42 | **0.24x** | **6.29x** | 758256 | 146551 | 112 |
| `rate` | 100 | 2.69 | 10.7 | 0.42 | **0.25x** | **6.39x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 922.7 MiB | 2048.1 MiB | 706.9 MiB |
| **anonymous peak during ingest** | 674.6 MiB | 1138.8 MiB | 451.8 MiB |
| `memory.peak` during queries | 79.2 MiB | 357.4 MiB | 273.9 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 441958323 | 442087463 | 442027434 |
| total on disk, settled | 96.5 MiB | 117.7 MiB | 55.0 MiB |
| of which write-ahead log | 26.2 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.3 MiB | 117.7 MiB | 55.0 MiB |
| **total per GB ingested** | 218 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 159 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 96.5 MiB | 117.8 MiB | 55.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:27514240,/data/parts:73658878,/data/traces:4096`
* Loki — `/data/chunks:123295253,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107378,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:57715682`
...
* against Loki, cold: loggytracy is 30.10x faster (2.6 ms against 78.9 ms)
* against Loki, warm: loggytracy is 30.68x faster (2.6 ms against 78.8 ms)
* against VictoriaLogs, cold: loggytracy is 1.77x slower (2.6 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 1.84x slower (2.6 ms against 1.4 ms)
* ingest: loggytracy achieved 19771 eps against Loki's 19855 and VictoriaLogs' 19932
* disk: loggytracy's settled data is 0.60x Loki's and 1.28x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.90x faster (27.6 ms against 52.4 ms)
against Loki and loggytracy is 1.98x slower (27.6 ms against 13.9 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **27% of loggytracy's disk number is a write-ahead log the bed's own configuration stops it from compacting.** `flush.rs:219` compacts the WAL only when an object store is configured, and this bed runs loggytracy local-only so that it keeps one durable copy of a part rather than two. The two choices are in tension and I did not find a configuration that avoids both; the table reports the total and the WAL-excluded figure separately rather than picking one. The WAL-excluded row is the one to compare engines on, and the total is the one an operator running local-only actually gets.

* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19771 / 19855 / 19932 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-03 10:29:44.147986242 +0900
+++ /dev/fd/62	2026-08-03 10:29:44.147986242 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-03T01:29:25.972742Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-03T01:29:25.972804Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-03T01:29:25.972955Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-03T01:29:25.978174Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-03T01:29:25.978181Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-03T01:29:25.978230Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-03T01:29:25.978236Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
