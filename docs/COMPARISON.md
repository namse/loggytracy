...
**Generated by `compare/run.sh` on 2026-07-31T06:24:48Z, from revision `6f3f06e` (`master`). Do not edit
...
|---|---|---|---|
| build | `6f3f06e` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19818 | 19860 | 19941 |
| events accepted | 1201000 | 1200500 | 1200700 |
| elapsed s | 60.6 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12010 | 12005 | 12007 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.11 | 1.05 | 0.34 |
| push service p95 ms | 2.54 | 3.27 | 0.61 |
| push service p99 ms | 7.87 | 5.29 | 1.10 |
| push response p50 ms | 3.06 | 2.67 | 1.69 |
| push response p95 ms | 3.70 | 5.14 | 2.16 |
| push response p99 ms | 8.65 | 12.5 | 2.68 |
| latency samples | 10010 | 10005 | 10007 |
| line bytes offered | 393217932 | 393057634 | 393119777 |
| wire bytes (snappy) | 189378042 | 189298028 | 189327869 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 54.4 | 175 | 30.8 | 66.8 | 180 | 33.9 | **0.31x** | **1.77x** |
| `label_only` | warm | 53.7 | 179 | 28.0 | 57.6 | 189 | 31.6 | **0.30x** | **1.92x** |
| `line_filter` | cold | 17.4 | 24.0 | 7.57 | 21.1 | 26.8 | 9.70 | **0.72x** | **2.29x** |
| `line_filter` | warm | 17.4 | 23.7 | 7.17 | 21.1 | 25.7 | 9.58 | **0.73x** | **2.43x** |
| `json_field` | cold | 45.5 | 52.0 | 7.23 | 50.6 | 67.4 | 9.14 | **0.88x** | **6.30x** |
| `json_field` | warm | 45.5 | 52.5 | 7.18 | 51.5 | 69.4 | 9.01 | **0.87x** | **6.33x** |
| `json_field_rare` | cold | 42.9 | 136 | 1.69 | 46.1 | 139 | 1.91 | **0.32x** | **25.44x** |
| `json_field_rare` | warm | 42.9 | 136 | 1.66 | 46.0 | 138 | 2.40 | **0.32x** | **25.88x** |
| `metadata_rare` | cold | 3.73 | 79.3 | 1.54 | 3.82 | 81.1 | 1.75 | **0.05x** | **2.42x** |
| `metadata_rare` | warm | 3.77 | 79.1 | 1.62 | 3.97 | 81.3 | 2.46 | **0.05x** | **2.32x** |
| `rate` | cold | 9.46 | 10.8 | 0.41 | 11.4 | 12.4 | 0.79 | **0.87x** | **23.31x** |
| `rate` | warm | 9.64 | 10.7 | 0.40 | 11.6 | 13.0 | 0.51 | **0.90x** | **24.26x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 54.4 | 175 | 30.8 | **0.31x** | **1.77x** | 747456 | 156516 | 150000 |
| `label_only` | 100 | 12.5 | 8.29 | 14.7 | **1.51x** | **0.85x** | 307770 | 13686 | 2400 |
| `line_filter` | 20000 | 17.4 | 24.0 | 7.57 | **0.72x** | **2.29x** | 747456 | 157304 | 10208 |
| `line_filter` | 100 | 14.0 | 10.6 | 11.8 | **1.32x** | **1.19x** | 438375 | 85550 | 2400 |
| `json_field` | 20000 | 45.5 | 52.0 | 7.23 | **0.88x** | **6.30x** | 747456 | 156988 | 17661 |
| `json_field` | 100 | 20.6 | 14.9 | 9.92 | **1.39x** | **2.08x** | 386982 | 79279 | 2400 |
| `json_field_rare` | 20000 | 42.9 | 136 | 1.69 | **0.32x** | **25.44x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 42.8 | 136 | 1.63 | **0.31x** | **26.25x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 3.73 | 79.3 | 1.54 | **0.05x** | **2.42x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 3.72 | 79.0 | 1.59 | **0.05x** | **2.34x** | 589824 | 1582288 | 24 |
| `rate` | 20000 | 9.46 | 10.8 | 0.41 | **0.87x** | **23.31x** | 747456 | 146551 | 112 |
| `rate` | 100 | 9.52 | 10.7 | 0.39 | **0.89x** | **24.20x** | 747456 | 146551 | 112 |
...
| `memory.peak` during ingest | 1707.5 MiB | 2048.1 MiB | 688.8 MiB |
| **anonymous peak during ingest** | 1032.9 MiB | 1120.1 MiB | 429.3 MiB |
| `memory.peak` during queries | 104.5 MiB | 289.6 MiB | 224.5 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442247761 | 442087463 | 442149606 |
| total on disk, settled | 597.7 MiB | 117.7 MiB | 58.0 MiB |
| of which write-ahead log | 541.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 55.8 MiB | 117.7 MiB | 58.0 MiB |
| **total per GB ingested** | 1351 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 126 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 597.7 MiB | 117.8 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568230021,/data/parts:58470432,/data/traces:4096`
* Loki — `/data/chunks:123290200,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95984,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60834460`
...
* against Loki, cold: loggytracy is 21.25x faster (3.7 ms against 79.3 ms)
* against Loki, warm: loggytracy is 21.01x faster (3.8 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 2.42x slower (3.7 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 2.32x slower (3.8 ms against 1.6 ms)
* ingest: loggytracy achieved 19818 eps against Loki's 19860 and VictoriaLogs' 19941
* disk: loggytracy's settled data is 0.47x Loki's and 0.96x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.14x faster (45.5 ms against 52.0 ms)
against Loki and loggytracy is 6.30x slower (45.5 ms against 7.2 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19818 / 19860 / 19941 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 15:14:39.011413979 +0900
+++ /dev/fd/62	2026-07-31 15:14:39.011413979 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T06:14:20.830324Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T06:14:20.830512Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T06:14:20.842156Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T06:14:20.842163Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T06:14:20.842194Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T06:14:20.842197Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
