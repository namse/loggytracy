...
**Generated by `compare/run.sh` on 2026-08-02T06:40:35Z, from revision `144c852` (`master`). Do not edit
...
|---|---|---|---|
| build | `144c852` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19609 | 19864 | 19929 |
| events accepted | 1201100 | 1200900 | 1200300 |
| elapsed s | 61.3 | 60.5 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12011 | 12009 | 12003 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.12 | 1.05 | 0.34 |
| push service p95 ms | 7.06 | 3.27 | 0.61 |
| push service p99 ms | 11.4 | 5.10 | 1.10 |
| push response p50 ms | 3.30 | 2.61 | 1.80 |
| push response p95 ms | 8.19 | 5.03 | 2.28 |
| push response p99 ms | 12.7 | 10.3 | 2.79 |
| latency samples | 10011 | 10009 | 10003 |
| line bytes offered | 393250374 | 393185745 | 392997605 |
| wire bytes (snappy) | 189380161 | 189337107 | 189255394 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 45.4 | 176 | 30.8 | 60.8 | 182 | 33.9 | **0.26x** | **1.47x** |
| `label_only` | warm | 44.0 | 176 | 28.1 | 48.0 | 187 | 32.6 | **0.25x** | **1.56x** |
| `line_filter` | cold | 13.8 | 23.7 | 7.35 | 17.1 | 25.3 | 9.28 | **0.58x** | **1.87x** |
| `line_filter` | warm | 13.5 | 23.6 | 7.31 | 16.8 | 26.8 | 9.41 | **0.57x** | **1.85x** |
| `json_field` | cold | 22.7 | 52.7 | 7.24 | 29.9 | 68.4 | 8.39 | **0.43x** | **3.13x** |
| `json_field` | warm | 22.7 | 52.0 | 7.49 | 30.5 | 68.1 | 9.11 | **0.44x** | **3.02x** |
| `json_field_rare` | cold | 2.85 | 136 | 1.12 | 3.05 | 138 | 1.78 | **0.02x** | **2.55x** |
| `json_field_rare` | warm | 2.92 | 136 | 1.18 | 3.15 | 138 | 1.67 | **0.02x** | **2.47x** |
| `metadata_rare` | cold | 2.36 | 79.1 | 1.08 | 2.40 | 81.1 | 1.60 | **0.03x** | **2.18x** |
| `metadata_rare` | warm | 2.42 | 79.1 | 1.17 | 2.58 | 81.6 | 1.56 | **0.03x** | **2.06x** |
| `trace_window` | cold | 2.27 | 31.9 | 1.16 | 2.31 | 33.5 | 1.49 | **0.07x** | **1.96x** |
| `trace_window` | warm | 2.29 | 31.9 | 1.10 | 2.50 | 33.9 | 1.51 | **0.07x** | **2.08x** |
| `rate` | cold | 1.87 | 10.8 | 0.41 | 2.52 | 11.5 | 0.73 | **0.17x** | **4.55x** |
| `rate` | warm | 1.90 | 10.5 | 0.41 | 2.58 | 12.0 | 0.68 | **0.18x** | **4.67x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 45.4 | 176 | 30.8 | **0.26x** | **1.47x** | 537812 | 156516 | 150000 |
| `label_only` | 100 | 10.1 | 8.30 | 14.1 | **1.22x** | **0.72x** | 155625 | 13686 | 2400 |
| `line_filter` | 20000 | 13.8 | 23.7 | 7.35 | **0.58x** | **1.87x** | 537812 | 157304 | 10208 |
| `line_filter` | 100 | 10.8 | 10.7 | 11.7 | **1.01x** | **0.92x** | 288885 | 85550 | 2400 |
| `json_field` | 20000 | 22.7 | 52.7 | 7.24 | **0.43x** | **3.13x** | 537812 | 156988 | 17661 |
| `json_field` | 100 | 13.1 | 14.5 | 9.80 | **0.90x** | **1.34x** | 537812 | 79279 | 2400 |
| `json_field_rare` | 20000 | 2.85 | 136 | 1.12 | **0.02x** | **2.55x** | 344064 | 1582288 | 24 |
| `json_field_rare` | 100 | 2.93 | 135 | 1.23 | **0.02x** | **2.38x** | 344064 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.36 | 79.1 | 1.08 | **0.03x** | **2.18x** | 344064 | 1582288 | 24 |
| `metadata_rare` | 100 | 2.36 | 79.3 | 1.11 | **0.03x** | **2.13x** | 344064 | 1582288 | 24 |
| `trace_window` | 20000 | 2.27 | 31.9 | 1.16 | **0.07x** | **1.96x** | 221184 | 574392 | 24 |
| `trace_window` | 100 | 2.25 | 32.2 | 1.03 | **0.07x** | **2.17x** | 221184 | 574392 | 24 |
| `rate` | 20000 | 1.87 | 10.8 | 0.41 | **0.17x** | **4.55x** | 537812 | 146551 | 112 |
| `rate` | 100 | 1.88 | 10.6 | 0.40 | **0.18x** | **4.67x** | 537812 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 731.1 MiB |
| **anonymous peak during ingest** | 1446.9 MiB | 1139.1 MiB | 420.4 MiB |
| `memory.peak` during queries | 128.1 MiB | 305.9 MiB | 198.6 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442280203 | 442215574 | 442027434 |
| total on disk, settled | 615.0 MiB | 117.7 MiB | 57.8 MiB |
| of which write-ahead log | 541.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 73.0 MiB | 117.7 MiB | 57.8 MiB |
| **total per GB ingested** | 1390 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 165 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 615.0 MiB | 117.8 MiB | 57.8 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568271080,/data/parts:76577347,/data/traces:4096`
* Loki — `/data/chunks:123309085,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95801,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60608357`
...
* against Loki, cold: loggytracy is 33.50x faster (2.4 ms against 79.1 ms)
* against Loki, warm: loggytracy is 32.74x faster (2.4 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 2.18x slower (2.4 ms against 1.1 ms)
* against VictoriaLogs, warm: loggytracy is 2.06x slower (2.4 ms against 1.2 ms)
* ingest: loggytracy achieved 19609 eps against Loki's 19864 and VictoriaLogs' 19929
* disk: loggytracy's settled data is 0.62x Loki's and 1.26x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.32x faster (22.7 ms against 52.7 ms)
against Loki and loggytracy is 3.13x slower (22.7 ms against 7.2 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19609 / 19864 / 19929 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-02 15:30:43.962106745 +0900
+++ /dev/fd/62	2026-08-02 15:30:43.962106745 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-02T06:30:25.779145Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-02T06:30:25.779301Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-02T06:30:25.783066Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-02T06:30:25.783073Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-02T06:30:25.783107Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-02T06:30:25.783112Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
