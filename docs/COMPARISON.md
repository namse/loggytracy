...
**Generated by `compare/run.sh` on 2026-08-06T11:48:24Z, from revision `9edee89` (`master`). Do not edit
...
|---|---|---|---|
| build | `9edee89` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19759 | 19867 | 19932 |
| events accepted | 1200400 | 1200800 | 1200400 |
| elapsed s | 60.8 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12004 | 12008 | 12004 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 7.54 | 1.12 | 0.26 |
| push service p95 ms | 16.4 | 3.42 | 0.48 |
| push service p99 ms | 23.9 | 5.69 | 1.05 |
| push response p50 ms | 8.85 | 1.96 | 1.94 |
| push response p95 ms | 18.5 | 4.50 | 2.41 |
| push response p99 ms | 49.5 | 9.76 | 2.87 |
| latency samples | 10004 | 10008 | 10004 |
| line bytes offered | 393026236 | 393151549 | 393026236 |
| wire bytes (OTLP protobuf) | 512011125 | 512176066 | 512011125 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 49.1 | 176 | 29.1 | 71.0 | 182 | 34.0 | **0.28x** | **1.69x** |
| `label_only` | warm | 41.7 | 175 | 26.1 | 44.3 | 186 | 30.6 | **0.24x** | **1.60x** |
| `line_filter` | cold | 4.68 | 23.8 | 7.86 | 4.86 | 26.2 | 10.5 | **0.20x** | **0.60x** |
| `line_filter` | warm | 4.72 | 23.8 | 7.44 | 5.22 | 26.7 | 10.7 | **0.20x** | **0.63x** |
| `json_field` | cold | 44.2 | 52.1 | 13.8 | 51.7 | 69.3 | 16.2 | **0.85x** | **3.19x** |
| `json_field` | warm | 13.5 | 52.1 | 13.1 | 19.6 | 68.6 | 15.4 | **0.26x** | **1.03x** |
| `json_field_rare` | cold | 1.98 | 136 | 69.5 | 4.70 | 138 | 74.7 | **0.01x** | **0.03x** |
| `json_field_rare` | warm | 1.11 | 136 | 68.7 | 1.77 | 138 | 74.7 | **0.01x** | **0.02x** |
| `metadata_rare` | cold | 1.54 | 78.8 | 1.51 | 2.26 | 82.0 | 1.76 | **0.02x** | **1.02x** |
| `metadata_rare` | warm | 0.81 | 79.0 | 1.43 | 1.14 | 80.9 | 1.89 | **0.01x** | **0.57x** |
| `trace_window` | cold | 1.51 | 31.9 | 1.45 | 2.09 | 33.8 | 1.70 | **0.05x** | **1.05x** |
| `trace_window` | warm | 0.81 | 31.9 | 1.35 | 1.13 | 33.8 | 1.61 | **0.03x** | **0.60x** |
| `rate` | cold | 1.31 | 10.7 | 0.43 | 1.54 | 11.3 | 0.50 | **0.12x** | **3.02x** |
| `rate` | warm | 1.30 | 10.7 | 0.43 | 1.56 | 12.2 | 0.69 | **0.12x** | **3.03x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 49.1 | 176 | 29.1 | **0.28x** | **1.69x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 11.8 | 7.99 | 14.3 | **1.47x** | **0.82x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 4.68 | 23.8 | 7.86 | **0.20x** | **0.60x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 1.86 | 10.5 | 11.9 | **0.18x** | **0.16x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 44.2 | 52.1 | 13.8 | **0.85x** | **3.19x** | 758256 | 156988 | 17661 |
| `json_field` | 100 | 34.7 | 14.7 | 15.5 | **2.36x** | **2.23x** | 758256 | 79279 | 2400 |
| `json_field_rare` | 20000 | 1.98 | 136 | 69.5 | **0.01x** | **0.03x** | 49152 | 1582288 | 24 |
| `json_field_rare` | 100 | 1.82 | 135 | 68.4 | **0.01x** | **0.03x** | 49152 | 1582288 | 24 |
| `metadata_rare` | 20000 | 1.54 | 78.8 | 1.51 | **0.02x** | **1.02x** | 49152 | 1582288 | 24 |
| `metadata_rare` | 100 | 1.53 | 78.8 | 1.44 | **0.02x** | **1.06x** | 49152 | 1582288 | 24 |
| `trace_window` | 20000 | 1.51 | 31.9 | 1.45 | **0.05x** | **1.05x** | 49152 | 574392 | 24 |
| `trace_window` | 100 | 1.53 | 31.7 | 1.37 | **0.05x** | **1.12x** | 49152 | 574392 | 24 |
| `rate` | 20000 | 1.31 | 10.7 | 0.43 | **0.12x** | **3.02x** | 758256 | 146551 | 112 |
| `rate` | 100 | 1.25 | 10.7 | 0.41 | **0.12x** | **3.05x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1237.4 MiB | 2048.1 MiB | 561.7 MiB |
| **anonymous peak during ingest** | 959.9 MiB | 1133.4 MiB | 416.6 MiB |
| `memory.peak` during queries | 232.3 MiB | 347.5 MiB | 274.6 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442056065 | 442181378 | 442056065 |
| total on disk, settled | 78.6 MiB | 117.8 MiB | 55.4 MiB |
| of which write-ahead log | 8.7 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 69.9 MiB | 117.8 MiB | 55.4 MiB |
| **total per GB ingested** | 178 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 158 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 78.6 MiB | 117.8 MiB | 55.4 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9099818,/data/parts:73287351,/data/traces:4096`
* Loki — `/data/chunks:123329516,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107317,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:58044692`
...
* against Loki, cold: loggytracy is 51.04x faster (1.5 ms against 78.8 ms)
* against Loki, warm: loggytracy is 97.13x faster (0.8 ms against 79.0 ms)
* against VictoriaLogs, cold: within 10% (1.5 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 1.76x faster (0.8 ms against 1.4 ms)
* ingest: loggytracy achieved 19759 eps against Loki's 19867 and VictoriaLogs' 19932
* disk: loggytracy's settled data is 0.59x Loki's and 1.26x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 1.18x faster (44.2 ms against 52.1 ms)
against Loki and loggytracy is 3.19x slower (44.2 ms against 13.8 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19759 / 19867 / 19932 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 20:38:20.409350881 +0900
+++ /dev/fd/62	2026-08-06 20:38:20.413350891 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T11:38:02.208951Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T11:38:02.209014Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T11:38:02.209176Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T11:38:02.226178Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T11:38:02.226186Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T11:38:02.226222Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T11:38:02.226232Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
