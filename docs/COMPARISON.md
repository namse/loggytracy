...
**Generated by `compare/run.sh` on 2026-07-31T07:28:32Z, from revision `1b5c4f1` (`master`). Do not edit
...
|---|---|---|---|
| build | `1b5c4f1` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 18543 | 19860 | 19942 |
| events accepted | 1200900 | 1200400 | 1200700 |
| elapsed s | 64.8 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12009 | 12004 | 12007 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.11 | 1.05 | 0.34 |
| push service p95 ms | 2.52 | 3.30 | 0.58 |
| push service p99 ms | 7.99 | 5.19 | 1.06 |
| push response p50 ms | 3.61 | 2.55 | 1.71 |
| push response p95 ms | 4.26 | 4.97 | 2.18 |
| push response p99 ms | 9.61 | 8.74 | 2.61 |
| latency samples | 10009 | 10004 | 10007 |
| line bytes offered | 393185745 | 393026236 | 393119777 |
| wire bytes (snappy) | 189351577 | 189260340 | 189320162 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 52.0 | 177 | 29.8 | 67.0 | 183 | 35.6 | **0.29x** | **1.74x** |
| `label_only` | warm | 50.6 | 176 | 27.4 | 53.9 | 187 | 32.6 | **0.29x** | **1.85x** |
| `line_filter` | cold | 14.6 | 23.6 | 7.11 | 17.8 | 25.7 | 8.53 | **0.62x** | **2.06x** |
| `line_filter` | warm | 14.6 | 23.6 | 6.78 | 17.7 | 26.1 | 8.92 | **0.62x** | **2.15x** |
| `json_field` | cold | 21.1 | 53.4 | 6.62 | 26.2 | 67.5 | 8.28 | **0.40x** | **3.19x** |
| `json_field` | warm | 21.1 | 51.8 | 6.62 | 26.2 | 67.8 | 8.79 | **0.41x** | **3.18x** |
| `json_field_rare` | cold | 4.52 | 136 | 1.36 | 4.84 | 138 | 2.35 | **0.03x** | **3.32x** |
| `json_field_rare` | warm | 4.55 | 136 | 1.35 | 4.94 | 138 | 2.23 | **0.03x** | **3.38x** |
| `metadata_rare` | cold | 4.00 | 79.2 | 1.30 | 4.04 | 80.2 | 1.72 | **0.05x** | **3.09x** |
| `metadata_rare` | warm | 3.99 | 79.1 | 1.29 | 4.29 | 81.6 | 2.41 | **0.05x** | **3.10x** |
| `rate` | cold | 9.60 | 10.6 | 0.40 | 10.7 | 11.5 | 0.66 | **0.90x** | **23.75x** |
| `rate` | warm | 9.58 | 10.9 | 0.42 | 10.7 | 12.0 | 0.68 | **0.88x** | **22.57x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 52.0 | 177 | 29.8 | **0.29x** | **1.74x** | 619488 | 156516 | 150000 |
| `label_only` | 100 | 10.3 | 7.96 | 12.4 | **1.30x** | **0.83x** | 242050 | 13686 | 2400 |
| `line_filter` | 20000 | 14.6 | 23.6 | 7.11 | **0.62x** | **2.06x** | 619488 | 157304 | 10208 |
| `line_filter` | 100 | 11.2 | 10.5 | 10.2 | **1.07x** | **1.11x** | 363070 | 85550 | 2400 |
| `json_field` | 20000 | 21.1 | 53.4 | 6.62 | **0.40x** | **3.19x** | 619488 | 156988 | 17661 |
| `json_field` | 100 | 11.3 | 14.5 | 8.31 | **0.78x** | **1.36x** | 619488 | 79279 | 2400 |
| `json_field_rare` | 20000 | 4.52 | 136 | 1.36 | **0.03x** | **3.32x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 4.53 | 136 | 1.30 | **0.03x** | **3.49x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 4.00 | 79.2 | 1.30 | **0.05x** | **3.09x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 4.01 | 79.0 | 1.30 | **0.05x** | **3.09x** | 589824 | 1582288 | 24 |
| `rate` | 20000 | 9.60 | 10.6 | 0.40 | **0.90x** | **23.75x** | 619488 | 146551 | 112 |
| `rate` | 100 | 9.59 | 10.6 | 0.41 | **0.91x** | **23.32x** | 619488 | 146551 | 112 |
...
| `memory.peak` during ingest | 1847.7 MiB | 2048.0 MiB | 657.0 MiB |
| **anonymous peak during ingest** | 1207.7 MiB | 1107.7 MiB | 427.6 MiB |
| `memory.peak` during queries | 107.5 MiB | 265.7 MiB | 207.2 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442215574 | 442056065 | 442149606 |
| total on disk, settled | 617.2 MiB | 117.7 MiB | 57.0 MiB |
| of which write-ahead log | 541.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 75.3 MiB | 117.7 MiB | 57.0 MiB |
| **total per GB ingested** | 1396 MiB / GB | 266 MiB / GB | 129 MiB / GB |
| **settled data per GB ingested** | 170 MiB / GB | 266 MiB / GB | 129 MiB / GB |
| total after the query phase | 617.2 MiB | 117.8 MiB | 57.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568188804,/data/parts:78998232,/data/traces:4096`
* Loki — `/data/chunks:123274907,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95801,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:59798858`
...
* against Loki, cold: loggytracy is 19.80x faster (4.0 ms against 79.2 ms)
* against Loki, warm: loggytracy is 19.84x faster (4.0 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 3.09x slower (4.0 ms against 1.3 ms)
* against VictoriaLogs, warm: loggytracy is 3.10x slower (4.0 ms against 1.3 ms)
* ingest: loggytracy achieved 18543 eps against Loki's 19860 and VictoriaLogs' 19942
* disk: loggytracy's settled data is 0.64x Loki's and 1.32x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.53x faster (21.1 ms against 53.4 ms)
against Loki and loggytracy is 3.19x slower (21.1 ms against 6.6 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (18543 / 19860 / 19942 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 16:18:38.038163221 +0900
+++ /dev/fd/62	2026-07-31 16:18:38.038163221 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T07:18:19.849595Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T07:18:19.849772Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T07:18:19.853921Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T07:18:19.853927Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T07:18:19.853954Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T07:18:19.853957Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
