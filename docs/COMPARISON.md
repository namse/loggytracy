...
**Generated by `compare/run.sh` on 2026-08-01T11:44:13Z, from revision `c798e5b` (`master`). Do not edit
...
|---|---|---|---|
| build | `c798e5b` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 18877 | 19863 | 19937 |
| events accepted | 1201000 | 1200700 | 1200800 |
| elapsed s | 63.6 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12010 | 12007 | 12008 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 7.61 | 1.06 | 0.34 |
| push service p95 ms | 14.9 | 3.32 | 0.61 |
| push service p99 ms | 29.1 | 5.30 | 1.08 |
| push response p50 ms | 8.88 | 2.65 | 1.93 |
| push response p95 ms | 18.2 | 5.10 | 2.41 |
| push response p99 ms | 91.6 | 9.68 | 2.89 |
| latency samples | 10010 | 10007 | 10008 |
| line bytes offered | 393217932 | 393119777 | 393151549 |
| wire bytes (snappy) | 189374943 | 189319323 | 189340612 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 44.6 | 177 | 30.8 | 57.0 | 180 | 34.8 | **0.25x** | **1.45x** |
| `label_only` | warm | 44.0 | 176 | 27.2 | 46.7 | 187 | 32.2 | **0.25x** | **1.62x** |
| `line_filter` | cold | 14.0 | 23.2 | 7.78 | 15.9 | 25.8 | 9.07 | **0.60x** | **1.80x** |
| `line_filter` | warm | 13.9 | 23.7 | 7.12 | 16.0 | 26.1 | 9.65 | **0.59x** | **1.96x** |
| `json_field` | cold | 25.7 | 52.4 | 7.48 | 32.0 | 67.8 | 8.88 | **0.49x** | **3.43x** |
| `json_field` | warm | 25.8 | 52.0 | 7.01 | 32.2 | 68.4 | 9.80 | **0.50x** | **3.69x** |
| `json_field_rare` | cold | 3.77 | 136 | 1.53 | 3.95 | 138 | 1.71 | **0.03x** | **2.47x** |
| `json_field_rare` | warm | 3.78 | 135 | 1.44 | 4.03 | 138 | 2.06 | **0.03x** | **2.64x** |
| `metadata_rare` | cold | 2.57 | 79.1 | 1.49 | 2.65 | 80.9 | 1.97 | **0.03x** | **1.72x** |
| `metadata_rare` | warm | 2.57 | 79.1 | 1.47 | 2.72 | 81.3 | 1.95 | **0.03x** | **1.75x** |
| `trace_window` | cold | 2.41 | 32.0 | 1.36 | 2.55 | 34.0 | 2.19 | **0.08x** | **1.76x** |
| `trace_window` | warm | 2.42 | 31.9 | 1.34 | 2.57 | 34.3 | 1.73 | **0.08x** | **1.81x** |
| `rate` | cold | 2.04 | 10.6 | 0.41 | 2.62 | 11.6 | 0.57 | **0.19x** | **4.99x** |
| `rate` | warm | 2.06 | 10.8 | 0.41 | 2.64 | 12.3 | 0.50 | **0.19x** | **5.05x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 44.6 | 177 | 30.8 | **0.25x** | **1.45x** | 523760 | 156516 | 150000 |
| `label_only` | 100 | 10.7 | 8.10 | 13.5 | **1.32x** | **0.79x** | 168036 | 13686 | 2400 |
| `line_filter` | 20000 | 14.0 | 23.2 | 7.78 | **0.60x** | **1.80x** | 523760 | 157304 | 10208 |
| `line_filter` | 100 | 11.1 | 10.5 | 11.3 | **1.06x** | **0.99x** | 293824 | 85550 | 2400 |
| `json_field` | 20000 | 25.7 | 52.4 | 7.48 | **0.49x** | **3.43x** | 523760 | 156988 | 17661 |
| `json_field` | 100 | 19.3 | 14.8 | 9.93 | **1.30x** | **1.95x** | 523760 | 79279 | 2400 |
| `json_field_rare` | 20000 | 3.77 | 136 | 1.53 | **0.03x** | **2.47x** | 360448 | 1582288 | 24 |
| `json_field_rare` | 100 | 3.89 | 136 | 1.44 | **0.03x** | **2.69x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.57 | 79.1 | 1.49 | **0.03x** | **1.72x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 100 | 2.77 | 79.2 | 1.35 | **0.04x** | **2.05x** | 360448 | 1582288 | 24 |
| `trace_window` | 20000 | 2.41 | 32.0 | 1.36 | **0.08x** | **1.76x** | 188416 | 574392 | 24 |
| `trace_window` | 100 | 2.59 | 32.1 | 1.33 | **0.08x** | **1.95x** | 188416 | 574392 | 24 |
| `rate` | 20000 | 2.04 | 10.6 | 0.41 | **0.19x** | **4.99x** | 523760 | 146551 | 112 |
| `rate` | 100 | 2.10 | 10.8 | 0.40 | **0.19x** | **5.28x** | 523760 | 146551 | 112 |
...
| **anonymous peak during ingest** | 1343.3 MiB | 1119.8 MiB | 412.7 MiB |
| `memory.peak` during queries | 135.3 MiB | 353.1 MiB | 219.1 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442247761 | 442149606 | 442181378 |
| total on disk, settled | 611.9 MiB | 117.7 MiB | 57.8 MiB |
| of which write-ahead log | 541.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 70.0 MiB | 117.7 MiB | 57.8 MiB |
| **total per GB ingested** | 1384 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 158 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 611.9 MiB | 117.8 MiB | 57.8 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568230639,/data/parts:73417012,/data/traces:4096`
* Loki — `/data/chunks:123303432,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95923,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60628727`
...
* against Loki, cold: loggytracy is 30.80x faster (2.6 ms against 79.1 ms)
* against Loki, warm: loggytracy is 30.73x faster (2.6 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 1.72x slower (2.6 ms against 1.5 ms)
* against VictoriaLogs, warm: loggytracy is 1.75x slower (2.6 ms against 1.5 ms)
* ingest: loggytracy achieved 18877 eps against Loki's 19863 and VictoriaLogs' 19937
* disk: loggytracy's settled data is 0.59x Loki's and 1.21x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.04x faster (25.7 ms against 52.4 ms)
against Loki and loggytracy is 3.43x slower (25.7 ms against 7.5 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (18877 / 19863 / 19937 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-01 20:34:16.778861051 +0900
+++ /dev/fd/62	2026-08-01 20:34:16.778861051 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-01T11:33:58.589523Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-01T11:33:58.589709Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-01T11:33:58.595062Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-01T11:33:58.595069Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-01T11:33:58.595100Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-01T11:33:58.595104Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
