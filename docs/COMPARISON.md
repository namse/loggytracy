...
**Generated by `compare/run.sh` on 2026-08-02T06:22:56Z, from revision `68f3b98` (`master`). Do not edit
...
|---|---|---|---|
| build | `68f3b98` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 18990 | 19858 | 19929 |
| events accepted | 1201200 | 1200300 | 1200300 |
| elapsed s | 63.3 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12012 | 12003 | 12003 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.25 | 1.08 | 0.34 |
| push service p95 ms | 12.4 | 3.36 | 0.60 |
| push service p99 ms | 15.2 | 5.25 | 1.10 |
| push response p50 ms | 3.81 | 2.30 | 1.69 |
| push response p95 ms | 13.6 | 4.77 | 2.16 |
| push response p99 ms | 20.7 | 9.11 | 2.66 |
| latency samples | 10012 | 10003 | 10003 |
| line bytes offered | 393285324 | 392997605 | 392997605 |
| wire bytes (snappy) | 189404330 | 189249138 | 189246466 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 43.3 | 178 | 31.4 | 60.0 | 181 | 35.7 | **0.24x** | **1.38x** |
| `label_only` | warm | 42.8 | 176 | 28.0 | 46.0 | 184 | 33.1 | **0.24x** | **1.53x** |
| `line_filter` | cold | 12.5 | 23.4 | 8.00 | 14.2 | 25.8 | 10.0 | **0.53x** | **1.56x** |
| `line_filter` | warm | 12.6 | 23.6 | 7.07 | 14.5 | 26.5 | 9.48 | **0.53x** | **1.78x** |
| `json_field` | cold | 22.7 | 52.4 | 7.70 | 27.0 | 67.9 | 8.86 | **0.43x** | **2.95x** |
| `json_field` | warm | 22.8 | 52.1 | 7.20 | 27.2 | 69.9 | 9.00 | **0.44x** | **3.17x** |
| `json_field_rare` | cold | 3.19 | 136 | 1.26 | 3.30 | 138 | 1.74 | **0.02x** | **2.53x** |
| `json_field_rare` | warm | 3.09 | 136 | 1.17 | 3.29 | 139 | 1.86 | **0.02x** | **2.64x** |
| `metadata_rare` | cold | 2.55 | 79.0 | 1.18 | 2.77 | 81.7 | 1.52 | **0.03x** | **2.16x** |
| `metadata_rare` | warm | 2.53 | 79.2 | 1.16 | 2.78 | 81.7 | 1.73 | **0.03x** | **2.19x** |
| `trace_window` | cold | 2.38 | 32.1 | 1.11 | 2.49 | 34.1 | 1.51 | **0.07x** | **2.14x** |
| `trace_window` | warm | 2.41 | 32.0 | 1.10 | 2.66 | 34.2 | 1.92 | **0.08x** | **2.18x** |
| `rate` | cold | 1.54 | 10.7 | 0.42 | 2.08 | 12.4 | 0.76 | **0.14x** | **3.65x** |
| `rate` | warm | 1.55 | 10.6 | 0.40 | 2.11 | 12.0 | 0.69 | **0.15x** | **3.84x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 43.3 | 178 | 31.4 | **0.24x** | **1.38x** | 492016 | 156516 | 150000 |
| `label_only` | 100 | 9.20 | 8.24 | 14.1 | **1.12x** | **0.66x** | 156850 | 13686 | 2400 |
| `line_filter` | 20000 | 12.5 | 23.4 | 8.00 | **0.53x** | **1.56x** | 492016 | 157304 | 10208 |
| `line_filter` | 100 | 9.74 | 10.4 | 11.8 | **0.94x** | **0.83x** | 275539 | 85550 | 2400 |
| `json_field` | 20000 | 22.7 | 52.4 | 7.70 | **0.43x** | **2.95x** | 492016 | 156988 | 17661 |
| `json_field` | 100 | 12.8 | 14.7 | 10.2 | **0.87x** | **1.25x** | 492016 | 79279 | 2400 |
| `json_field_rare` | 20000 | 3.19 | 136 | 1.26 | **0.02x** | **2.53x** | 360448 | 1582288 | 24 |
| `json_field_rare` | 100 | 3.16 | 136 | 1.20 | **0.02x** | **2.64x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 20000 | 2.55 | 79.0 | 1.18 | **0.03x** | **2.16x** | 360448 | 1582288 | 24 |
| `metadata_rare` | 100 | 2.62 | 79.2 | 1.12 | **0.03x** | **2.35x** | 360448 | 1582288 | 24 |
| `trace_window` | 20000 | 2.38 | 32.1 | 1.11 | **0.07x** | **2.14x** | 229376 | 574392 | 24 |
| `trace_window` | 100 | 2.56 | 32.0 | 1.09 | **0.08x** | **2.36x** | 229376 | 574392 | 24 |
| `rate` | 20000 | 1.54 | 10.7 | 0.42 | **0.14x** | **3.65x** | 492016 | 146551 | 112 |
| `rate` | 100 | 1.58 | 10.9 | 0.41 | **0.15x** | **3.87x** | 492016 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 652.3 MiB |
| **anonymous peak during ingest** | 1284.4 MiB | 1128.8 MiB | 430.2 MiB |
| `memory.peak` during queries | 135.2 MiB | 302.0 MiB | 205.9 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442315153 | 442027434 | 442027434 |
| total on disk, settled | 611.7 MiB | 117.7 MiB | 57.8 MiB |
| of which write-ahead log | 542.0 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 69.7 MiB | 117.7 MiB | 57.8 MiB |
| **total per GB ingested** | 1383 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 158 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 611.7 MiB | 117.8 MiB | 57.8 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568316115,/data/parts:73041937,/data/traces:4096`
* Loki — `/data/chunks:123279963,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95984,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60597506`
...
* against Loki, cold: loggytracy is 30.95x faster (2.6 ms against 79.0 ms)
* against Loki, warm: loggytracy is 31.27x faster (2.5 ms against 79.2 ms)
* against VictoriaLogs, cold: loggytracy is 2.16x slower (2.6 ms against 1.2 ms)
* against VictoriaLogs, warm: loggytracy is 2.19x slower (2.5 ms against 1.2 ms)
* ingest: loggytracy achieved 18990 eps against Loki's 19858 and VictoriaLogs' 19929
* disk: loggytracy's settled data is 0.59x Loki's and 1.21x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.30x faster (22.7 ms against 52.4 ms)
against Loki and loggytracy is 2.95x slower (22.7 ms against 7.7 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (18990 / 19858 / 19929 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-02 15:13:02.831513155 +0900
+++ /dev/fd/62	2026-08-02 15:13:02.831513155 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-02T06:12:44.655985Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-02T06:12:44.656129Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-02T06:12:44.662452Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-02T06:12:44.662457Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-02T06:12:44.662479Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-02T06:12:44.662482Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
