...
**Generated by `compare/run.sh` on 2026-07-31T08:23:24Z, from revision `640a996` (`master`). Do not edit
...
|---|---|---|---|
| build | `640a996` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 18929 | 19868 | 19938 |
| events accepted | 1200900 | 1201000 | 1200700 |
| elapsed s | 63.4 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12009 | 12010 | 12007 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 6.10 | 1.08 | 0.34 |
| push service p95 ms | 13.7 | 3.35 | 0.59 |
| push service p99 ms | 20.3 | 5.27 | 1.08 |
| push response p50 ms | 7.00 | 2.36 | 1.69 |
| push response p95 ms | 14.9 | 4.86 | 2.16 |
| push response p99 ms | 90.1 | 10.6 | 2.59 |
| latency samples | 10009 | 10010 | 10007 |
| line bytes offered | 393185745 | 393217932 | 393119777 |
| wire bytes (snappy) | 189349144 | 189367664 | 189320741 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 51.7 | 176 | 31.6 | 61.0 | 182 | 34.8 | **0.29x** | **1.63x** |
| `label_only` | warm | 51.2 | 177 | 27.7 | 55.2 | 184 | 32.8 | **0.29x** | **1.85x** |
| `line_filter` | cold | 21.2 | 23.5 | 7.82 | 25.4 | 24.6 | 9.43 | **0.90x** | **2.71x** |
| `line_filter` | warm | 21.2 | 23.6 | 7.26 | 25.2 | 26.4 | 9.64 | **0.90x** | **2.93x** |
| `json_field` | cold | 25.4 | 52.7 | 7.17 | 31.9 | 69.0 | 8.93 | **0.48x** | **3.55x** |
| `json_field` | warm | 25.4 | 52.2 | 6.99 | 32.1 | 69.2 | 9.40 | **0.49x** | **3.63x** |
| `json_field_rare` | cold | 5.90 | 136 | 1.76 | 6.11 | 138 | 2.28 | **0.04x** | **3.35x** |
| `json_field_rare` | warm | 5.94 | 135 | 1.69 | 6.36 | 138 | 2.41 | **0.04x** | **3.52x** |
| `metadata_rare` | cold | 5.37 | 79.3 | 1.69 | 5.55 | 81.4 | 2.02 | **0.07x** | **3.19x** |
| `metadata_rare` | warm | 5.39 | 79.1 | 1.66 | 5.66 | 82.0 | 2.56 | **0.07x** | **3.23x** |
| `rate` | cold | 6.56 | 10.7 | 0.45 | 8.21 | 12.2 | 0.72 | **0.61x** | **14.54x** |
| `rate` | warm | 6.52 | 10.6 | 0.41 | 8.29 | 12.1 | 0.69 | **0.62x** | **15.80x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 51.7 | 176 | 31.6 | **0.29x** | **1.63x** | 840672 | 156516 | 150000 |
| `label_only` | 100 | 15.8 | 8.03 | 15.6 | **1.97x** | **1.01x** | 335345 | 13686 | 2400 |
| `line_filter` | 20000 | 21.2 | 23.5 | 7.82 | **0.90x** | **2.71x** | 840672 | 157304 | 10208 |
| `line_filter` | 100 | 17.5 | 10.5 | 11.8 | **1.68x** | **1.48x** | 476605 | 85550 | 2400 |
| `json_field` | 20000 | 25.4 | 52.7 | 7.17 | **0.48x** | **3.55x** | 840672 | 156988 | 17661 |
| `json_field` | 100 | 16.1 | 15.0 | 9.92 | **1.08x** | **1.63x** | 840672 | 79279 | 2400 |
| `json_field_rare` | 20000 | 5.90 | 136 | 1.76 | **0.04x** | **3.35x** | 589824 | 1582288 | 24 |
| `json_field_rare` | 100 | 5.81 | 135 | 1.58 | **0.04x** | **3.68x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 20000 | 5.37 | 79.3 | 1.69 | **0.07x** | **3.19x** | 589824 | 1582288 | 24 |
| `metadata_rare` | 100 | 5.29 | 79.0 | 1.59 | **0.07x** | **3.32x** | 589824 | 1582288 | 24 |
| `rate` | 20000 | 6.56 | 10.7 | 0.45 | **0.61x** | **14.54x** | 840672 | 146551 | 112 |
| `rate` | 100 | 6.51 | 10.7 | 0.41 | **0.61x** | **15.91x** | 840672 | 146551 | 112 |
...
| `memory.peak` during ingest | 2048.0 MiB | 2048.1 MiB | 660.7 MiB |
| **anonymous peak during ingest** | 1218.0 MiB | 1145.9 MiB | 393.9 MiB |
| `memory.peak` during queries | 134.8 MiB | 276.1 MiB | 227.7 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442215574 | 442247761 | 442149606 |
| total on disk, settled | 611.3 MiB | 117.7 MiB | 58.0 MiB |
| of which write-ahead log | 541.9 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 69.5 MiB | 117.7 MiB | 58.0 MiB |
| **total per GB ingested** | 1382 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| **settled data per GB ingested** | 157 MiB / GB | 266 MiB / GB | 131 MiB / GB |
| total after the query phase | 611.3 MiB | 117.8 MiB | 58.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:568189189,/data/parts:72825693,/data/traces:4096`
* Loki — `/data/chunks:123308721,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:95801,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:60793032`
...
* against Loki, cold: loggytracy is 14.76x faster (5.4 ms against 79.3 ms)
* against Loki, warm: loggytracy is 14.69x faster (5.4 ms against 79.1 ms)
* against VictoriaLogs, cold: loggytracy is 3.19x slower (5.4 ms against 1.7 ms)
* against VictoriaLogs, warm: loggytracy is 3.23x slower (5.4 ms against 1.7 ms)
* ingest: loggytracy achieved 18929 eps against Loki's 19868 and VictoriaLogs' 19938
* disk: loggytracy's settled data is 0.59x Loki's and 1.20x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 2.07x faster (25.4 ms against 52.7 ms)
against Loki and loggytracy is 3.55x slower (25.4 ms against 7.2 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (18929 / 19868 / 19938 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-07-31 17:13:33.454302326 +0900
+++ /dev/fd/62	2026-07-31 17:13:33.454302326 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-07-31T08:13:15.271965Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m5368709120 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-07-31T08:13:15.272113Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-07-31T08:13:15.277656Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-07-31T08:13:15.277662Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-07-31T08:13:15.277698Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-07-31T08:13:15.277703Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
