...
**Generated by `compare/run.sh` on 2026-08-06T14:31:32Z, from revision `ed6d807` (`master`). Do not edit
...
|---|---|---|---|
| build | `ed6d807` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19757 | 19862 | 19937 |
| events accepted | 1200200 | 1200600 | 1200700 |
| elapsed s | 60.7 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12002 | 12006 | 12007 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.21 | 1.12 | 0.26 |
| push service p95 ms | 3.48 | 3.46 | 0.47 |
| push service p99 ms | 9.24 | 5.65 | 1.05 |
| push response p50 ms | 3.56 | 1.95 | 1.09 |
| push response p95 ms | 4.78 | 4.49 | 1.56 |
| push response p99 ms | 10.5 | 9.65 | 2.09 |
| latency samples | 10002 | 10006 | 10007 |
| line bytes offered | 392963749 | 393087620 | 393119777 |
| wire bytes (OTLP protobuf) | 511928817 | 512092310 | 512134376 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 40.5 | 176 | 28.9 | 61.3 | 181 | 33.2 | **0.23x** | **1.40x** |
| `label_only` | warm | 29.7 | 177 | 25.0 | 30.5 | 187 | 29.3 | **0.17x** | **1.19x** |
| `line_filter` | cold | 4.13 | 23.8 | 7.94 | 4.52 | 25.4 | 9.98 | **0.17x** | **0.52x** |
| `line_filter` | warm | 4.13 | 23.7 | 7.08 | 4.58 | 26.6 | 9.67 | **0.17x** | **0.58x** |
| `json_field` | cold | 13.3 | 52.7 | 13.5 | 16.4 | 66.7 | 15.3 | **0.25x** | **0.98x** |
| `json_field` | warm | 11.8 | 52.5 | 12.9 | 15.7 | 68.4 | 15.3 | **0.22x** | **0.91x** |
| `json_field_rare` | cold | 0.24 | 136 | 70.5 | 4.86 | 138 | 72.0 | **0.00x** | **0.00x** |
| `json_field_rare` | warm | 0.24 | 135 | 68.2 | 0.68 | 138 | 73.7 | **0.00x** | **0.00x** |
| `metadata_rare` | cold | 0.22 | 78.8 | 1.81 | 1.19 | 80.8 | 2.76 | **0.00x** | **0.12x** |
| `metadata_rare` | warm | 0.23 | 78.9 | 1.76 | 0.24 | 81.6 | 2.27 | **0.00x** | **0.13x** |
| `trace_window` | cold | 0.22 | 32.0 | 1.71 | 1.18 | 33.6 | 2.53 | **0.01x** | **0.13x** |
| `trace_window` | warm | 0.23 | 31.9 | 1.64 | 0.26 | 33.9 | 2.08 | **0.01x** | **0.14x** |
| `rate` | cold | 0.44 | 11.0 | 0.41 | 0.52 | 11.9 | 0.56 | **0.04x** | **1.06x** |
| `rate` | warm | 0.44 | 10.7 | 0.42 | 0.54 | 11.9 | 0.57 | **0.04x** | **1.04x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 40.5 | 176 | 28.9 | **0.23x** | **1.40x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 11.7 | 7.95 | 13.7 | **1.47x** | **0.86x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 4.13 | 23.8 | 7.94 | **0.17x** | **0.52x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 1.88 | 10.5 | 12.3 | **0.18x** | **0.15x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 13.3 | 52.7 | 13.5 | **0.25x** | **0.98x** | 657904 | 156988 | 17661 |
| `json_field` | 100 | 4.98 | 14.8 | 14.4 | **0.34x** | **0.35x** | 657904 | 79279 | 2400 |
| `json_field_rare` | 20000 | 0.24 | 136 | 70.5 | **0.00x** | **0.00x** | 6144 | 1582288 | 24 |
| `json_field_rare` | 100 | 0.36 | 135 | 67.8 | **0.00x** | **0.01x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 20000 | 0.22 | 78.8 | 1.81 | **0.00x** | **0.12x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 100 | 0.35 | 78.7 | 1.76 | **0.00x** | **0.20x** | 6144 | 1582288 | 24 |
| `trace_window` | 20000 | 0.22 | 32.0 | 1.71 | **0.01x** | **0.13x** | 6144 | 574392 | 24 |
| `trace_window` | 100 | 0.34 | 31.9 | 1.66 | **0.01x** | **0.20x** | 6144 | 574392 | 24 |
| `rate` | 20000 | 0.44 | 11.0 | 0.41 | **0.04x** | **1.06x** | 758256 | 146551 | 112 |
| `rate` | 100 | 0.44 | 10.7 | 0.41 | **0.04x** | **1.08x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1163.9 MiB | 2048.1 MiB | 657.6 MiB |
| **anonymous peak during ingest** | 881.0 MiB | 1096.2 MiB | 440.6 MiB |
| `memory.peak` during queries | 174.9 MiB | 295.2 MiB | 287.2 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 441993578 | 442117449 | 442149606 |
| total on disk, settled | 86.9 MiB | 117.7 MiB | 55.0 MiB |
| of which write-ahead log | 8.7 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 78.2 MiB | 117.7 MiB | 55.0 MiB |
| **total per GB ingested** | 197 MiB / GB | 266 MiB / GB | 124 MiB / GB |
| **settled data per GB ingested** | 177 MiB / GB | 266 MiB / GB | 124 MiB / GB |
| total after the query phase | 86.9 MiB | 117.8 MiB | 55.0 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:9083401,/data/parts:82005802,/data/traces:4096`
* Loki — `/data/chunks:123309043,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107378,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:57677996`
...
* against Loki, cold: loggytracy is 356.51x faster (0.2 ms against 78.8 ms)
* against Loki, warm: loggytracy is 343.60x faster (0.2 ms against 78.9 ms)
* against VictoriaLogs, cold: loggytracy is 8.21x faster (0.2 ms against 1.8 ms)
* against VictoriaLogs, warm: loggytracy is 7.68x faster (0.2 ms against 1.8 ms)
* ingest: loggytracy achieved 19757 eps against Loki's 19862 and VictoriaLogs' 19937
* disk: loggytracy's settled data is 0.66x Loki's and 1.42x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 3.97x faster (13.3 ms against 52.7 ms)
against Loki and within 10% (13.3 ms against 13.5 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19757 / 19862 / 19937 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-06 23:21:33.385499105 +0900
+++ /dev/fd/62	2026-08-06 23:21:33.385499105 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T14:21:15.201015Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T14:21:15.201076Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T14:21:15.201227Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T14:21:15.206870Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T14:21:15.206877Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T14:21:15.206909Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T14:21:15.206913Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
