...
**Generated by `compare/run.sh` on 2026-08-06T15:16:22Z, from revision `9a5ad8e` (`master`). Do not edit
...
|---|---|---|---|
| build | `9a5ad8e` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19767 | 19869 | 19930 |
| events accepted | 1201100 | 1201000 | 1200200 |
| elapsed s | 60.8 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12011 | 12010 | 12002 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.22 | 1.12 | 0.26 |
| push service p95 ms | 4.04 | 3.43 | 0.46 |
| push service p99 ms | 9.69 | 5.26 | 1.02 |
| push response p50 ms | 3.83 | 2.64 | 1.67 |
| push response p95 ms | 5.63 | 5.16 | 2.13 |
| push response p99 ms | 11.4 | 9.07 | 2.61 |
| latency samples | 10011 | 10010 | 10002 |
| line bytes offered | 393250374 | 393217932 | 392963749 |
| wire bytes (OTLP protobuf) | 512304607 | 512262270 | 511928817 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 26.3 | 178 | 29.8 | 48.7 | 193 | 33.8 | **0.15x** | **0.88x** |
| `label_only` | warm | 15.9 | 179 | 25.1 | 16.8 | 193 | 30.1 | **0.09x** | **0.63x** |
| `line_filter` | cold | 3.52 | 23.6 | 7.52 | 3.83 | 26.3 | 9.65 | **0.15x** | **0.47x** |
| `line_filter` | warm | 3.71 | 23.5 | 7.14 | 4.12 | 26.0 | 9.23 | **0.16x** | **0.52x** |
| `json_field` | cold | 11.5 | 50.2 | 12.6 | 14.5 | 68.1 | 14.5 | **0.23x** | **0.91x** |
| `json_field` | warm | 10.5 | 50.9 | 12.6 | 14.1 | 68.5 | 14.6 | **0.21x** | **0.83x** |
| `json_field_rare` | cold | 0.25 | 136 | 66.5 | 5.32 | 138 | 68.0 | **0.00x** | **0.00x** |
| `json_field_rare` | warm | 0.24 | 135 | 66.4 | 0.40 | 139 | 69.4 | **0.00x** | **0.00x** |
| `metadata_rare` | cold | 0.23 | 78.7 | 1.26 | 1.23 | 82.0 | 1.41 | **0.00x** | **0.19x** |
| `metadata_rare` | warm | 0.22 | 78.8 | 1.15 | 0.24 | 81.5 | 1.63 | **0.00x** | **0.19x** |
| `trace_window` | cold | 0.24 | 32.0 | 1.06 | 1.22 | 33.9 | 1.21 | **0.01x** | **0.22x** |
| `trace_window` | warm | 0.22 | 31.9 | 1.09 | 0.23 | 33.9 | 1.28 | **0.01x** | **0.20x** |
| `rate` | cold | 0.46 | 11.0 | 0.42 | 0.57 | 12.1 | 0.48 | **0.04x** | **1.09x** |
| `rate` | warm | 0.45 | 10.6 | 0.42 | 0.56 | 12.5 | 0.65 | **0.04x** | **1.07x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 26.3 | 178 | 29.8 | **0.15x** | **0.88x** | 758256 | 170816 | 150000 |
| `label_only` | 100 | 11.5 | 8.39 | 14.6 | **1.37x** | **0.79x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 3.52 | 23.6 | 7.52 | **0.15x** | **0.47x** | 758256 | 172097 | 10208 |
| `line_filter` | 100 | 1.55 | 11.1 | 12.1 | **0.14x** | **0.13x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 11.5 | 50.2 | 12.6 | **0.23x** | **0.91x** | 657904 | 171501 | 17661 |
| `json_field` | 100 | 4.72 | 14.7 | 13.9 | **0.32x** | **0.34x** | 657904 | 79279 | 2400 |
| `json_field_rare` | 20000 | 0.25 | 136 | 66.5 | **0.00x** | **0.00x** | 6144 | 1774080 | 24 |
| `json_field_rare` | 100 | 0.36 | 136 | 66.0 | **0.00x** | **0.01x** | 6144 | 1774080 | 24 |
| `metadata_rare` | 20000 | 0.23 | 78.7 | 1.26 | **0.00x** | **0.19x** | 6144 | 1774080 | 24 |
| `metadata_rare` | 100 | 0.35 | 78.9 | 1.13 | **0.00x** | **0.31x** | 6144 | 1774080 | 24 |
| `trace_window` | 20000 | 0.24 | 32.0 | 1.06 | **0.01x** | **0.22x** | 6144 | 574392 | 24 |
| `trace_window` | 100 | 0.35 | 31.9 | 1.11 | **0.01x** | **0.32x** | 6144 | 574392 | 24 |
| `rate` | 20000 | 0.46 | 11.0 | 0.42 | **0.04x** | **1.09x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1164.1 MiB | 2048.1 MiB | 709.6 MiB |
| **anonymous peak during ingest** | 862.8 MiB | 1090.4 MiB | 443.2 MiB |
| `memory.peak` during queries | 159.4 MiB | 297.5 MiB | 272.1 MiB |
...
| | loggytracy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442280203 | 442247761 | 441993578 |
| total on disk, settled | 78.3 MiB | 117.8 MiB | 54.2 MiB |
| of which write-ahead log | 0.0 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 78.3 MiB | 117.8 MiB | 54.2 MiB |
| **total per GB ingested** | 177 MiB / GB | 266 MiB / GB | 123 MiB / GB |
| **settled data per GB ingested** | 177 MiB / GB | 266 MiB / GB | 123 MiB / GB |
| total after the query phase | 78.3 MiB | 117.8 MiB | 54.2 MiB |

Breakdown:

* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:0,/data/parts:82082058,/data/traces:4096`
* Loki — `/data/chunks:123337330,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107317,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:56821309`
...
* against Loki, cold: loggytracy is 337.47x faster (0.2 ms against 78.7 ms)
* against Loki, warm: loggytracy is 354.15x faster (0.2 ms against 78.8 ms)
* against VictoriaLogs, cold: loggytracy is 5.40x faster (0.2 ms against 1.3 ms)
* against VictoriaLogs, warm: loggytracy is 5.17x faster (0.2 ms against 1.1 ms)
* ingest: loggytracy achieved 19767 eps against Loki's 19869 and VictoriaLogs' 19930
* disk: loggytracy's settled data is 0.66x Loki's and 1.44x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 4.37x faster (11.5 ms against 50.2 ms)
against Loki and within 10% (11.5 ms against 12.6 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19767 / 19869 / 19930 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-07 00:06:30.049388673 +0900
+++ /dev/fd/62	2026-08-07 00:06:30.049388673 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-06T15:06:11.875590Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mtrue
[2m2026-08-06T15:06:11.875661Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans, the memtable and allocator retention [3mpeak_materialized_bytes[0m[2m=[0m1610612736 [3mquery_memory_budget_bytes[0m[2m=[0m536870912 [3mrow_group_cache_max_bytes[0m[2m=[0m268435456 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m536870912 [3mmerge_max_memory_bytes[0m[2m=[0m1073741824 [3mmerge_max_input_bytes[0m[2m=[0m536870912 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-06T15:06:11.875818Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-06T15:06:11.880549Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-06T15:06:11.880556Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-06T15:06:11.880584Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-06T15:06:11.880589Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
