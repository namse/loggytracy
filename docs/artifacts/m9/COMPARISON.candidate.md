...
* loggytracy — `/data/journal.ckpt:8,/data/journal.wal:10987399,/data/parts:81833650,/data/traces:4096`
...
* against Loki, cold: loggytracy is 377.44x faster (0.2 ms against 78.8 ms)
* against Loki, warm: loggytracy is 380.46x faster (0.2 ms against 78.8 ms)
* against VictoriaLogs, cold: loggytracy is 4.68x faster (0.2 ms against 1.0 ms)
* against VictoriaLogs, warm: loggytracy is 4.78x faster (0.2 ms against 1.0 ms)
* ingest: loggytracy achieved 19933 eps against Loki's 19869 and VictoriaLogs' 19932
* disk: loggytracy's settled data is 0.66x Loki's and 1.41x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is loggytracy is 5.26x faster (10.0 ms against 52.7 ms)
against Loki and loggytracy is 1.28x faster (10.0 ms against 12.8 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and loggytracy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19933 / 19869 / 19932 achieved eps in run order).
...
```
[2m2026-08-18T01:43:48.220140Z[0m [32m INFO[0m [2mloggytracy[0m[2m:[0m glibc malloc tuning (LOGGYTRACY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mfalse
[2m2026-08-18T01:43:48.220239Z[0m [32m INFO[0m [2mloggytracy::config[0m[2m:[0m configured peak materialized memory, excluding trace scans and allocator retention [3mmemory_budget_bytes[0m[2m=[0m1288490188 [3mmemory_budget_source[0m[2m=[0m60% of 2147483648 (cgroup v2 memory.max) [3mpeak_materialized_bytes[0m[2m=[0m644245094 [3mquery_memory_budget_bytes[0m[2m=[0m322122547 [3mrow_group_cache_max_bytes[0m[2m=[0m161061273 [3msidecar_cache_max_bytes[0m[2m=[0m128849018 [3mmax_memtable_bytes[0m[2m=[0m128849018 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m322122547 [3mmerge_max_memory_bytes[0m[2m=[0m322122547 [3mmerge_max_input_bytes[0m[2m=[0m161061273 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-18T01:43:48.220391Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-18T01:43:48.225374Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m no retention is configured: neither LOGGYTRACY_RETENTION_PERIOD nor LOGGYTRACY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-18T01:43:48.225384Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-18T01:43:48.225433Z[0m [32m INFO[0m [2mloggytracy::startup[0m[2m:[0m loggytracy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-18T01:43:48.225468Z[0m [33m WARN[0m [2mloggytracy::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
