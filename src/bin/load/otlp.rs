...
//! them to stream labels (loggytracy and Loki, the same default list) sanitize
...
use loggytracy::memtable::{Labels, LogEntry};
...
///
/// Every name on the right is in the promotion list loggytracy and Loki share,
...
/// The same sanitization loggytracy and Loki apply to promoted attribute
