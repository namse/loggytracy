...
admin routes under /loggytracy/api/v1/admin — see docs/QUERY_API.md",
            uri.path(),
            ROUTES.join(", ")
        ),
    )
...
pub(crate) const SCANNED_ROWS_HEADER: &str = "x-loggytracy-scanned-rows";
pub(crate) const SCANNED_BYTES_HEADER: &str = "x-loggytracy-scanned-bytes";
