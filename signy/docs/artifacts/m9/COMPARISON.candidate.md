...
**Generated by `compare/run.sh` on 2026-08-18T01:53:58Z, from revision `e79e78c` (`master`). Do not edit
...
|---|---|---|---|
| build | `e79e78c` (`master`) | `release-3.3.x-23b5fc2` (`23b5fc2c`) | `v1.52.0` |
...
| **achieved eps** | 19933 | 19869 | 19932 |
| events accepted | 1201100 | 1201000 | 1200300 |
| elapsed s | 60.3 | 60.4 | 60.2 |
| stopped on | event_target | event_target | event_target |
| pushes accepted | 12011 | 12010 | 12003 |
| pushes throttled (429) | 0 | 0 | 0 |
| pushes failed | 0 | 0 | 0 |
| error rate | 0 | 0 | 0 |
| throttled rate | 0 | 0 | 0 |
| push service p50 ms | 2.15 | 1.12 | 0.26 |
| push service p95 ms | 12.7 | 3.44 | 0.48 |
| push service p99 ms | 18.9 | 5.58 | 1.13 |
| push response p50 ms | 3.63 | 2.04 | 1.15 |
| push response p95 ms | 14.0 | 4.66 | 1.61 |
| push response p99 ms | 20.4 | 14.0 | 2.17 |
| latency samples | 10011 | 10010 | 10003 |
| line bytes offered | 393250374 | 393217932 | 392997605 |
| wire bytes (OTLP protobuf) | 512304607 | 512262270 | 511972576 |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | cold | 17.7 | 175 | 28.4 | 29.7 | 181 | 32.8 | **0.10x** | **0.62x** |
| `label_only` | warm | 12.6 | 177 | 26.1 | 13.1 | 185 | 30.9 | **0.07x** | **0.48x** |
| `line_filter` | cold | 3.17 | 23.8 | 7.41 | 3.36 | 26.0 | 9.62 | **0.13x** | **0.43x** |
| `line_filter` | warm | 3.20 | 23.9 | 6.60 | 3.65 | 26.4 | 9.52 | **0.13x** | **0.49x** |
| `json_field` | cold | 10.0 | 52.7 | 12.8 | 12.4 | 69.7 | 15.8 | **0.19x** | **0.78x** |
| `json_field` | warm | 8.80 | 52.8 | 12.8 | 11.6 | 69.4 | 15.2 | **0.17x** | **0.69x** |
| `json_field_rare` | cold | 0.22 | 136 | 65.0 | 3.04 | 139 | 68.5 | **0.00x** | **0.00x** |
| `json_field_rare` | warm | 0.22 | 136 | 65.1 | 0.35 | 138 | 67.7 | **0.00x** | **0.00x** |
| `metadata_rare` | cold | 0.21 | 78.8 | 0.98 | 1.03 | 79.9 | 1.46 | **0.00x** | **0.21x** |
| `metadata_rare` | warm | 0.21 | 78.8 | 0.99 | 0.22 | 81.2 | 1.29 | **0.00x** | **0.21x** |
| `trace_window` | cold | 0.21 | 31.8 | 1.02 | 0.87 | 33.6 | 1.19 | **0.01x** | **0.21x** |
| `trace_window` | warm | 0.21 | 31.8 | 0.93 | 0.22 | 33.6 | 1.18 | **0.01x** | **0.22x** |
| `rate` | cold | 0.45 | 10.8 | 0.41 | 0.53 | 12.1 | 1.02 | **0.04x** | **1.09x** |
| `rate` | warm | 0.43 | 10.7 | 0.41 | 0.53 | 12.3 | 0.57 | **0.04x** | **1.05x** |
...
|---|---|---|---|---|---|---|---|---|---|
| `label_only` | 20000 | 17.7 | 175 | 28.4 | **0.10x** | **0.62x** | 758256 | 156516 | 150000 |
| `label_only` | 100 | 5.56 | 8.26 | 12.6 | **0.67x** | **0.44x** | 254787 | 13686 | 2400 |
| `line_filter` | 20000 | 3.17 | 23.8 | 7.41 | **0.13x** | **0.43x** | 758256 | 157304 | 10208 |
| `line_filter` | 100 | 1.57 | 10.4 | 11.2 | **0.15x** | **0.14x** | 426064 | 85550 | 2400 |
| `json_field` | 20000 | 10.0 | 52.7 | 12.8 | **0.19x** | **0.78x** | 657904 | 156988 | 17661 |
| `json_field` | 100 | 4.06 | 14.6 | 13.5 | **0.28x** | **0.30x** | 657904 | 79279 | 2400 |
| `json_field_rare` | 20000 | 0.22 | 136 | 65.0 | **0.00x** | **0.00x** | 6144 | 1582288 | 24 |
| `json_field_rare` | 100 | 0.22 | 135 | 64.5 | **0.00x** | **0.00x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 20000 | 0.21 | 78.8 | 0.98 | **0.00x** | **0.21x** | 6144 | 1582288 | 24 |
| `metadata_rare` | 100 | 0.20 | 78.7 | 0.97 | **0.00x** | **0.21x** | 6144 | 1582288 | 24 |
| `trace_window` | 20000 | 0.21 | 31.8 | 1.02 | **0.01x** | **0.21x** | 6144 | 574392 | 24 |
| `trace_window` | 100 | 0.20 | 31.8 | 0.90 | **0.01x** | **0.23x** | 6144 | 574392 | 24 |
| `rate` | 20000 | 0.45 | 10.8 | 0.41 | **0.04x** | **1.09x** | 758256 | 146551 | 112 |
| `rate` | 100 | 0.43 | 10.9 | 0.42 | **0.04x** | **1.02x** | 758256 | 146551 | 112 |
...
| `memory.peak` during ingest | 1049.2 MiB | 1820.5 MiB | 559.1 MiB |
| **anonymous peak during ingest** | 678.4 MiB | 1103.0 MiB | 418.1 MiB |
| `memory.peak` during queries | 278.6 MiB | 278.4 MiB | 290.9 MiB |
...
| | signy | Loki | VictoriaLogs |
|---|---|---|---|
| line bytes ingested | 442280203 | 442247761 | 442027434 |
| total on disk, settled | 88.5 MiB | 117.8 MiB | 55.3 MiB |
| of which write-ahead log | 10.5 MiB | 0.0 MiB | -0.0 MiB |
| settled data (total minus WAL) | 78.1 MiB | 117.8 MiB | 55.3 MiB |
| **total per GB ingested** | 200 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| **settled data per GB ingested** | 176 MiB / GB | 266 MiB / GB | 125 MiB / GB |
| total after the query phase | 88.5 MiB | 117.8 MiB | 55.3 MiB |

Breakdown:

* signy — `/data/journal.ckpt:8,/data/journal.wal:10987399,/data/parts:81833650,/data/traces:4096`
* Loki — `/data/chunks:123349567,/data/compactor:4096,/data/rules:4096,/data/rules-temp:4096,/data/tsdb-shipper-active:107500,/data/tsdb-shipper-cache:24576,/data/wal:8192`
* VictoriaLogs — `/data/flock.lock:0,/data/partitions:57947687`
...
* against Loki, cold: signy is 377.44x faster (0.2 ms against 78.8 ms)
* against Loki, warm: signy is 380.46x faster (0.2 ms against 78.8 ms)
* against VictoriaLogs, cold: signy is 4.68x faster (0.2 ms against 1.0 ms)
* against VictoriaLogs, warm: signy is 4.78x faster (0.2 ms against 1.0 ms)
* ingest: signy achieved 19933 eps against Loki's 19869 and VictoriaLogs' 19932
* disk: signy's settled data is 0.66x Loki's and 1.41x VictoriaLogs' (write-ahead logs excluded on every side)

The previous claim's shape stays measured beside it: `json_field` cold is signy is 5.26x faster (10.0 ms against 52.7 ms)
against Loki and signy is 1.28x faster (10.0 ms against 12.8 ms) against VictoriaLogs. That claim was measured, lost, and
...
* **The ingest runs are sequential, and signy went first.** A later run starts with a warmer page cache and a machine that has just finished doing work. Running them concurrently would remove that and introduce a worse problem — each system's throughput would depend on the others' — so this is a chosen bias rather than an overlooked one, and its direction favours the systems that ran later (19933 / 19869 / 19932 achieved eps in run order).
...
```diff
--- /dev/fd/63	2026-08-18 10:44:06.389913508 +0900
+++ /dev/fd/62	2026-08-18 10:44:06.389913508 +0900
@@ -7 +7 @@
-  http_listen_address: ""
...
```
[2m2026-08-18T01:43:48.220140Z[0m [32m INFO[0m [2msigny[0m[2m:[0m glibc malloc tuning (SIGNY_MALLOC_TUNING=off to disable) [3mapplied[0m[2m=[0mfalse
[2m2026-08-18T01:43:48.220239Z[0m [32m INFO[0m [2msigny::config[0m[2m:[0m configured peak materialized memory, excluding trace scans and allocator retention [3mmemory_budget_bytes[0m[2m=[0m1288490188 [3mmemory_budget_source[0m[2m=[0m60% of 2147483648 (cgroup v2 memory.max) [3mpeak_materialized_bytes[0m[2m=[0m644245094 [3mquery_memory_budget_bytes[0m[2m=[0m322122547 [3mrow_group_cache_max_bytes[0m[2m=[0m161061273 [3msidecar_cache_max_bytes[0m[2m=[0m128849018 [3mmax_memtable_bytes[0m[2m=[0m128849018 [3mconcurrent_query_scans[0m[2m=[0m8 [3mmax_query_memory_bytes[0m[2m=[0m322122547 [3mmerge_max_memory_bytes[0m[2m=[0m322122547 [3mmerge_max_input_bytes[0m[2m=[0m161061273 [3mflush_chunk_bytes[0m[2m=[0m33554432 [3mdetected_memory_limit_bytes[0m[2m=[0m2147483648 [3mdetected_memory_source[0m[2m=[0m"cgroup v2 memory.max"
[2m2026-08-18T01:43:48.220391Z[0m [32m INFO[0m [2msigny::startup[0m[2m:[0m journal recovery complete [3mcheckpoint[0m[2m=[0m0 [3mreplay_end[0m[2m=[0m0
[2m2026-08-18T01:43:48.225374Z[0m [33m WARN[0m [2msigny::startup[0m[2m:[0m no retention is configured: neither SIGNY_RETENTION_PERIOD nor SIGNY_TENANT_POLICY_TOKEN is set, so the object store grows without bound
[2m2026-08-18T01:43:48.225384Z[0m [33m WARN[0m [2msigny::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:4317
[2m2026-08-18T01:43:48.225433Z[0m [32m INFO[0m [2msigny::startup[0m[2m:[0m signy listening [3maddr[0m[2m=[0m0.0.0.0:3100
[2m2026-08-18T01:43:48.225468Z[0m [33m WARN[0m [2msigny::startup[0m[2m:[0m bound to a non-loopback address: this process has no TLS and no authentication, and X-Scope-OrgID is trusted without proof. Keep it inside a trust boundary [3maddr[0m[2m=[0m0.0.0.0:3100
```
